...
echo Loading VIRTUAL-EQUIPMENT-MANAGER
java -jar /app/backrits/virtual-equipment-manager.jar -Dfile.encoding=UTF-8 --xml.adapter=virtual_equipment_manager_adapter_v1.xml
