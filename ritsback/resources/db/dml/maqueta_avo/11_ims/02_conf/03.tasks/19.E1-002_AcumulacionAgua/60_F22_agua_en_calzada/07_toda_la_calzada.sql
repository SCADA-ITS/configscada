...
(1, 1, 01060606, '[
	...
	{
		"id": 5,
		"alias": "PMVI - S023 - Aguas arriba - Desde el incidente hasta salida anterior",
		"spathId": "Spath:107",
		...
		"command": {
					"commandElementTypeId": "CommandElementType:2:71",
					"commandElementValues": [{
						"value": "[{\"zone\":1,\"alternance_ms\":5000,\"align\":\"center\",\"texts\":[{\"id\":1,\"value\":\"ACUMULACION AGUA\",\"alternance\":\"TRAFICO CORTADO\",\"color\":\"#FFFFFF\"}]}]",
						"commandElementTypeParamId": "CommandElementTypeParam:2:71:1"
					}]	
		}
	},
	...
	},
	{
		...
		"command": {
					"commandElementTypeId": "CommandElementType:2:71",
					"commandElementValues": [{
						"value": "[{\"zone\":1,\"alternance_ms\":5000,\"graphics\":[{\"id\":1,\"value\":\"142\",\"alternance\":\"136\"}]},{\"zone\":2,\"alternance_ms\":5000,\"align\":\"center\",\"texts\":[{\"id\":1,\"value\":\"TUNEL\",\"alternance\":\"POSIBLES\",\"color\":\"#FFFFFF\"},{\"id\":2,\"value\":\"CORTADO POR\",\"alternance\":\"RETENCIONES\",\"color\":\"#FFFFFF\"},{\"id\":3,\"value\":\"ACUMULACION AGUA\",\"alternance\":\"MODERE VELOCIDAD\",\"color\":\"#FFFFFF\"}]}]",
						"commandElementTypeParamId": "CommandElementTypeParam:2:71:1"
					}]	
		}
	},
