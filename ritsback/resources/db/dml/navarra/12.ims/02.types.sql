...
(1,'Meteorológicas','Meteorológicas','LBL_IMS_INCIDENT_GROUP_TYPE_WEATHER_DATA', 'LBL_IMS_INCIDENT_GROUP_TYPE_WEATHER_DATA',true,true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
(2,'Obras','Obras','LBL_IMS_INCIDENT_GROUP_TYPE_ROAD_WORKS', 'LBL_IMS_INCIDENT_GROUP_TYPE_ROAD_WORKS_DESC',true,true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
(3,'Red viaría','Red viaría','LBL_IMS_INCIDENT_GROUP_TYPE_ROAD_INCIDENTS', 'LBL_IMS_INCIDENT_GROUP_TYPE_ROAD_INCIDENTS_DESC',true,true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
