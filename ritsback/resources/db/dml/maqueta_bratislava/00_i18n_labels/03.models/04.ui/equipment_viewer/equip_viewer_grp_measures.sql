...
INSERT INTO master.i18n_labels (locale_code,module_id,"label","translation",created_at,updated_at) VALUES
    --es_ES
	 ...
	 ('es_ES', 1, 'LBL_ELEMENT_PATTERN_CLASSIFICATION', 'Patrones', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ...
    --en_GB
	 ('en_GB', 1, 'LBL_ELEMENT_GENERAL', 'General', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
 	 ('en_GB', 1, 'LBL_ELEMENT_PATTERN_CLASSIFICATION', 'Pattern', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ...
    --sk_SK
	 ('sk_SK',1,'LBL_ELEMENT_GENERAL','Všeobecne',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
 	 ('sk_SK',1,'LBL_ELEMENT_PATTERN_CLASSIFICATION','Vozidla',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
    ...
    --es_CL
	 ...
	 ('es_CL', 1, 'LBL_ELEMENT_PATTERN_CLASSIFICATION', 'Patrones', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
