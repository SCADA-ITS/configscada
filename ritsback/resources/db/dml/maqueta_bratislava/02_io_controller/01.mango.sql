...
(1, 1, 13, 'http://192.168.88.169:8080/rest/v1', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
(1, 1, 14, 'http://192.168.88.169:8080/rest/v2/login', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
(1, 1, 15, 'admin', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1, 1, 16, 'Revenga.19', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
