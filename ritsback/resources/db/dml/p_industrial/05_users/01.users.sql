...
(1, 1, 'admin', 'hcebhlEAlBBNaZcdLdmvuQ==', NULL, 86400, NULL, true, true, 'System admin', 'admin@rits.com', 'es_CL', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 2, 'oper', 'hcebhlEAlBBNaZcdLdmvuQ==', NULL, 86400, NULL, true, true, 'System operator', 'oper@rits.com', 'es_CL', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(3, 2, 'aortiztr', 'uS0w/QXS6CoMzB+AlcWY4A==', NULL, 86400, NULL, true, true, 'System operator', '', 'es_CL', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(4, 2, 'msanhueza', 'Nw9OCrNQsjMugZM+Ag99XQ==', NULL, 86400, NULL, true, true, 'System operator', '', 'es_CL', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 2, 'istruckrath', '6HgymZBA6VIHPmNJ42bI+g==', NULL, 86400, NULL, true, true, 'System operator', '', 'es_CL', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(6, 2, 'rcontreras', 'UX3jR03q6EcLfC7Eyk2u9A==', NULL, 86400, NULL, true, true, 'System operator', '', 'es_CL', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(7, 2, 'amanriquez', 'sq4HoCXQ9GVfHVx62O+P9Q==', NULL, 86400, NULL, true, true, 'System operator', '', 'es_CL', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(8, 2, 'gonzaloroa', 'qWnOGZ1JGW0sxeoIIPXprg==', NULL, 86400, NULL, true, true, 'System operator', '', 'es_CL', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(9, 1, 'cserrano', 'EOTGE5fynKZZFc92BooLCg==', NULL, 86400, NULL, true, true, 'System admin', '', 'es_CL', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(10, 1, 'pgaldames', 'f/cCPQcasBnD+FI6s/ar3g==', NULL, 86400, NULL, true, true, 'System admin', '', 'es_CL', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(11, 1, 'avillaroel', 'y39LBYK+sOEiAz0LKWHkGQ==', NULL, 86400, NULL, true, true, 'System admin', '', 'es_CL', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
