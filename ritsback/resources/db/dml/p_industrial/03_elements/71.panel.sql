...
(71, 19, 1, 0010071, NULL, NULL, '01.4-ASC-PMV-01', '01.4-ASC-PMV-01', NULL, NULL, 'ChangeMeasureHistorical.groovy', NULL, true, true, false, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
(71, 19, 2, 0020071, NULL, NULL, '05.1-DES-PMV-01', '05.1-DES-PMV-01', NULL, NULL, 'ChangeMeasureHistorical.groovy', NULL, true, true, false, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(71, 1003, 1, 1, NULL, '01.4-ASC-PMV-01', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
...
(71, 1003, 1, 2, NULL, '05.1-DES-PMV-01', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
