...
UPDATE conf.alarm_configs SET alarm_level_id = 1, enabled = True, treatment = True WHERE element_type_id = 87 AND alarm_config_id = 10050087; --LBL_ALARM_CONFIGS_ALARM_LOW_TOXIC_LEVEL
UPDATE conf.alarm_configs SET alarm_level_id = 1, enabled = True, treatment = True WHERE element_type_id = 87 AND alarm_config_id = 10060087; --LBL_ALARM_CONFIGS_ALARM_HIGH_TOXIC_LEVEL
