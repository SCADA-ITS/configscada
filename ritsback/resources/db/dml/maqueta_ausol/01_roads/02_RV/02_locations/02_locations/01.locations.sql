...
(1000, 2, 'RV-TUNEL', 'Tunel de Río Verde', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1001, 2, 'RV-TSM', 'Boca sentido Málaga del tunel de Río Verde', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1002, 2, 'RV-TSC', 'Boca sentido Cádiz del tunel de Río Verde', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
