...
(1007, 2, 'MM-TUNEL', 'Tunel de Montemayor', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1008, 2, 'MM-TSM', 'Boca sentido Málaga del tunel de Montemayor', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1009, 2, 'MM-TSC', 'Boca sentido Cádiz del tunel de Montemayor', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
