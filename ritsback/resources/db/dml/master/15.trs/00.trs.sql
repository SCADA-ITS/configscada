...
(10,'CL','Check lists','Check lists','LBL_TRANSIT_STATE_CHECK_LISTS','LBL_TRANSIT_STATE_CHECK_LISTS_DESC',false,true,true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
(11,'WL','White list','White list','LBL_TRANSIT_STATE_WHITE_LIST','LBL_TRANSIT_STATE_WHITE_LIST_DESC',false,true,true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
(12,'BL','Black list','Black list','LBL_TRANSIT_STATE_BLACK_LIST','LBL_TRANSIT_STATE_BLACK_LIST_DESC',false,true,true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
