...
--CONFIG
(8,1,1, NULL,2, ' ', 'brand', 'brand', 'LBL_ELEMENT_TYPE_PARAM_BRAND' , 'LBL_ELEMENT_TYPE_PARAM_BRAND_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(8,1,2, NULL,2, ' ', 'model', 'model', 'LBL_ELEMENT_TYPE_PARAM_MODEL' , 'LBL_ELEMENT_TYPE_PARAM_MODEL_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(8,1,1003, NULL,2, ' ', 'MANGO SESSION_UID', 'MANGO SESSION_UID', 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID' , 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(39, 4, 3, 8, NULL, NULL, true, true, 'ALARM BARRIER DISCONNECTED', 'ALARM BARRIER DISCONNECTED', 'LBL_ALARM_CONFIGS_ALARM_BARRIER_DISCONNECTED', 'LBL_ALARM_CONFIGS_ALARM_BARRIER_DISCONNECTED_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(283, 2, 5, 8, NULL, 3, true, true, 'ALARM BARRIER RISE FAILURE', 'ALARM BARRIER RISE FAILURE', 'LBL_ALARM_CONFIGS_ALARM_BARRIER_RISE_FAILURE', 'LBL_ALARM_CONFIGS_ALARM_BARRIER_RISE_FAILURE_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(284, 2, 5, 8, NULL, 3, true, true, 'ALARM BARRIER LOWERING FAILURE', 'ALARM BARRIER LOWERING FAILURE', 'LBL_ALARM_CONFIGS_ALARM_BARRIER_LOWERING_FAILURE', 'LBL_ALARM_CONFIGS_ALARM_BARRIER_LOWERING_FAILURE_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(285, 2, 5, 8, NULL, 3, true, true, 'ALARM BARRIER ENGINE', 'ALARM BARRIER ENGINE', 'LBL_ALARM_CONFIGS_ALARM_BARRIER_ENGINE', 'LBL_ALARM_CONFIGS_ALARM_BARRIER_ENGINE_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(347, 2, 5, 8, NULL, 3, true, true, 'ALARM BARRIER FAIL', 'ALARM BARRIER FAIL', 'LBL_ALARM_CONFIGS_ALARM_BARRIER_FAIL', 'LBL_ALARM_CONFIGS_ALARM_BARRIER_FAIL_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(0806, 2, 5, 8, NULL, 3, true, true, 'ALARM BARRIER DOWN', 'ALARM BARRIER DOWN', 'LBL_ALARM_CONFIGS_ALARM_BARRIER_DOWN', 'LBL_ALARM_CONFIGS_ALARM_BARRIER_DOWN_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(0807, 2, 5, 8, NULL, 3, true, true, 'ALARM BARRIER DOWN VEH DET', 'ALARM BARRIER DOWN VEH DET', 'LBL_ALARM_CONFIGS_ALARM_BARRIER_DOWN_VEHICLE_DET', 'LBL_ALARM_CONFIGS_ALARM_BARRIER_DOWN_VEHICLE_DET_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(0808, 2, 5, 8, NULL, 3, true, true, 'ALARM BARRIER NO RETURN', 'ALARM BARRIER NO RETURN', 'LBL_ALARM_CONFIGS_ALARM_BARRIER_NO_RETURN', 'LBL_ALARM_CONFIGS_ALARM_BARRIER_NO_RETURN_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(0809, 2, 5, 8, NULL, 3, true, true, 'ALARM BARRIER DOWN NO RED SEM', 'ALARM BARRIER DOWN NO RED SEM', 'LBL_ALARM_CONFIGS_ALARM_BARRIER_DOWN_NO_RED_SEM', 'LBL_ALARM_CONFIGS_ALARM_BARRIER_DOWN_NO_RED_SEM_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(0810, 2, 5, 8, NULL, 3, true, true, 'ALARM BARRIER COMMAND FAIL', 'ALARM BARRIER COMMAND FAIL', 'LBL_ALARM_CONFIGS_ALARM_BARRIER_COMMAND_FAIL', 'LBL_ALARM_CONFIGS_ALARM_BARRIER_COMMAND_FAIL_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(8, 2, 39, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
