...
VALUES(98, 'PROCESS INFO', 'Process Information','LBL_ELEMENT_TYPE_PROCESSS_INFO', 'LBL_ELEMENT_TYPE_PROCESS_INFO_DESC', 1, 1, 1, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(98,2,4, NULL,3, null, 'PROCESS CPU LOAD', 'PROCESS CPU LOAD', 'LBL_ELEMENT_TYPE_PARAM_PROCESS_CPU_LOAD', 'LBL_ELEMENT_TYPE_PARAM_PROCESS_CPU_LOAD', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
