...
(3201, 2, 5, 32, NULL, 3, true, true, 'ALARM FAN ON OFF', 'ALARM FAN ON OFF', 'LBL_ALARM_CONFIGS_ALARM_FAN_ON_OFF', 'LBL_ALARM_CONFIGS_ALARM_CONFIGS_ALARM_FAN_ON_OFF_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(3202, 2, 5, 32, NULL, 3, true, true, 'ALARM FAN FAIL STOP', 'ALARM FAN FAIL STOP', 'LBL_ALARM_CONFIGS_ALARM_FAN_FAIL_STOP', 'LBL_ALARM_CONFIGS_ALARM_FAN_FAIL_STOP_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(3203, 2, 5, 32, NULL, 3, true, true, 'ALARM FAN FAIL START', 'ALARM FAN FAIL START', 'LBL_ALARM_CONFIGS_ALARM_FAN_FAIL_START', 'LBL_ALARM_CONFIGS_ALARM_FAN_FAIL_START_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(3204, 2, 5, 32, NULL, 3, true, true, 'ALARM FAN FAIL', 'ALARM FAN FAIL', 'LBL_ALARM_CONFIGS_ALARM_FAN_FAIL', 'LBL_ALARM_CONFIGS_ALARM_FAN_FAIL_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(3205, 2, 6, 32, NULL, NULL, true, true, 'ALARM PRESSURIZATION NO CONNECTION', 'ALARM PRESSURIZATION NO CONNECTION', 'LBL_ALARM_CONFIGS_ALARM_PRESSURIZATION_NO_CONNECTION', 'LBL_ALARM_CONFIGS_ALARM_PRESSURIZATION_NO_CONNECTION_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(3207, 2, 3, 32, NULL, 3, true, true, 'ALARM FIRE PRESSURIZATION FAN 1 FAIL', 'ALARM FIRE PRESSURIZATION FAN 1 FAIL', 'LBL_ALARM_CONFIGS_ALARM_FIRE_PRESSURIZATION_FAN_1_FAIL', 'LBL_ALARM_CONFIGS_ALARM_FIRE_PRESSURIZATION_FAN_1_FAIL_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(3208, 2, 3, 32, NULL, 3, true, true, 'ALARM FIRE PRESSURIZATION FAN 2 FAIL', 'ALARM FIRE PRESSURIZATION FAN 2 FAIL', 'LBL_ALARM_CONFIGS_ALARM_FIRE_PRESSURIZATION_FAN_2_FAIL', 'LBL_ALARM_CONFIGS_ALARM_FIRE_PRESSURIZATION_FAN_2_FAIL_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(32, 2, 3205, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
