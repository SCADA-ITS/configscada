...
(2, 32, 'PRESURIZACION AUSOL', 'PRESURIZACION AUSOL', 'LBL_ELEMENT_SUBTYPE_PRESURIZACION_AUSOL', 'LBL_ELEMENT_SUBTYPE_PRESURIZACION_AUSOL_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- 
...
(2, 32, 2, 1, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 32, 2, 2, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 32, 2, 3, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(2, 1, 32, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 2, 32, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);