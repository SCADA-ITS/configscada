...
--CONFIG
(93, 1, 1, NULL, 2, NULL, 'brand', 'brand', 'LBL_ELEMENT_TYPE_PARAM_BRAND' , 'LBL_ELEMENT_TYPE_PARAM_BRAND_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(93, 1, 2, NULL, 2, NULL, 'model', 'model', 'LBL_ELEMENT_TYPE_PARAM_MODEL' , 'LBL_ELEMENT_TYPE_PARAM_MODEL_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(93, 1, 1003, NULL, 2, NULL, 'MANGO_SESSION_UID', 'MANGO SESSION_UID', 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID' , 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
--
...
(010093, 2, 3, 93, NULL, NULL, true, true, 'ALARM TRANSFER GROUP DISCONNECTED', 'ALARM TRANSFER GROUP DISCONNECTED', 'LBL_ALARM_CONFIGS_ALARM_TRANSFER_GROUP_DISCONNECTED', 'LBL_ALARM_CONFIGS_ALARM_TRANSFER_GROUP_DISCONNECTED_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(020093, 2, 3, 93, NULL, 3, true, true, 'ALARM TRANSFER GROUP GENERAL ALARM', 'ALARM TRANSFER GROUP GENERAL ALARM', 'LBL_ALARM_CONFIGS_ALARM_TRANSFER_GROUP_GENERAL_ALARM', 'LBL_ALARM_CONFIGS_ALARM_TRANSFER_GROUP_GENERAL_ALARM_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(030093, 2, 3, 93, NULL, 3, true, true, 'ALARM TRANSFER GROUP ON', 'ALARM TRANSFER GROUP ON', 'LBL_ALARM_CONFIGS_ALARM_TRANSFER_GROUP_ON', 'LBL_ALARM_CONFIGS_ALARM_TRANSFER_GROUP_ON_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(93, 2, 010093, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
