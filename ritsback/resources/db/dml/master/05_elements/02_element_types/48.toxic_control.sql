...
(48, null, 'TOXIC_CONTROL', 'TOXIC_CONTROL', 'LBL_ELEMENT_TYPE_TOXIC_CONTROL', 'LBL_ELEMENT_TYPE_TOXIC_CONTROL_DESC', 0, 1, 2, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
--CONFIG
(48,1,1, NULL,2, ' ','brand', 'brand', 'LBL_ELEMENT_TYPE_PARAM_BRAND' , 'LBL_ELEMENT_TYPE_PARAM_BRAND_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(48,1,2, NULL,2, ' ', 'model', 'model', 'LBL_ELEMENT_TYPE_PARAM_MODEL' , 'LBL_ELEMENT_TYPE_PARAM_MODEL_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(48,1,1003, NULL,2, ' ', 'MANGO SESSION_UID', 'MANGO SESSION_UID', 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID' , 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

--MEASURES
(48, 2, 1, NULL, 5, '', 'opening_gate', 'opening_gate', 'LBL_ELEMENT_TYPE_PARAM_TOXIC_CONTROL_OPENING_GATE' , 'LBL_ELEMENT_TYPE_PARAM_TOXIC_CONTROL_OPENING_GATE_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(48, 2, 2, NULL, 5, '', 'gate_opened', 'gate_opened', 'LBL_ELEMENT_TYPE_PARAM_TOXIC_CONTROL_GATE_OPENED' , 'LBL_ELEMENT_TYPE_PARAM_TOXIC_CONTROL_GATE_OPENED_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
