...
VALUES
(7, 71, 'VMS_METEOROLOGICO', 'VMS_METEOROLOGICO', 'LBL_ELEMENT_SUBTYPE_PANEL_VMS_METEOROLOGICO', 'LBL_ELEMENT_SUBTYPE_PANEL_VMS_METEOROLOGICO_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(7, 71, 2, 1, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(7, 71, 2, 2, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(7, 71, 2, 3, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(7, 71, 2, 7, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(7, 3, 71, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(7, 4, 71, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);