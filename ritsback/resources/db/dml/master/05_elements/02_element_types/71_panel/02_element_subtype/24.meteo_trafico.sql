...
VALUES
(24, 71, 'VMS_METEO_TRAFICO', 'VMS_METEO_TRAFICO', 'LBL_ELEMENT_SUBTYPE_PANEL_VMS_METEO_TRAFICO', 'LBL_ELEMENT_SUBTYPE_PANEL_VMS_METEO_TRAFICO_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(24, 71, 2, 1, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(24, 71, 2, 2, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(24, 71, 2, 3, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(24, 71, 2, 7, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(24, 71, 2, 8, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(24, 3, 71, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(24, 4, 71, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);