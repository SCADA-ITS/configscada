...
VALUES
(5, 71, 'VMS_MAT_128_64', 'VMS_MAT_128_64', 'LBL_ELEMENT_SUBTYPE_PANEL_VMS_VMS_MAT_128_64', 'LBL_ELEMENT_SUBTYPE_PANEL_VMS_VMS_MAT_128_64_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(5, 71, 2, 1, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 71, 2, 2, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 71, 2, 3, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(5, 2, 71, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 3, 71, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);