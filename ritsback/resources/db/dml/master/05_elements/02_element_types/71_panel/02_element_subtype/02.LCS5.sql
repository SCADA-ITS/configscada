...
VALUES
(2, 71, 'VMS_AC_BD_5LCS', 'VMS_AC_BD_5LCS', 'LBL_ELEMENT_SUBTYPE_PANEL_VMS_AC_BD_5LCS', 'LBL_ELEMENT_SUBTYPE_PANEL_VMS_AC_BD_5LCS_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(2, 71, 2, 1, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 71, 2, 2, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 71, 2, 3, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 71, 2, 11, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(2, 2, 71, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 3, 71, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);