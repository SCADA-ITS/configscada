...
--CONFIG
(55, 1, 1, NULL, 2, ' ', 'brand', 'brand', 'LBL_ELEMENT_TYPE_PARAM_BRAND' , 'LBL_ELEMENT_TYPE_PARAM_BRAND_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(55, 1, 2, NULL, 2, ' ', 'model', 'model', 'LBL_ELEMENT_TYPE_PARAM_MODEL' , 'LBL_ELEMENT_TYPE_PARAM_MODEL_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(55, 1, 1003, NULL, 2, ' ', 'MANGO SESSION_UID', 'MANGO SESSION_UID', 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID' , 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
--MEASURE
...
(010055, 2, 3, 55, NULL, 3, true, true, 'ALARM CT EQUIPMENT OUT OF COMMUNICATIONS', 'ALARM CT EQUIPMENT OUT OF COMMUNICATIONS', 'LBL_ALARM_CONFIGS_ALARM_CT_EQUIPMENT_OUT_OF_COMMUNICATIONS', 'LBL_ALARM_CONFIGS_ALARM_CT_EQUIPMENT_OUT_OF_COMMUNICATIONS_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(020055, 2, 3, 55, NULL, 3, true, true, 'ALARM CT EQUIPMENT ALARMED', 'ALARM CT EQUIPMENT ALARMED', 'LBL_ALARM_CONFIGS_ALARM_CT_EQUIPMENT_ALARMED', 'LBL_ALARM_CONFIGS_ALARM_CT_EQUIPMENT_ALARMED_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

(176, 2, 3, 55, NULL, 3, true, true, 'ALARM CT AIR CONDITIONER', 'ALARM CT AIR CONDITIONER', 'LBL_ALARM_CONFIGS_ALARM_CT_AIR_CONDITIONER', 'LBL_ALARM_CONFIGS_ALARM_CT_AIR_CONDITIONER_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(177, 2, 3, 55, NULL, 3, true, true, 'ALARM CT DOOR OPEN', 'ALARM CT DOOR OPEN', 'LBL_ALARM_CONFIGS_ALARM_CT_DOOR_OPEN', 'LBL_ALARM_CONFIGS_ALARM_CT_DOOR_OPEN_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(178, 2, 3, 55, NULL, 3, true, true, 'ALARM CT EXCESS TEMPERATURE', 'ALARM CT EXCESS TEMPERATURE', 'LBL_ALARM_CONFIGS_ALARM_CT_EXCESS_TEMPERATURE', 'LBL_ALARM_CONFIGS_ALARM_CT_EXCESS_TEMPERATURE_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
