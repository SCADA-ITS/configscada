...
VALUES(35, 'SENTINAS', 'SENTINAS','LBL_ELEMENT_TYPE_SENTINAS', 'LBL_ELEMENT_TYPE_SENTINAS_DESC', 0, 1, 2, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
--CONFIG
(35, 1, 1, NULL, 2, ' ', 'brand', 'brand', 'LBL_ELEMENT_TYPE_PARAM_BRAND' , 'LBL_ELEMENT_TYPE_PARAM_BRAND_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(35, 1, 2, NULL, 2, ' ', 'model', 'model', 'LBL_ELEMENT_TYPE_PARAM_MODEL' , 'LBL_ELEMENT_TYPE_PARAM_MODEL_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(35, 1, 1003, NULL, 2, ' ', 'MANGO SESSION_UID', 'MANGO SESSION_UID', 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID' , 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
--MEASURE
...
(10010035, 2, 3, 35, NULL, NULL, true, true, 'ALARM SENTINA DISCONNECTED', 'ALARM SENTINA DISCONNECTED', 'LBL_ALARM_CONFIGS_ALARM_SENTINA_DISCONNECTED', 'LBL_ALARM_CONFIGS_ALARM_SENTINA_DISCONNECTED_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(10020035, 2, 3, 35, NULL, 3, true, true, 'ALARM PUMP1 ENABLE', 'ALARM PUMP1 ENABLE', 'LBL_ALARM_CONFIGS_ALARM_PUMP1_ENABLE', 'LBL_ALARM_CONFIGS_ALARM_PUMP1_ENABLE_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(10030035, 2, 3, 35, NULL, 3, true, true, 'ALARM PUMP2 ENABLE', 'ALARM PUMP2 ENABLE', 'LBL_ALARM_CONFIGS_ALARM_PUMP2_ENABLE', 'LBL_ALARM_CONFIGS_ALARM_PUMP1_ENABLE_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
