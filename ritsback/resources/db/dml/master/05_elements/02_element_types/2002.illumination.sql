...
(element_type_id, element_group_id, alias, description,label_alias, label_description, initial_element_type_state_id, connected_element_type_state_id, disconnected_element_type_state_id, is_logic, enabled, visible, created_at, updated_at) VALUES
(2002, NULL, 'ILLUMINATION', 'Tunnel illumination system', 'LBL_ELEMENT_TYPE_ILUMINATION', 'LBL_ELEMENT_TYPE_ILLUMINATION_DESC', 0, 1, 2, true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
