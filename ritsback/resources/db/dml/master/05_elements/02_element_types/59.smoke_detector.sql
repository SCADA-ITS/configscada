...
(59, NULL, 'SMOKE_DETECTOR', 'SMOKE_DETECTOR', 'LBL_ELEMENT_TYPE_SMOKE_DETECTOR', 'LBL_ELEMENT_TYPE_SMOKE_DETECTOR_DESC', 0, 1, 2, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
--CONFIG
(59, 1, 1, NULL, 2, ' ', 'brand', 'brand', 'LBL_ELEMENT_TYPE_PARAM_BRAND' , 'LBL_ELEMENT_TYPE_PARAM_BRAND_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(59, 1, 2, NULL, 2, ' ', 'model', 'model', 'LBL_ELEMENT_TYPE_PARAM_MODEL' , 'LBL_ELEMENT_TYPE_PARAM_MODEL_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(59, 1, 1003, NULL, 2, ' ', 'MANGO SESSION_UID', 'MANGO SESSION_UID', 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID' , 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(183, 2, 3, 59, NULL, NULL, true, true, 'ALARM SMOKE_DETECTOR NO CONNECTION', 'ALARM SMOKE_DETECTOR NO CONNECTION', 'LBL_ALARM_CONFIGS_ALARM_SMOKE_DETECTOR_NO_CONNECTION', 'LBL_ALARM_CONFIGS_ALARM_SMOKE_DETECTOR_NO_CONNECTION_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(184, 2, 3, 59, NULL, 3, true, true, 'ALARM SMOKE_DETECTOR SMOKE_ALARM', 'ALARM SMOKE_DETECTOR SMOKE_ALARM', 'LBL_ALARM_CONFIGS_ALARM_SMOKE_DETECTOR_SMOKE_ALARM', 'LBL_ALARM_CONFIGS_ALARM_SMOKE_DETECTOR_SMOKE_ALARM_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(303, 2, 3, 59, NULL, 3, true, true, 'ALARM SMOKE_DETECTOR FAIL', 'ALARM SMOKE_DETECTOR FAIL', 'LBL_ALARM_CONFIGS_ALARM_SMOKE_DETECTOR_FAIL', 'LBL_ALARM_CONFIGS_ALARM_SMOKE_DETECTOR_FAIL_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(59, 2, 183, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);