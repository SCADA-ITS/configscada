...
(8701, 2, 3, 87, NULL, NULL, true, true, 'ALARM TANK DISCONNECTED', 'ALARM TANK DISCONNECTED', 'LBL_ALARM_CONFIGS_ALARM_TANK_DISCONNECTED', 'LBL_ALARM_CONFIGS_ALARM_PUMP_DISCONNECTED_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(10020087, 2, 3, 87, NULL, 3, true, true, 'ALARM CRITICAL POND LEVEL', 'ALARM CRITICAL POND LEVEL', 'LBL_ALARM_CONFIGS_ALARM_CRITICAL_POND_LEVEL', 'LBL_ALARM_CONFIGS_ALARM_CRITICAL_POND_LEVEL_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(10030087, 2, 3, 87, NULL, 3, true, true, 'ALARM MEDIUM POND LEVEL', 'ALARM MEDIUM POND LEVEL', 'LBL_ALARM_CONFIGS_ALARM_MEDIUM_POND_LEVEL', 'LBL_ALARM_CONFIGS_ALARM_MEDIUM_POND_LEVEL_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(10040087, 2, 3, 87, NULL, 3, true, true, 'ALARM LOW POND LEVEL', 'ALARM LOW POND LEVEL', 'LBL_ALARM_CONFIGS_ALARM_LOW_POND_LEVEL', 'LBL_ALARM_CONFIGS_ALARM_LOW_POND_LEVEL_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(10050087, 2, 1, 87, NULL, 3, true, true, 'ALARM LOW TOXIC LEVEL', 'Toxic greater than 10% but less than 76%', 'LBL_ALARM_CONFIGS_ALARM_LOW_TOXIC_LEVEL', 'LBL_ALARM_CONFIGS_ALARM_LOW_TOXIC_LEVEL_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(10060087, 2, 1, 87, NULL, 3, true, true, 'ALARM HIGH TOXIC LEVEL', 'Toxic greater than 75%', 'LBL_ALARM_CONFIGS_ALARM_HIGH_TOXIC_LEVEL', 'LBL_ALARM_CONFIGS_ALARM_HIGH_TOXIC_LEVEL_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(87, 2, 8701, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
