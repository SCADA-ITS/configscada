...
(57, NULL, 'INTERRUPTOR', 'INTERRUPTOR', 'LBL_ELEMENT_TYPE_INTERRUPTOR', 'LBL_ELEMENT_TYPE_INTERRUPTOR_DESC', 0, 1, 2, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
--CONFIG
(57, 1, 1, NULL, 2, ' ', 'brand', 'brand', 'LBL_ELEMENT_TYPE_PARAM_BRAND' , 'LBL_ELEMENT_TYPE_PARAM_BRAND_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(57, 1, 2, NULL, 2, ' ', 'model', 'model', 'LBL_ELEMENT_TYPE_PARAM_MODEL' , 'LBL_ELEMENT_TYPE_PARAM_MODEL_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(57, 1, 1003, NULL, 2, ' ', 'MANGO SESSION_UID', 'MANGO SESSION_UID', 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID' , 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
--MEASURE
...
(030057, 2, 3, 57, NULL, 3, true, true, 'ALARM START GE', 'ALARM START GE', 'LBL_ALARM_CONFIGS_ALARM_DIMMER_START_GE', 'LBL_ALARM_CONFIGS_ALARM_DIMMER_START_GE', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(040057, 2, 3, 57, NULL, 3, true, true, 'ALARM ELECTRICAL PROTECTION TRIGGERED', 'ALARM ELECTRICAL PROTECTION TRIGGERED', 'LBL_ALARM_CONFIGS_ALARM_ELECTRICAL_PROTECTION_TRIGGERED', 'LBL_ALARM_CONFIGS_ALARM_ELECTRICAL_PROTECTION_TRIGGERED_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(050057, 2, 6, 57, NULL, 3, true, true, 'ALARM INTERRUPTOR SELECCIONADOR PAT CELDA MT', 'ALARM INTERRUPTOR SELECCIONADOR PAT CELDA MT', 'LBL_ALARM_CONFIGS_ALARM_INTERRUPTOR_SELECCIONADOR_PAT_CELDA_MT', 'LBL_ALARM_CONFIGS_ALARM_INTERRUPTOR_SELECCIONADOR_PAT_CELDA_MT', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(060057, 2, 6, 57, NULL, 3, true, true, 'ALARM INTERRUPTOR INTERRUPTOR DESCONECTADOR CELDA MT', 'ALARM INTERRUPTOR INTERRUPTOR DESCONECTADOR CELDA MT', 'LBL_ALARM_CONFIGS_ALARM_INTERRUPTOR_INTERRUPTOR_DESCONECTADOR_CELDA_MT', 'LBL_ALARM_CONFIGS_ALARM_INTERRUPTOR_INTERRUPTOR_DESCONECTADOR_CELDA_MT', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(070057, 2, 6, 57, NULL, 3, true, true, 'ALARM INTERRUPTOR ESTADO FUSIBLES', 'ALARM INTERRUPTOR ESTADO FUSIBLES', 'LBL_ALARM_CONFIGS_ALARM_INTERRUPTOR_ESTADO_FUSIBLES', 'LBL_ALARM_CONFIGS_ALARM_INTERRUPTOR_ESTADO_FUSIBLES', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(080057, 2, 6, 57, NULL, 3, true, true, 'ALARM WITHOUT MAINS VOLTAGE', 'ALARM WITHOUT MAINS VOLTAGE', 'LBL_ALARM_CONFIGS_ALARM_WITHOUT_MAINS_VOLTAGE', 'LBL_ALARM_CONFIGS_ALARM_WITHOUT_MAINS_VOLTAGE', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
