...
--CONFIG
(41,1,1, NULL,2, ' ', 'brand', 'brand', 'LBL_ELEMENT_TYPE_PARAM_BRAND' , 'LBL_ELEMENT_TYPE_PARAM_BRAND_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(41,1,2, NULL,2, ' ', 'model', 'model', 'LBL_ELEMENT_TYPE_PARAM_MODEL' , 'LBL_ELEMENT_TYPE_PARAM_MODEL_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(41,1,1003, NULL,2, ' ', 'MANGO SESSION_UID', 'MANGO SESSION_UID', 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID' , 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(131, 2, 5, 41, NULL, 3, true, true, 'ALARM PLC_CABINET DOOR OPEN', 'ALARM PLC_CABINET DOOR OPEN', 'LBL_ALARM_CONFIGS_ALARM_PLC_CABINET_DOOR_OPEN', 'LBL_ALARM_CONFIGS_ALARM_PLC_CABINET_DOOR_OPEN_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(132, 2, 5, 41, NULL, 3, true, true, 'ALARM PLC_CABINET POWER SUPPLY FAIL', 'ALARM PLC_POWER SUPPLY FAIL', 'LBL_ALARM_CONFIGS_ALARM_PLC_CABINET_POWER_SUPPLY_FAIL', 'LBL_ALARM_CONFIGS_ALARM_PLC_CABINET_POWER_SUPPLY_FAIL_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(133, 2, 5, 41, NULL, 3, true, true, 'ALARM PLC_CABINET BATTERY LOW', 'ALARM PLC_CABINET BATTERY LOW', 'LBL_ALARM_CONFIGS_ALARM_PLC_CABINET_BATTERY_LOW', 'LBL_ALARM_CONFIGS_ALARM_PLC_CABINET_BATTERY_LOW_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(134, 2, 5, 41, NULL, 3, true, true, 'ALARM PLC_CABINET OVERLOAD UPS', 'ALARM PLC_CABINET OVERLOAD UPS', 'LBL_ALARM_CONFIGS_ALARM_PLC_CABINET_OVERLOAD_UPS', 'LBL_ALARM_CONFIGS_ALARM_PLC_CABINET_OVERLOAD_UPS_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(135, 2, 5, 41, NULL, NULL, true, true, 'ALARM PLC_CABINET NO CONNECTION', 'ALARM PLC_CABINET NO CONNECTION', 'LBL_ALARM_CONFIGS_ALARM_PLC_CABINET_NO_CONNECTION', 'LBL_ALARM_CONFIGS_ALARM_PLC_CABINET_NO_CONNECTION_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(41, 2, 135, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);