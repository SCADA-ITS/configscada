...
(53, 2, 3, 18, NULL, NULL, true, true, 'ALARM ANEM_INT NO CONNECTION', 'ALARM ANEM_INT NO CONNECTION', 'LBL_ALARM_CONFIGS_ALARM_ANEM_INT_NO_CONNECTION', 'LBL_ALARM_CONFIGS_ALARM_ANEM_INT_NO_CONNECTION_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(245, 2, 3, 18, NULL, 3, true, true, 'ALARM SENSOR', 'ALARM SENSOR', 'LBL_ALARM_CONFIGS_ALARM_ANEM_SENSOR', 'LBL_ALARM_CONFIGS_ALARM_SENSOR_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(259, 2, 3, 18, NULL, 3, true, true, 'ALARM FA', 'ALARM FA', 'LBL_ALARM_CONFIGS_ALARM_ANEM_FA', 'LBL_ALARM_CONFIGS_ALARM_FA_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(18, 2, 53, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
