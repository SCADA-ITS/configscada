...
(37, 2, 3, 5, NULL, NULL, true, true, 'ALARM PA SYSTEM NO CONNECTION', 'ALARM PA SYSTEM NO CONNECTION', 'LBL_ALARM_CONFIGS_ALARM_PA_SYSTEM_NO_CONNECTION', 'LBL_ALARM_CONFIGS_ALARM_PA_SYSTEM_NO_CONNECTION_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(38, 2, 3, 5, NULL, 3, true, true, 'ALARM GENERAL', 'ALARM GENERAL', 'LBL_ALARM_CONFIGS_ALARM_PA_SYSTEM_GENERAL', 'LBL_ALARM_CONFIGS_ALARM_GENERAL_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(5, 2, 37, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
