...
(2001, NULL, 'VENTILATION', 'Tunnel ventilation system', 'LBL_ELEMENT_TYPE_VENTILATION', 'LBL_ELEMENT_TYPE_VENTILATION_DESC', 0, 1, 2, true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
