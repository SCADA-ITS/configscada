...
(020017, 2, 3, 17, NULL, 3, true, true, 'ALARM GALIBO CONTROLLER CABINET DOOR OPEN', 'ALARM GALIBO CONTROLLER CABINET DOOR OPEN', 'LBL_ALARM_CONFIGS_ALARM_GALIBO_CONTROLLER_CABINET_DOOR_OPEN', 'LBL_ALARM_CONFIGS_ALARM_GALIBO_CONTROLLER_CABINET_DOOR_OPEN', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
