...
--CONFIG
(16, 1, 5, null, 1, ' ', 'zone_id', 'zone_id', 'LBL_ELEMENT_TYPE_PARAM_PA_ZONE_ZONE_ID' , 'LBL_ELEMENT_TYPE_PARAM_PA_ZONE_ZONE_ID_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(16, 1, 6, null, 2, ' ', 'group_zones', 'group_zones', 'LBL_ELEMENT_TYPE_PARAM_PA_ZONE_GROUP_ZONES' , 'LBL_ELEMENT_TYPE_PARAM_PA_ZONE_GROUP_ZONES_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(16, 1, 1003, null, 2, '', 'MANGO SESSION_UID', 'MANGO SESSION_UID', 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID' , 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
--MEASURE
...
(50, 2, 3, 16, NULL, NULL, true, true, 'ALARM PA ZONE NO CONNECTION', 'ALARM PA ZONE NO CONNECTION', 'LBL_ALARM_CONFIGS_ALARM_ANALIZADOR_PA_ZONE_NO_CONNECTION', 'LBL_ALARM_CONFIGS_ALARM_PA_SYSTEM_NO_CONNECTION_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(51, 2, 3, 16, NULL, 3, true, true, 'ALARM ZONE', 'ALARM ZONE', 'LBL_ALARM_CONFIGS_ALARM_PA_ZONE', 'LBL_ALARM_CONFIGS_ALARM_PA_ZONE_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(52, 2, 3, 16, NULL, 3, true, true, 'ALARM EMERGENCY', 'ALARM EMERGENCY', 'LBL_ALARM_CONFIGS_ALARM_EMERGENCY', 'LBL_ALARM_CONFIGS_ALARM_EMERGENCY_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(16, 2, 50, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
