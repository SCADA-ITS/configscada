...
--CONFIG
(11,1,1, NULL,2, ' ', 'brand', 'brand', 'LBL_ELEMENT_TYPE_PARAM_BRAND' , 'LBL_ELEMENT_TYPE_PARAM_BRAND_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(11,1,2, NULL,2, ' ', 'model', 'model', 'LBL_ELEMENT_TYPE_PARAM_MODEL' , 'LBL_ELEMENT_TYPE_PARAM_MODEL_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(11,1,3, NULL,2, ' ', 'extension', 'extension', 'LBL_ELEMENT_TYPE_PARAM_EXTENSION' , 'LBL_ELEMENT_TYPE_PARAM_EXTENSION_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(11,1,1003, NULL,2, '', 'MANGO SESSION_UID', 'MANGO SESSION_UID', 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID' , 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(41, 4, 3, 11, NULL, NULL, true, true, 'ALARM SOS NO CONNECTION', 'ALARM SOS NO CONNECTION', 'LBL_ALARM_CONFIGS_ALARM_SOS_NO_CONNECTION', 'LBL_ALARM_CONFIGS_ALARM_SOS_NO_CONNECTION_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
-- Subtipo SOS
(42, 2, 3, 11, NULL, 3, true, true, 'ALARM SOS DOOR OPEN', 'ALARM SOS DOOR OPEN', 'LBL_ALARM_CONFIGS_ALARM_SOS_DOOR_OPEN', 'LBL_ALARM_CONFIGS_ALARM_SOS_DOOR_OPEN_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(43, 2, 3, 11, NULL, 3, true, true, 'ALARM SOS FA BOARD', 'ALARM SOS FA BOARD', 'LBL_ALARM_CONFIGS_ALARM_SOS_FA_BOARD', 'LBL_ALARM_CONFIGS_ALARM_SOS_FA_BOARD_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
-- Subtipos SOS Modbus y SOS cabinet Modbus
(44, 2, 3, 11, NULL, 3, true, true, 'ALARM SOS LEFT EXTINGUISHER DOOR OPEN', 'ALARM SOS LEFT EXTINGUISHER DOOR OPEN', 'LBL_ALARM_CONFIGS_ALARM_SOS_LEFT_EXTINGUISHER_DOOR_OPEN', 'LBL_ALARM_CONFIGS_ALARM_SOS_LEFT_EXTINGUISHER_DOOR_OPEN_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(45, 2, 3, 11, NULL, 3, true, true, 'ALARM SOS RIGHT EXTINGUISHER DOOR OPEN', 'ALARM SOS RIGHT EXTINGUISHER DOOR OPEN', 'LBL_ALARM_CONFIGS_ALARM_SOS_RIGHT_EXTINGUISHER_DOOR_OPEN', 'LBL_ALARM_CONFIGS_ALARM_SOS_RIGHT_EXTINGUISHER_DOOR_OPEN_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(306, 2, 3, 11, NULL, 3, true, true, 'ALARM SOS EXTINGUISHER DOOR OPEN', 'ALARM SOS EXTINGUISHER DOOR OPEN', 'LBL_ALARM_CONFIGS_ALARM_SOS_EXTINGUISHER_DOOR_OPEN', 'LBL_ALARM_CONFIGS_ALARM_SOS_EXTINGUISHER_DOOR_OPEN_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(307, 2, 3, 11, NULL, 3, true, true, 'ALARM SOS EXTINGUISHER EXTRACTION', 'ALARM SOS EXTINGUISHER EXTRACTION', 'LBL_ALARM_CONFIGS_ALARM_SOS_EXTINGUISHER_EXTRACTION', 'LBL_ALARM_CONFIGS_ALARM_SOS_EXTINGUISHER_EXTRACTION_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(11001, 2, 5, 11, NULL, 3, true, true, 'ALARM SOS SIP', 'ALARM SOS SIP', 'LBL_ALARM_CONFIGS_ALARM_SOS_SIP', 'LBL_ALARM_CONFIGS_ALARM_SOS_SIP_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(11003, 2, 3, 11, NULL, 3, true, true, 'ALARM SOS SIP REGISTER', 'ALARM SOS SIP REGISTER', 'LBL_ALARM_CONFIGS_ALARM_SOS_SIP_REGISTER', 'LBL_ALARM_CONFIGS_ALARM_SOS_SIP_REGISTER_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(11, 2, 41, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);