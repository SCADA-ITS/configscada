...
(49, 2, 3, 15, NULL, NULL, true, true, 'ALARM FIRE_DET NO CONNECTION', 'ALARM FIRE_DET NO CONNECTION', 'LBL_ALARM_CONFIGS_ALARM_FIRE_DET_NO_CONNECTION', 'LBL_ALARM_CONFIGS_ALARM_FIRE_DET_NO_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(256, 2, 6, 15, NULL, 3, true, true, 'ALARM ZONE', 'ALARM ZONE', 'LBL_ALARM_CONFIGS_ALARM_FIRE_ZONE', 'LBL_ALARM_CONFIGS_ALARM_FIRE_ZONE_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(257, 2, 3, 15, NULL, 3, true, true, 'ALARM FIBER FAULT', 'ALARM FIBER FAULT', 'LBL_ALARM_CONFIGS_ALARM_FIBER_FAULT', 'LBL_ALARM_CONFIGS_ALARM_FIBER_FAULT_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(010015, 2, 3, 15, NULL, 3, true, true, 'ALARM MIN TEMP', 'ALARM MIN TEMP', 'LBL_ALARM_CONFIGS_ALARM_MIN_TEMP', 'LBL_ALARM_CONFIGS_ALARM_MIN_TEMP', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(020015, 2, 3, 15, NULL, 3, true, true, 'ALARM ENVIRONMENTAL', 'ALARM ENVIRONMENTAL', 'LBL_ALARM_CONFIGS_ALARM_ENVIRONMENTAL', 'LBL_ALARM_CONFIGS_ALARM_ENVIRONMENTAL', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(15, 2, 49, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
