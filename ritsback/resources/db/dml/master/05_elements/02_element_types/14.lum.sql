...
--CONFIG
(14,1,1, NULL,2, NULL, 'brand', 'brand', 'LBL_ELEMENT_TYPE_PARAM_BRAND' , 'LBL_ELEMENT_TYPE_PARAM_BRAND_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(14,1,2, NULL,2, NULL, 'model', 'model', 'LBL_ELEMENT_TYPE_PARAM_MODEL' , 'LBL_ELEMENT_TYPE_PARAM_MODEL_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(14,1,1003, NULL,2, NULL, 'MANGO SESSION_UID', 'MANGO SESSION_UID', 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID' , 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
--MEASURE
...
(010014, 4, 3, 14, NULL, NULL, true, true, 'ALARM LUM NO CONNECTION', 'ALARM LUM NO CONNECTION', 'LBL_ALARM_CONFIGS_ALARM_LUM_NO_CONNECTION', 'LBL_ALARM_CONFIGS_ALARM_LUM_NO_CONNECTION_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(020014, 2, 5, 14, NULL, 3, true, true, 'ALARM SENSOR', 'ALARM SENSOR', 'LBL_ALARM_CONFIGS_ALARM_LUM_SENSOR', 'LBL_ALARM_CONFIGS_ALARM_SENSOR_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(030014, 2, 3, 14, NULL, 3, true, true, 'ALARM BROKEN THREAD', 'ALARM BROKEN THREAD', 'LBL_ALARM_CONFIGS_ALARM_BROKEN_THREAD', 'LBL_ALARM_CONFIGS_ALARM_BROKEN_THREAD_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(14, 2, 010014, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);