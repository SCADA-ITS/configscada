...
(2, 87, 'Diesel Tank', 'Diesel Tank','LBL_ELEMENT_SUBTYPE_DIESEL_TANK', 'LBL_ELEMENT_SUBTYPE_DIESEL_TANK_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(2, 87, 2, 2, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);