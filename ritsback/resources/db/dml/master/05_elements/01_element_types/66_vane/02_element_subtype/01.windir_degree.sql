...
(1, 66, 'VANE', 'VANE', 'LBL_ELEMENT_SUBTYPE_VANE', 'LBL_ELEMENT_SUBTYPE_VANE_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(1, 66, 2, 1, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1, 66, 2, 2, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1, 66, 2, 4, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);