...
(90,1,5, NULL,1, null, 'sftpIp', 'sftpIp', 'LBL_ELEMENT_TYPE_PARAM_SFTP_IP', 'LBL_ELEMENT_TYPE_PARAM_SFTP_IP_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(90,1,6, NULL,1, null, 'sftpUser', 'sftpUser', 'LBL_ELEMENT_TYPE_PARAM_SFTP_USER', 'LBL_ELEMENT_TYPE_PARAM_SFTP_USER_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(90,1,7, NULL,1, null, 'sftpPassword', 'sftpPassword', 'LBL_ELEMENT_TYPE_PARAM_SFTP_PASSWORD', 'LBL_ELEMENT_TYPE_PARAM_SFTP_PASSWORD_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(90,1,8, NULL,1, null, 'sftpPath', 'sftpPath', 'LBL_ELEMENT_TYPE_PARAM_SFTP_PATH', 'LBL_ELEMENT_TYPE_PARAM_SFTP_PATH_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
