...
VALUES
(1, 71, 'VMS_AC_BD_3LCS', 'VMS_AC_BD_3LCS', 'LBL_ELEMENT_SUBTYPE_PANEL_VMS_AC_BD_3LCS', 'LBL_ELEMENT_SUBTYPE_PANEL_VMS_AC_BD_3LCS_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(1, 71, 2, 1, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1, 71, 2, 2, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1, 71, 2, 3, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1, 71, 2, 11, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(1, 3, 71, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1, 5, 71, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);