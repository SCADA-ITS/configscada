...
--
INSERT INTO master.element_types(element_type_id, alias, description,label_alias, label_description, initial_element_type_state_id, connected_element_type_state_id, disconnected_element_type_state_id, check_if_connected, enabled, visible, created_at, updated_at) VALUES
(71, 'Panel', 'Panel', 'LBL_ELEMENT_TYPE_PANEL', 'LBL_ELEMENT_TYPE_PANEL_DESC', 0, 1, 2, true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
--CONFIG
(71,1,1, NULL,2, NULL, 'brand', 'brand', 'LBL_ELEMENT_TYPE_PARAM_BRAND' , 'LBL_ELEMENT_TYPE_PARAM_BRAND_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(71,1,2, NULL,2, NULL, 'model', 'model', 'LBL_ELEMENT_TYPE_PARAM_MODEL' , 'LBL_ELEMENT_TYPE_PARAM_MODEL_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(71,1,3, NULL,2, NULL, 'protocolo', 'protocolo', 'LBL_ELEMENT_TYPE_PARAM_PROTOCOL' , 'LBL_ELEMENT_TYPE_PARAM_PROTOCOL_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(71,1,4, NULL,2, NULL, 'config json', 'config json', 'LBL_ELEMENT_TYPE_PARAM_CONFIG' , 'LBL_ELEMENT_TYPE_PARAM_CONFIG_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(71,1,6, NULL,2, NULL, 'armario asociado', 'armario asociado', 'LBL_ELEMENT_TYPE_PARAM_ELECTRICAL_CABINET' , 'LBL_ELEMENT_TYPE_PARAM_ELECTRICAL_CABINET_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(71,1,7, NULL,2, NULL, 'CH', 'CH', 'LBL_ELEMENT_TYPE_PARAM_PK' , 'LBL_ELEMENT_TYPE_PARAM_PK_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(71,1,8, NULL,2, NULL, 'panel code', 'panel code', 'LBL_ELEMENT_TYPE_PARAM_PANEL_CODE' , 'LBL_ELEMENT_TYPE_PARAM_PANEL_CODE_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(71,1,9, NULL,5, NULL, 'travel_time_configurable', 'travel_time_configurable', 'LBL_ELEMENT_TYPE_PARAM_TRAVEL_TIME_CONFIGURABLE' , 'LBL_ELEMENT_TYPE_PARAM_TRAVEL_TIME_CONFIGURABLE_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(71,1,1003, NULL,2, NULL, 'MANGO SESSION_UID', 'MANGO SESSION_UID', 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID' , 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
--MEASURE
(71,2,1,NULL,1, NULL, 'brightness', 'brightness', 'LBL_ELEMENT_TYPE_PARAM_BRIGHTNESS' , 'LBL_ELEMENT_TYPE_PARAM_BRIGHTNESS_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(71,2,2,8,1, NULL, 'temperature', 'temperature', 'LBL_ELEMENT_TYPE_PARAM_PANEL_TEMPERATURE' , 'LBL_ELEMENT_TYPE_PARAM_PANEL_TEMPERATURE_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(71,2,3,NULL,2, NULL, 'data_json', 'data_json', 'LBL_ELEMENT_TYPE_PARAM_PANEL_DATA' , 'LBL_ELEMENT_TYPE_PARAM_PANEL_DATA_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(71,2,4,NULL,1, NULL, 'actual_brightness_state', 'actual_brightness_state', 'LBL_ELEMENT_TYPE_PARAM_ACTUAL_BRIGHTNESS_STATE' , 'LBL_ELEMENT_TYPE_PARAM_ACTUAL_BRIGHTNESS_STATE_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(71,2,5,NULL,1, NULL, 'beacons', 'beacons', 'LBL_ELEMENT_TYPE_PARAM_ACTUAL_BEACONS' , 'LBL_ELEMENT_TYPE_PARAM_ACTUAL_BEACONS_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(71,2,6,NULL,1, NULL, 'pixel_service', 'pixel_service', 'LBL_ELEMENT_TYPE_PARAM_ACTUAL_PIXEL_SERVICE' , 'LBL_ELEMENT_TYPE_PARAM_ACTUAL_PIXEL_SERVICE_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(71,2,8,NULL,2, NULL, 'rate', 'rate', 'LBL_ELEMENT_TYPE_PARAM_RATE' , 'LBL_ELEMENT_TYPE_PARAM_RATE_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(71,2,9,NULL,2, NULL, 'crc', 'crc', 'LBL_ELEMENT_TYPE_PARAM_CRC' , 'LBL_ELEMENT_TYPE_PARAM_CRC_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(71,2,10,NULL,5, NULL, 'travel_time_enabled', 'travel_time_enabled', 'LBL_ELEMENT_TYPE_PARAM_TRAVEL_TIME_ENABLED' , 'LBL_ELEMENT_TYPE_PARAM_TRAVEL_TIME_ENABLED_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(71,2,11,NULL,1, '0', 'priority', 'priority', 'LBL_ELEMENT_TYPE_PARAM_PRIORITY' , 'LBL_ELEMENT_TYPE_PARAM_PRIORITY', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(71,2,12,NULL,5, NULL, 'state', 'state', 'LBL_ELEMENT_TYPE_PARAM_STATE' , 'LBL_ELEMENT_TYPE_PARAM_STATE_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(71,2,1001,NULL,2, NULL, 'graphic_conversion', 'provisional data conversion', 'LBL_ELEMENT_TYPE_PARAM_PROVISIONAL_DATA' , 'LBL_ELEMENT_TYPE_PARAM_PROVISIONAL_DATA_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(080071, 2, 5, 71, NULL, 3, true, true, 'ALARM PMV VENTILATION ACTIVATED', 'ALARM PMV VENTILATION ACTIVATED', 'LBL_ALARM_CONFIGS_ALARM_PMV_VENTILATION_ACTIVATED', 'LBL_ALARM_CONFIGS_ALARM_PMV_VENTILATION_ACTIVATED_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(090071, 2, 5, 71, NULL, 3, true, true, 'ALARM PMV VENTILATION ERROR', 'ALARM PMV VENTILATION ERROR', 'LBL_ALARM_CONFIGS_ALARM_PMV_VENTILATION_ERROR', 'LBL_ALARM_CONFIGS_ALARM_PMV_VENTILATION_ERROR_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(100071, 2, 5, 71, NULL, 3, true, true, 'ALARM PMV INTERNAL HARDWARE ERROR', 'ALARM PMV INTERNAL HARDWARE ERROR', 'LBL_ALARM_CONFIGS_ALARM_PMV_INTERNAL_HARDWARE_ERROR', 'LBL_ALARM_CONFIGS_ALARM_PMV_INTERNAL_HARDWARE_ERROR_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
