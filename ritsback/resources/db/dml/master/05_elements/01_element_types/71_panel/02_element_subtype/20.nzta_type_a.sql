...
VALUES
(20, 71, 'VMS_NZTA_TYPE_A', 'VMS_NZTA_TYPE_A', 'LBL_ELEMENT_SUBTYPE_PANEL_VMS_VMS_NZTA_TYPE_A', 'LBL_ELEMENT_SUBTYPE_PANEL_VMS_VMS_NZTA_TYPE_A_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(20, 71, 2, 1, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(20, 71, 2, 2, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(20, 71, 2, 3, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(20, 2, 71, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(20, 3, 71, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
