...
VALUES
(28, 71, 'VMS_INCIDENTS_TASKS', 'VMS_INCIDENTS_TASKS', 'LBL_ELEMENT_SUBTYPE_PANEL_INCIDENTS_TASKS', 'LBL_ELEMENT_SUBTYPE_PANEL_INCIDENTS_TASKS_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(28, 71, 2, 1, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(28, 71, 2, 2, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(28, 71, 2, 3, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(28, 2, 71, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(28, 3, 71, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);