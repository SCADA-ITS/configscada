...
VALUES
(8, 71, 'VMS_SNOW', 'VMS_SNOW', 'LBL_ELEMENT_SUBTYPE_PANEL_VMS_SNOW', 'LBL_ELEMENT_SUBTYPE_PANEL_VMS_SNOW_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(8, 71, 2, 1, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(8, 71, 2, 2, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(8, 71, 2, 3, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(8, 3, 71, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(8, 4, 71, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);