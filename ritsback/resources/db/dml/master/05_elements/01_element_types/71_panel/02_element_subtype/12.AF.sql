...
VALUES
(12, 71, 'VMS_AF', 'VMS_AF', 'LBL_ELEMENT_SUBTYPE_PANEL_VMS_AF', 'LBL_ELEMENT_SUBTYPE_PANEL_VMS_AF_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(12, 71, 2, 1, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(12, 71, 2, 3, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(12, 71, 2, 4, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(12, 2, 71, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(12, 3, 71, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(12, 5, 71, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(12, 6, 71, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(12, 7, 71, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
