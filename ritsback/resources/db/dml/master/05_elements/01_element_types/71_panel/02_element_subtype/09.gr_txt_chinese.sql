...
VALUES
(9, 71, 'VMS_GR_TXT_CHINESE', 'VMS_GR_TXT_CHINESE', 'LBL_ELEMENT_SUBTYPE_PANEL_VMS_GR_TXT_CHINESE', 'LBL_ELEMENT_SUBTYPE_PANEL_VMS_GR_TXT_CHINESE_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(9, 71, 2, 1, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(9, 71, 2, 2, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(9, 71, 2, 3, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(9, 2, 71, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(9, 3, 71, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
