...
(11,2,15,NULL,1, NULL, 'meg_state', 'meg_state', 'LBL_ELEMENT_TYPE_PARAM_MEG_STATE', 'LBL_ELEMENT_TYPE_PARAM_MEG_STATE_DESC', true, true, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(11,2,16,NULL,1, NULL, 'vol_meg', 'vol_meg', 'LBL_ELEMENT_TYPE_PARAM_VOL_MEG', 'LBL_ELEMENT_TYPE_PARAM_VOL_MEG_DESC', true, true, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(4, 11, 'SOS cabinet DGT', 'SOS cabinet Dgt', 'LBL_ELEMENT_SUBTYPE_SOS_CABINET_DGT', 'LBL_ELEMENT_SUBTYPE_SOS_CABINET_DGT_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(11, 11, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(4, 11, 2, 4, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(4, 11, 2, 15, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(4, 11, 2, 16, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
--alarmas jaen
(090011, 2, 3, 11, NULL, 3, true, true, 'ALARM SOS LOW BATTERY', 'ALARM SOS DOOR LOW BATTERY', 'LBL_ALARM_CONFIGS_ALARM_SOS_LOW_BATTERY', 'LBL_ALARM_CONFIGS_ALARM_SOS_LOW_BATTERY_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(100011, 2, 3, 11, NULL, 3, true, true, 'ALARM SOS POWER FAILURE', 'ALARM SOS POWER FAILURE', 'LBL_ALARM_CONFIGS_ALARM_SOS_POWER_FAILURE', 'LBL_ALARM_CONFIGS_ALARM_SOS_POWER_FAILURE_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(110011, 2, 3, 11, NULL, 3, true, true, 'ALARM SOS AUDIO ENABLE', 'ALARM SOS AUDIO ENABLE', 'LBL_ALARM_CONFIGS_ALARM_SOS_AUDIO_ENABLE', 'LBL_ALARM_CONFIGS_ALARM_SOS_AUDIO_ENABLE_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(120011, 2, 3, 11, NULL, 3, true, true, 'ALARM SOS RINGTONE ENABLE', 'ALARM SOS DOOR RINGTONE ENABLE', 'LBL_ALARM_CONFIGS_ALARM_SOS_RINGTONE_ENABLE', 'LBL_ALARM_CONFIGS_ALARM_SOS_RINGTONE_ENABLE_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(130011, 2, 3, 11, NULL, 3, true, true, 'ALARM SOS AUDIO MESSAGE ENABLE', 'ALARM SOS AUDIO MESSAGE ENABLE', 'LBL_ALARM_CONFIGS_ALARM_SOS_AUDIO_MESSAGE_ENABLE', 'LBL_ALARM_CONFIGS_ALARM_SOS_AUDIO_MESSAGE_ENABLE_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
