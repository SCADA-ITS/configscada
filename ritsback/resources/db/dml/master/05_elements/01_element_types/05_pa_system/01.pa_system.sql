...
(5, 'PA_SYSTEM', 'PA_SYSTEM', 'LBL_ELEMENT_TYPE_PA_SYSTEM', 'LBL_ELEMENT_TYPE_PA_SYSTEM_DESC', 0, 1, 2, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
--CONFIG
(5,1,1,NULL,2, NULL, 'brand', 'brand', 'LBL_ELEMENT_TYPE_PARAM_BRAND' , 'LBL_ELEMENT_TYPE_PARAM_BRAND_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5,1,2,NULL,2, NULL, 'model', 'model', 'LBL_ELEMENT_TYPE_PARAM_MODEL' , 'LBL_ELEMENT_TYPE_PARAM_MODEL_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5,1,5,NULL,2, NULL, 'sender_ip', 'sender_ip', 'LBL_ELEMENT_TYPE_PARAM_PA_SYSTEM_SENDER_IP' , 'LBL_ELEMENT_TYPE_PARAM_PA_SYSTEM_SENDER_IP_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5,1,1003,NULL,2, NULL, 'MANGO SESSION_UID', 'MANGO SESSION_UID', 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID' , 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
