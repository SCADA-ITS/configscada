...
(5, 9, 'Jetfan Type 4', 'Jetfan Type 4', 'LBL_ELEMENT_SUBTYPE_JETFAN_TYPE_4', 'LBL_ELEMENT_SUBTYPE_JETFAN_TYPE_4_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(5, 9, 2, 1, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 9, 2, 2, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 9, 2, 15, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 9, 2, 29, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(5, 1, 9, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 2, 9, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 3, 9, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 11, 9, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
