...
(73, 2, 2, NULL, 1, null, 'OFF', 'OFF', 'LBL_ELEMENT_TYPE_PARAM_OFF' , 'LBL_ELEMENT_TYPE_PARAM_OFF_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(73, 2, 3, NULL, 1, null, 'REMOTE', 'REMOTE', 'LBL_ELEMENT_TYPE_PARAM_REMOTE' , 'LBL_ELEMENT_TYPE_PARAM_REMOTE_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
