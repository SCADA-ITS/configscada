...
(95, 'SYNC_SERVER', 'SYNC_SERVER', 'LBL_ELEMENT_TYPE_SYNC_SERVER', 'LBL_ELEMENT_TYPE_SYNC_SERVER_DESC', 0, 1, 2, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
--CONFIG
(95, 1, 1, NULL, 2, NULL, 'brand', 'brand', 'LBL_ELEMENT_TYPE_PARAM_BRAND' , 'LBL_ELEMENT_TYPE_PARAM_BRAND_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(95, 1, 2, NULL, 2, NULL, 'model', 'model', 'LBL_ELEMENT_TYPE_PARAM_MODEL' , 'LBL_ELEMENT_TYPE_PARAM_MODEL_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(95,1,1003, NULL,2, NULL, 'MANGO SESSION_UID', 'MANGO SESSION_UID', 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID' , 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
--MEASURE
(95,2,1,null,1, NULL, 'modulo_alimentacion1_state', 'modulo_alimentacion1_state', 'LBL_ELEMENT_TYPE_PARAM_MODULO_ALIMENTACION1_STATE' , 'LBL_ELEMENT_TYPE_PARAM_MODULO_ALIMENTACION1_STATE_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(95,2,2,null,1, NULL, 'modulo_alimentacion2_state', 'modulo_alimentacion2_state', 'LBL_ELEMENT_TYPE_PARAM_MODULO_ALIMENTACION2_STATE' , 'LBL_ELEMENT_TYPE_PARAM_MODULO_ALIMENTACION2_STATE_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(95,2,3,null,1, NULL, 'modulo_basetiempos1_state', 'modulo_basetiempos1_state', 'LBL_ELEMENT_TYPE_PARAM_MODULO_BASETIEMPOS1_STATE' , 'LBL_ELEMENT_TYPE_PARAM_MODULO_BASETIEMPOS1_STATE_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(95,2,4,null,1, NULL, 'modulo_basetiempos1_nosync', 'modulo_basetiempos1_nosync', 'LBL_ELEMENT_TYPE_PARAM_MODULO_BASETIEMPOS1_NOSYNC' , 'LBL_ELEMENT_TYPE_PARAM_MODULO_BASETIEMPOS1_NOSYNC_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(95,2,5,null,1, NULL, 'modulo_basetiempos2_state', 'modulo_basetiempos2_state', 'LBL_ELEMENT_TYPE_PARAM_MODULO_BASETIEMPOS2_STATE' , 'LBL_ELEMENT_TYPE_PARAM_MODULO_BASETIEMPOS2_STATE_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(95,2,6,null,1, NULL, 'modulo_basetiempos2_nosync', 'modulo_basetiempos2_nosync', 'LBL_ELEMENT_TYPE_PARAM_MODULO_BASETIEMPOS2_NOSYNC' , 'LBL_ELEMENT_TYPE_PARAM_MODULO_BASETIEMPOS2_NOSYNC_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
