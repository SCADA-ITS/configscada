...
(47, 'ELECTRICAL_CABINET_TU', 'ELECTRICAL_CABINET_TU', 'LBL_ELEMENT_TYPE_ELECTRICAL_CABINET_TU', 'LBL_ELEMENT_TYPE_ELECTRICAL_CABINET_TU_DESC', 0, 1, 2, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
--CONFIG
(47,1,1, NULL,2, NULL,'brand', 'brand', 'LBL_ELEMENT_TYPE_PARAM_BRAND' , 'LBL_ELEMENT_TYPE_PARAM_BRAND_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(47,1,2, NULL,2, NULL, 'model', 'model', 'LBL_ELEMENT_TYPE_PARAM_MODEL' , 'LBL_ELEMENT_TYPE_PARAM_MODEL_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(47,1,1003, NULL,2, NULL, 'MANGO SESSION_UID', 'MANGO SESSION_UID', 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID' , 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(010047, 2, 6, 47, NULL, NULL, true, true, 'ALARM CABINET NO CONNECTION', 'ALARM CABINET NO CONNECTION', 'LBL_ALARM_CONFIGS_ALARM_CABINET_NO_CONNECTION', 'LBL_ALARM_CONFIGS_ALARM_CABINET_NO_CONNECTION_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(020047, 2, 5, 47, NULL, 3, true, true, 'ALARM CABINET DOOR OPEN', 'ALARM CABINET DOOR OPEN', 'LBL_ALARM_CONFIGS_ALARM_CABINET_DOOR_OPEN', 'LBL_ALARM_CONFIGS_ALARM_CABINET_DOOR_OPEN_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(030047, 2, 5, 47, NULL, 3, true, true, 'ALARM CABINET POWER SUPPLY FAIL', 'ALARM PLC_POWER SUPPLY FAIL', 'LBL_ALARM_CONFIGS_ALARM_PLC_POWER_SUPPLY_FAIL', 'LBL_ALARM_CONFIGS_ALARM_PLC_POWER_SUPPLY_FAIL_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(040047, 2, 5, 47, NULL, 3, true, true, 'ALARM CABINET BATTERY LOW', 'ALARM CABINET BATTERY LOW', 'LBL_ALARM_CONFIGS_ALARM_CABINET_BATTERY_LOW', 'LBL_ALARM_CONFIGS_ALARM_CABINET_BATTERY_LOW_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(050047, 2, 5, 47, NULL, 3, true, true, 'ALARM CABINET OVERLOAD UPS', 'ALARM CABINET OVERLOAD UPS', 'LBL_ALARM_CONFIGS_ALARM_CABINET_OVERLOAD_UPS', 'LBL_ALARM_CONFIGS_ALARM_CABINET_OVERLOAD_UPS_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(47, 2, 010047, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);