...
(2, 13, 'Semáforos Exteriores', 'Semáforos Exteriores', 'LBL_ELEMENT_SUBTYPE_SEM_EXT', 'LBL_ELEMENT_SUBTYPE_SEM_EXT_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(2, 13, 2, 1, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(2, 1, 13, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 2, 13, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 3, 13, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 4, 13, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 5, 13, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
