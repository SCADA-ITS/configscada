...
(37, 'IPL', 'IPL','LBL_ELEMENT_TYPE_IPL', 'LBL_ELEMENT_TYPE_IPL_DESC', 0, 1, 2, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
--CONFIG
(37, 1, 1, NULL, 2, NULL, 'brand', 'brand', 'LBL_ELEMENT_TYPE_PARAM_BRAND' , 'LBL_ELEMENT_TYPE_PARAM_BRAND_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(37, 1, 2, NULL, 2, NULL, 'model', 'model', 'LBL_ELEMENT_TYPE_PARAM_MODEL' , 'LBL_ELEMENT_TYPE_PARAM_MODEL_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(37, 1, 1003, NULL, 2, NULL, 'MANGO SESSION_UID', 'MANGO SESSION_UID', 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID' , 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
--MEASURE
...
(010037, 2, 3, 37, NULL, NULL, true, true, 'ALARM IPL DISCONNECTED', 'ALARM IPL DISCONNECTED', 'LBL_ALARM_CONFIGS_ALARM_IPL_DISCONNECTED', 'LBL_ALARM_CONFIGS_ALARM_IPL_DISCONNECTED_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(020037, 2, 3, 37, NULL, 3, true, true, 'ALARM IPL TEMPERATURA LINEA DE BALIZAS IPL 1200', 'Alarma Temperatura línea de balizas IPL 1200 - IPL 1200', 'LBL_ALARM_IPL_TEMPERATURA_LINEA_DE_BALIZAS', 'LBL_ALARM_IPL_TEMPERATURA_LINEA_DE_BALIZAS_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(030037, 2, 3, 37, NULL, 3, true, true, 'ALARM IPL TEMPERATURA EQUIPO IPL 1200', 'Alarma Temperatura equipo IPL 1200 - IPL 1200', 'LBL_ALARM_IPL_TEMPERATURA_EQUIPO', 'LBL_ALARM_IPL_TEMPERATURA_EQUIPO_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(040037, 2, 3, 37, NULL, 3, true, true, 'ALARM IPL FALLA IPL 1200', 'Alarma Fault IPL 1200 - IPL 1200', 'LBL_ALARM_IPL_FALLA', 'LBL_ALARM_IPL_FALLA_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(37, 2, 010037, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
