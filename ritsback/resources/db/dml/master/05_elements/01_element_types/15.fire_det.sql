...
--CONFIG
(15,1,1, NULL,2, NULL, 'brand', 'brand', 'LBL_ELEMENT_TYPE_PARAM_BRAND' , 'LBL_ELEMENT_TYPE_PARAM_BRAND_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(15,1,2, NULL,2, NULL, 'model', 'model', 'LBL_ELEMENT_TYPE_PARAM_MODEL' , 'LBL_ELEMENT_TYPE_PARAM_MODEL_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(15,1,5, NULL,2, NULL, 'pk_ini', 'pk_ini', 'LBL_ELEMENT_TYPE_PARAM_FIRE_DET_PK_INI' , 'LBL_ELEMENT_TYPE_PARAM_FIRE_DET_PK_INI_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(15,1,6, NULL,2, NULL, 'pk_end', 'pk_end', 'LBL_ELEMENT_TYPE_PARAM_FIRE_DET_PK_END' , 'LBL_ELEMENT_TYPE_PARAM_FIRE_DET_PK_END_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(15,1,1003, NULL,2, NULL, 'MANGO SESSION_UID', 'MANGO SESSION_UID', 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID', 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
--MEASURE
