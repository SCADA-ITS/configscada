...
(010051, 2, 5, 51, NULL, NULL, true, true, 'ALARM ETD NO CONNECTION', 'ALARM ETD NO CONNECTION', 'LBL_ALARM_CONFIGS_ALARM_ETD_NO_CONNECTION', 'LBL_ALARM_CONFIGS_ALARM_ETD_NO_CONNECTION_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(020051, 2, 3, 51, NULL, 3, true, true, 'ALARM ETD BATTERY LOW', 'ALARM ETD BATTERY LOW', 'LBL_ALARM_CONFIGS_ALARM_ETD_BATTERY_LOW', 'LBL_ALARM_CONFIGS_ALARM_ETD_BATTERY_LOW_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(030051, 2, 3, 51, NULL, 3, true, true, 'ALARM ETD POWER FAIL', 'ALARM ETD POWER FAIL', 'LBL_ALARM_CONFIGS_ALARM_ETD_POWER_FAIL', 'LBL_ALARM_CONFIGS_ALARM_ETD_POWER_FAIL_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(040051, 2, 3, 51, NULL, 3, true, true, 'ALARM ETD DOOR OPEN', 'ALARM ETD DOOR OPEN', 'LBL_ALARM_CONFIGS_ALARM_ETD_DOOR_OPEN', 'LBL_ALARM_CONFIGS_ALARM_ETD_DOOR_OPEN_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(51, 2, 010051, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
