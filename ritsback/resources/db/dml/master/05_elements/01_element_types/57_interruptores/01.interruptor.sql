...
--subtipo logica inversa
(57, 2, 2, NULL, 5, '', 'state', 'state', 'LBL_ELEMENT_TYPE_PARAM_INTERRUPTOR_STATE' , 'LBL_ELEMENT_TYPE_PARAM_INTERRUPTOR_STATE_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(030057, 2, 3, 57, NULL, 3, true, true, 'ALARM DIMMER CLOSED', 'ALARM DIMMER CLOSED', 'LBL_ALARM_CONFIGS_ALARM_DIMMER_CLOSED', 'LBL_ALARM_CONFIGS_ALARM_DIMMER_CLOSED_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
