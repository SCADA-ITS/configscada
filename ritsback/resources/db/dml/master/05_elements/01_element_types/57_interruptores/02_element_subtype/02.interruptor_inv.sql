...
(2, 57, 'Interruptor', 'Interruptor', 'LBL_ELEMENT_TYPE_INTERRUPTOR', 'LBL_ELEMENT_TYPE_INTERRUPTOR_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(2, 57, 2, 2, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
