...
--CONFIG
(99,1,1, NULL,2, null, 'brand', 'brand', 'LBL_ELEMENT_TYPE_PARAM_BRAND', 'LBL_ELEMENT_TYPE_PARAM_BRAND_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(99,1,2, NULL,2, null, 'model', 'model', 'LBL_ELEMENT_TYPE_PARAM_MODEL', 'LBL_ELEMENT_TYPE_PARAM_MODEL_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(99,1,3, NULL,2, null, 'type', 'type', 'LBL_ELEMENT_TYPE_PARAM_RADAR_TYPE', 'LBL_ELEMENT_TYPE_PARAM_RADAR_MODEL_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(99,1,4, NULL,2, null, 'connection', 'connection', 'LBL_ELEMENT_TYPE_PARAM_RADAR_CONNECTION', 'LBL_ELEMENT_TYPE_PARAM_RADAR_CONNECTION_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(99,1,5, NULL,2, null, 'cinemometer_serial', 'cinemometer_serial', 'LBL_ELEMENT_TYPE_PARAM_RADAR_CINEMOMETER_SERIAL', 'LBL_ELEMENT_TYPE_PARAM_RADAR_CINEMOMETER_SERIAL_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(99,1,6, NULL,2, null, 'cabinet_serial', 'cabine_serial', 'LBL_ELEMENT_TYPE_PARAM_RADAR_CABINET_SERIAL', 'LBL_ELEMENT_TYPE_PARAM_RADAR_CABINET_SERIAL_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(99,1,7, NULL,2, null, 'cabinet_model', 'cabine_model', 'LBL_ELEMENT_TYPE_PARAM_RADAR_CABINET_MODEL', 'LBL_ELEMENT_TYPE_PARAM_RADAR_CABINET_MODEL_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(99,1,8, NULL,2, null, 'instalation_type', 'instalation_type', 'LBL_ELEMENT_TYPE_PARAM_RADAR_INSTALATION_TYPE', 'LBL_ELEMENT_TYPE_PARAM_RADAR_INSTALATION_TYPE_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(99,1,9, NULL,2, null, 'certificate_date', 'certificate_date', 'LBL_ELEMENT_TYPE_PARAM_RADAR_CERTIFICATE_DATE', 'LBL_ELEMENT_TYPE_PARAM_RADAR_CERTIFICATE_DATE_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(99,1,10, NULL,2, null, 'street_dboid', 'street_dboid', 'LBL_ELEMENT_TYPE_PARAM_RADAR_STREET_DBOID', 'LBL_ELEMENT_TYPE_PARAM_RADAR_STREET_DBOID_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(99,1,11, NULL,2, null, 'instrument_code', 'instrument_code', 'LBL_ELEMENT_TYPE_PARAM_RADAR_INSTRUMENT_CODE', 'LBL_ELEMENT_TYPE_PARAM_RADAR_INSTRUMENT_CODE_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(99,1,12, NULL,2, null, 'infractionCorrectedVehicleSpeedId', 'infractionCorrectedVehicleSpeedId', 'LBL_ELEMENT_TYPE_PARAM_INFRACTION_CORRECTED_VEHICLE_SPEED', 'LBL_ELEMENT_TYPE_PARAM_INFRACTION_CORRECTED_VEHICLE_SPEED_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(99,1,13, NULL,2, null, 'bulletinLetter', 'bulletinLetter', 'LBL_ELEMENT_TYPE_PARAM_BULLETIN_LETTER', 'LBL_ELEMENT_TYPE_PARAM_BULLETIN_LETTER_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(99,1,14, NULL,2, null, 'speed_limit', 'speed_limit', 'LBL_ELEMENT_TYPE_PARAM_SPEED_LIMIT', 'LBL_ELEMENT_TYPE_PARAM_SPEED_LIMIT_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(99,1,15, NULL,2, null, 'road_type', 'road_type', 'LBL_ELEMENT_TYPE_PARAM_ROAD_TYPE', 'LBL_ELEMENT_TYPE_PARAM_ROAD_TYPE_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(99,1,16, NULL,2, null, 'location_type', 'location_type', 'LBL_ELEMENT_TYPE_PARAM_LOCATION_TYPE', 'LBL_ELEMENT_TYPE_PARAM_LOCATION_TYPE_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(99,1,17, NULL,2, null, 'limit_type', 'limit_type', 'LBL_ELEMENT_TYPE_PARAM_LIMIT_TYPE', 'LBL_ELEMENT_TYPE_PARAM_LIMIT_TYPE_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(99, 1, 5004, NULL, 2, NULL, 'sftp password', 'sftp password', 'LBL_ELEMENT_TYPE_PARAM_SFTP_PASSWORD' , 'LBL_ELEMENT_TYPE_PARAM_SFTP_PASSWORD_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(1, 99, 'SAIMA', 'SAIMA', 'LBL_ELEMENT_SUBTYPE_RADAR_SAIMA', 'LBL_ELEMENT_SUBTYPE_RADAR_SAIMA_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 99, 'TRADESEGUR_6F', 'TRADESEGUR_6F', 'LBL_ELEMENT_SUBTYPE_RADAR_TRADESEGUR_6F', 'LBL_ELEMENT_SUBTYPE_RADAR_TRADESEGUR_6F_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(3, 99, 'TRADESEGUR_MRC', 'TRADESEGUR_MRC', 'LBL_ELEMENT_SUBTYPE_RADAR_TRADESEGUR_MRC', 'LBL_ELEMENT_SUBTYPE_RADAR_TRADESEGUR_MRC_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(4, 99, 'TRADESEGUR_TC2', 'TRADESEGUR_TC2', 'LBL_ELEMENT_SUBTYPE_RADAR_TRADESEGUR_TC2', 'LBL_ELEMENT_SUBTYPE_RADAR_TRADESEGUR_TC2_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 99, 'LECTORVISION', 'LECTORVISION', 'LBL_ELEMENT_SUBTYPE_RADAR_LECTORVISION', 'LBL_ELEMENT_SUBTYPE_RADAR_LECTORVISION_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(6, 99, 'REVENGA', 'REVENGA', 'LBL_ELEMENT_SUBTYPE_RADAR_REVENGA', 'LBL_ELEMENT_SUBTYPE_RADAR_REVENGA_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
