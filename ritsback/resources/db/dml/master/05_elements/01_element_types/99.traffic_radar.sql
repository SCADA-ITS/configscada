...
(99,1,3, NULL,1, null, 'type', 'type', 'LBL_ELEMENT_TYPE_PARAM_TYPE', 'LBL_ELEMENT_TYPE_PARAM_MODEL_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(99,1,4, NULL,1, null, 'connection', 'connection', 'LBL_ELEMENT_TYPE_PARAM_CONNECTION', 'LBL_ELEMENT_TYPE_PARAM_CONNECTION_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(99,1,5, NULL,1, null, 'cinemometer_serial', 'cinemometer_serial', 'LBL_ELEMENT_TYPE_PARAM_CINEMOMETER_SERIAL', 'LBL_ELEMENT_TYPE_PARAM_CINEMOMETER_SERIAL_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(99,1,6, NULL,1, null, 'cabinet_serial', 'cabine_serial', 'LBL_ELEMENT_TYPE_PARAM_CABINET_SERIAL', 'LBL_ELEMENT_TYPE_PARAM_CABINET_SERIAL_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(99,1,7, NULL,1, null, 'cabinet_model', 'cabine_model', 'LBL_ELEMENT_TYPE_PARAM_CABINET_MODEL', 'LBL_ELEMENT_TYPE_PARAM_CABINET_MODEL_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(99,1,8, NULL,1, null, 'instalation_type', 'instalation_type', 'LBL_ELEMENT_TYPE_PARAM_INSTALATION_TYPE', 'LBL_ELEMENT_TYPE_PARAM_INSTALATION_TYPE_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(99,1,9, NULL,1, null, 'certificate_date', 'certificate_date', 'LBL_ELEMENT_TYPE_PARAM_CERTIFICATE_DATE', 'LBL_ELEMENT_TYPE_PARAM_CERTIFICATE_DATE_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
