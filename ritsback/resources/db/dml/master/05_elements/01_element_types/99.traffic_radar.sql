...
(99,1,3, NULL,1, null, 'type', 'type', 'LBL_ELEMENT_TYPE_PARAM_RADAR_TYPE', 'LBL_ELEMENT_TYPE_PARAM_RADAR_MODEL_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(99,1,4, NULL,1, null, 'connection', 'connection', 'LBL_ELEMENT_TYPE_PARAM_RADAR_CONNECTION', 'LBL_ELEMENT_TYPE_PARAM_RADAR_CONNECTION_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(99,1,5, NULL,1, null, 'cinemometer_serial', 'cinemometer_serial', 'LBL_ELEMENT_TYPE_PARAM_RADAR_CINEMOMETER_SERIAL', 'LBL_ELEMENT_TYPE_PARAM_RADAR_CINEMOMETER_SERIAL_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(99,1,6, NULL,1, null, 'cabinet_serial', 'cabine_serial', 'LBL_ELEMENT_TYPE_PARAM_RADAR_CABINET_SERIAL', 'LBL_ELEMENT_TYPE_PARAM_RADAR_CABINET_SERIAL_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(99,1,7, NULL,1, null, 'cabinet_model', 'cabine_model', 'LBL_ELEMENT_TYPE_PARAM_RADAR_CABINET_MODEL', 'LBL_ELEMENT_TYPE_PARAM_RADAR_CABINET_MODEL_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(99,1,8, NULL,1, null, 'instalation_type', 'instalation_type', 'LBL_ELEMENT_TYPE_PARAM_RADAR_INSTALATION_TYPE', 'LBL_ELEMENT_TYPE_PARAM_RADAR_INSTALATION_TYPE_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(99,1,9, NULL,1, null, 'certificate_date', 'certificate_date', 'LBL_ELEMENT_TYPE_PARAM_RADAR_CERTIFICATE_DATE', 'LBL_ELEMENT_TYPE_PARAM_RADAR_CERTIFICATE_DATE_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(99,1,10, NULL,1, null, 'street_dboid', 'street_dboid', 'LBL_ELEMENT_TYPE_PARAM_RADAR_STREET_DBOID', 'LBL_ELEMENT_TYPE_PARAM_RADAR_STREET_DBOID_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(99,1,11, NULL,1, null, 'instrument_code', 'instrument_code', 'LBL_ELEMENT_TYPE_PARAM_RADAR_INSTRUMENT_CODE', 'LBL_ELEMENT_TYPE_PARAM_RADAR_INSTRUMENT_CODE_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(99,1,12, NULL,1, null, 'infractionCorrectedVehicleSpeedId', 'infractionCorrectedVehicleSpeedId', 'LBL_ELEMENT_TYPE_PARAM_INFRACTION_CORRECTED_VEHICLE_SPEED', 'LBL_ELEMENT_TYPE_PARAM_INFRACTION_CORRECTED_VEHICLE_SPEED_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(99,1,13, NULL,1, null, 'bulletinLetter', 'bulletinLetter', 'LBL_ELEMENT_TYPE_PARAM_BULLETIN_LETTER', 'LBL_ELEMENT_TYPE_PARAM_BULLETIN_LETTER_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
