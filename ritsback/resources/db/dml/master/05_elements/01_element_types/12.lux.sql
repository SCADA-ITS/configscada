...
--CONFIG
(12,1,1, NULL,2, NULL, 'brand', 'brand', 'LBL_ELEMENT_TYPE_PARAM_BRAND' , 'LBL_ELEMENT_TYPE_PARAM_BRAND_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(12,1,2, NULL,2, NULL, 'model', 'model', 'LBL_ELEMENT_TYPE_PARAM_MODEL' , 'LBL_ELEMENT_TYPE_PARAM_MODEL_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(12,1,1003, NULL,2, NULL, 'MANGO SESSION_UID', 'MANGO SESSION_UID', 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID' , 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
--MEASURE
...
(010012, 4, 3, 12, NULL, NULL, true, true, 'ALARM LUX NO CONNECTION', 'ALARM LUX NO CONNECTION', 'LBL_ALARM_CONFIGS_ALARM_LUX_NO_CONNECTION', 'LBL_ALARM_CONFIGS_ALARM_LUX_NO_CONNECTION_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(020012, 2, 5, 12, NULL, 3, true, true, 'ALARM SENSOR', 'ALARM SENSOR', 'LBL_ALARM_CONFIGS_ALARM_LUX_SENSOR', 'LBL_ALARM_CONFIGS_ALARM_SENSOR_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(030012, 2, 3, 12, NULL, 3, true, true, 'ALARM FA', 'ALARM FA', 'LBL_ALARM_CONFIGS_ALARM_LUX_FA', 'LBL_ALARM_CONFIGS_ALARM_FA_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(040012, 2, 3, 12, NULL, 3, true, true, 'ALARM LOW LUMINOSITY', 'ALARM LOW LUMINOSITY', 'LBL_ALARM_CONFIGS_ALARM_LOW_LUMINOSITY', 'LBL_ALARM_CONFIGS_ALARM_LOW_LUMINOSITY', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(050012, 2, 3, 12, NULL, 3, true, true, 'ALARM BROKEN THREAD', 'ALARM BROKEN THREAD', 'LBL_ALARM_CONFIGS_ALARM_BROKEN_THREAD', 'LBL_ALARM_CONFIGS_ALARM_BROKEN_THREAD_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(12, 2, 010012, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
