...
(3, 84, 'LIGHTING_CIRCUIT', 'Lighting circuit','LBL_ELEMENT_TYPE_LIGHTING_CIRCUIT', 'LBL_ELEMENT_TYPE_LIGHTING_CIRCUIT_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(3, 84, 2, 1, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(3, 1, 84, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(3, 2, 84, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);