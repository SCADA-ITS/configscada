...
(2003, 'Electrical panel', 'Electrical panel', 'LBL_ELEMENT_TYPE_ELECTRICAL_PANEL', 'LBL_ELEMENT_TYPE_ELECTRICAL_PANEL_DESC', 0, 1, 2, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
