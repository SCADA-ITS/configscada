...
(74, 'ERU', 'ERU', 'LBL_ELEMENT_TYPE_ERU', 'LBL_ELEMENT_TYPE_ERU_DESC', 0, 1, 2, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
--CONFIG
(74, 1, 1, NULL, 2, NULL, 'brand', 'brand', 'LBL_ELEMENT_TYPE_PARAM_BRAND' , 'LBL_ELEMENT_TYPE_PARAM_BRAND_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(74, 1, 2, NULL, 2, NULL, 'model', 'model', 'LBL_ELEMENT_TYPE_PARAM_MODEL' , 'LBL_ELEMENT_TYPE_PARAM_MODEL_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(74,1,5, NULL,2, NULL, 'eru_type', 'eru_type', 'LBL_ELEMENT_TYPE_PARAM_ERU_TYPE', 'LBL_ELEMENT_TYPE_PARAM_ERU_TYPE_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(74,1,6, NULL,2, NULL, 'redundant_eru_type', 'reduntdant_eru_type', 'LBL_ELEMENT_TYPE_PARAM_REDUNDANT_ERU_TYPE', 'LBL_ELEMENT_TYPE_PARAM_REDUNDANT_ERU_TYPE_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(74,1,7, NULL,2, NULL, 'redundant_eru_alias', 'reduntdant_eru_alias', 'LBL_ELEMENT_TYPE_PARAM_REDUNDANT_ERU_ALIAS', 'LBL_ELEMENT_TYPE_PARAM_REDUNDANT_ERU_ALIAS_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(74,1,1003, NULL,2, NULL, 'MANGO SESSION_UID', 'MANGO SESSION_UID', 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID' , 'LBL_ELEMENT_TYPE_PARAM_MANGO_SESSION_UID_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
--MEASURE
(74,2,1, NULL,5, NULL, 'pheripheral_control', 'pheripheral_control', 'LBL_ELEMENT_TYPE_PARAM_PHERIPHERAL_CONTROL', 'LBL_ELEMENT_TYPE_PARAM_PHERIPHERAL_CONTROL_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);  
