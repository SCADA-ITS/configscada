...
--UNE PARAMS 
(2, 1, 4001, NULL, 2, NULL, 'socket une host', 'socket une host', 'LBL_ELEMENT_TYPE_PARAM_SOCKET_UNE_HOST' , 'LBL_ELEMENT_TYPE_PARAM_SOCKET_UNE_HOST_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 1, 4002, NULL, 1, NULL, 'socket une port', 'socket une port', 'LBL_ELEMENT_TYPE_PARAM_SOCKET_UNE_PORT' , 'LBL_ELEMENT_TYPE_PARAM_SOCKET_UNE_PORT_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 1, 4003, NULL, 6, NULL, 'socket une enq frame', 'socket une enq frame', 'LBL_ELEMENT_TYPE_PARAM_SOCKET_UNE_ENQ_FRAME' , 'LBL_ELEMENT_TYPE_PARAM_SOCKET_UNE_ENQ_FRAME_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 1, 4004, NULL, 6, NULL, 'socket une ack frame', 'socket une ack frame', 'LBL_ELEMENT_TYPE_PARAM_SOCKET_UNE_ACK_FRAME' , 'LBL_ELEMENT_TYPE_PARAM_SOCKET_UNE_ACK_FRAME_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 1, 4005, NULL, 6, NULL, 'socket une ack address', 'address', 'LBL_ELEMENT_TYPE_PARAM_SOCKET_UNE_ADDRESS' , 'LBL_ELEMENT_TYPE_PARAM_SOCKET_UNE_ADDRESS_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 1, 4006, NULL, 6, NULL, 'socket une ssl trust store', 'ssl trust store', 'LBL_ELEMENT_TYPE_PARAM_SSL_TRUST_STORE' , 'LBL_ELEMENT_TYPE_PARAM_SSL_TRUST_STORE_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 1, 4007, NULL, 6, NULL, 'socket une ssl trust store password', 'ssl trust store password', 'LBL_ELEMENT_TYPE_PARAM_SSL_TRUST_STORE_PASSWORD' , 'LBL_ELEMENT_TYPE_PARAM_SSL_TRUST_STORE_PASSWORD_DESC', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(080002, 2, 3, 2, NULL, 3, true, true, 'ALARM CAMERA DAI', 'ALARM CAMERA DAI', 'LBL_ALARM_CONFIGS_ALARM_CAMERA_DAI', 'LBL_ALARM_CONFIGS_ALARM_CAMERA_DAI_DESC', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
