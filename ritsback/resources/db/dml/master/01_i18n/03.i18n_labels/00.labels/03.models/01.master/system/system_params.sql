...
--es_ES
	 ...
	 ('es_ES',1,'LBL_SYSTEM_PARAM_TELEGRAM_CONFIG', 'Parámetros de configuración del bot y chats de Telegram', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
--en_GB
	 ...
	 ('en_GB',1,'LBL_SYSTEM_PARAM_TELEGRAM_CONFIG', 'Telegram bot and chat configuration parameters', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
--es_CL
	 ...
	 ('es_CL',1,'LBL_SYSTEM_PARAM_TELEGRAM_CONFIG', 'Parámetros de configuración del bot y chats de Telegram', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
