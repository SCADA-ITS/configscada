...
(1, 'LEVEL_MAINTENANCE', 'ALARM LEVEL MAINTENANCE', 'LBL_GRID_FIELD_ALARM_LEVEL_MAINTENANCE', null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 'LEVEL_0', 'ALARM LEVEL 0', 'LBL_GRID_FIELD_ALARM_LEVEL_0', null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(3, 'LEVEL_1', 'ALARM LEVEL 1', 'LBL_GRID_FIELD_ALARM_LEVEL_1', null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(4, 'LEVEL_2', 'ALARM LEVEL 2', 'LBL_GRID_FIELD_ALARM_LEVEL_2', null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 'LEVEL_3', 'ALARM LEVEL 3', 'LBL_GRID_FIELD_ALARM_LEVEL_3', null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(6, 'LEVEL_4', 'ALARM LEVEL 4', 'LBL_GRID_FIELD_ALARM_LEVEL_4', null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);