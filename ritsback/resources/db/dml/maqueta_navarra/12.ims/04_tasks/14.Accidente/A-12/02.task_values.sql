...
--2 = CHAT_ID del canal donde vamos a mandar la incidencia
--3 = MESSAGE_TEXT Definición del texto a enviar en la notificación
(10, 1, 010606010401, '@type
@location
@road_impact
@date', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

(10, 1, 010706010401, '@type
@location
@road_impact
@date', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

(10, 1, 010806010401, '@type
@location
@road_impact
@date', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

(10, 1, 020606010401, '@type
@location
@road_impact
@date', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

(10, 1, 020706010401, '@type
@location
@road_impact
@date', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

(10, 1, 020806010401, '@type
@location
@road_impact
@date', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
--2 = CHAT_ID del canal donde vamos a mandar la incidencia
--3 = MESSAGE_TEXT Definición del texto a enviar en la notificación
(10, 1, 000608010401, '@type
@location
@road_impact
@date', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

(10, 1, 000708010401, '@type
@location
@road_impact
@date', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

(10, 1, 000808010401, '@type
@location
@road_impact
@date', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
