...
(001403010401, 22, 401, 1, 10, 'TELEGRAM HERIDOS/FALLECIDOS', 'Envio de información interna de heridos y fallecidos', 'Enviar mediante Telegram de manera interna la información de los heridos graves y los fallecidos', false, 3, false, 'SendToTelegramNotification', true, null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(001503010401, 23, 401, 1, 10, 'TELEGRAM HERIDOS/FALLECIDOS', 'Envio de información interna de heridos y fallecidos', 'Enviar mediante Telegram de manera interna la información de los heridos graves y los fallecidos', false, 3, false, 'SendToTelegramNotification', true, null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(001406010401, 22, 401, 1, 10, 'TELEGRAM ESTADO CIRCULACIÓN', 'Envio de información interna del estado de circulación', 'Enviar mediante Telegram de manera interna la información del estado de la circulación', false, 6, false, 'SendToTelegramNotification', true, null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(001506010401, 23, 401, 1, 10, 'TELEGRAM ESTADO CIRCULACIÓN', 'Envio de información interna del estado de circulación', 'Enviar mediante Telegram de manera interna la información del estado de la circulación', false, 6, false, 'SendToTelegramNotification', true, null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(001408010401, 22, 401, 1, 10, 'INFORMACIÓN AL CIUDADANO', 'Publicar Telegram del accidente', 'Publicar en el canal público del Gobierno de Navarra la información al ciudadano del estado del accidente', false, 8, false, 'SendToTelegramNotification', true, null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(001508010401, 23, 401, 1, 10, 'INFORMACIÓN AL CIUDADANO', 'Publicar Telegram del accidente', 'Publicar en el canal público del Gobierno de Navarra la información al ciudadano del estado del accidente', false, 8, false, 'SendToTelegramNotification', true, null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
