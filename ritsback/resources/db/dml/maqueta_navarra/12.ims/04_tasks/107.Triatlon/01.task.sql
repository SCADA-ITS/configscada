...
(01010107, 107, 1, 10, 'ENVIAR TELEGRAM PUBLICO', 'Notificación usuarios por Telegram', 'Enviar información a canal público de Telegram de la incidencia para informar a los ciudadanos.', false, 1, true, 'SendToTelegramNotificationPublic', true, null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
