...
(2,3,1,2,'http://192.168.243.41:88/cgi-bin/CGIProxy.fcgi?cmd=snapPicture2&usr=admin&pwd=xxx',true,true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP), 
(2,4,1,2,'124',true,true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP), 
(2,5,1,2,'RKDJS24PI',true,true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
(2,7,1,2,'PTZ',true,true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
(2, 12, 1, 2,'{"up":0.02,"down":-0.02,"right":0.02,"left":-0.02,"zoom_in":0.02,"zoom_out":-0.02}', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
(2,1003,1,2,'CAM_2',true,true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),

(2,1,1,3,'Bosch',true,true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP), 
(2,2,1,3,'NBE-5503-AL',true,true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP), 
(2,3,1,3,'http://service:Revenga(2021)@10.25.8.3/snap.jpg?JpegCam=1',true,true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP), 
(2,4,1,3,'124',true,true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP), 
(2,5,1,3,'RKDJS24PI',true,true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP), 
(2,7,1,3,'PTZ',true,true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
(2,1003,1,3,'CAM_3',true,true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),

(2,1,1,4,'Bosch',true,true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP), 
(2,2,1,4,'NDP-7512-Z30',true,true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP), 
(2,3,1,4,'http://service:Revenga(2021)@10.25.8.2/snap.jpg?JpegCam=1',true,true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP), 
(2,4,1,4,'124',true,true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP), 
(2,5,1,4,'RKDJS24PI',true,true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
(2,7,1,4,'PTZ',true,true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
(2,1003,1,4,'CAM_4',true,true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),

(2,1,1,5,'Dahua',true,true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP), 
(2,2,1,5,'Interchange',true,true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP), 
(2,3,1,5,'http://192.168.0.198:55621/stream',true,true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP), 
(2,4,1,5,'124',true,true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP), 
(2,5,1,5,'RKDJS24PI',true,true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
(2,7,1,5,'PTZ',true,true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
