...
(4, 2, 'LPR_SOCKET_UNE', 'LPR_SOCKET_UNE', false, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 1, 'MODBUS_TCP_1', 'MODBUS_TCP_1', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 2, 'MODBUS_TCP_2', 'MODBUS_TCP_2', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
-- ModbusTcp
(5, 1, 1, 'true', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 1, 2, '0/5 * * ? * * *', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), -- Cada minuto
(5, 1, 3, 'true', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 1, 4, '0/5 * * ? * * *', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), -- Cada minuto
(5, 1, 5, 'true', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 1, 6, '0/5 * * ? * * *', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), -- Cada minuto
(5, 1, 7, '127.0.0.1', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 1, 8, '2502', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 1, 9, '3000', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 1, 10, '999999', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 1, 11, '5000', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 1, 12, '5000', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

(5, 2, 1, 'true', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 2, 2, '0/5 * * ? * * *', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), -- Cada minuto
(5, 2, 3, 'true', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 2, 4, '0/5 * * ? * * *', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), -- Cada minuto
(5, 2, 5, 'true', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 2, 6, '0/5 * * ? * * *', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), -- Cada minuto
(5, 2, 7, '127.0.0.1', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 2, 8, '3502', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 2, 9, '3000', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 2, 10, '999999', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 2, 11, '5000', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 2, 12, '5000', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
-- modbustcp
(9, 11, 5, 1, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(9, 12, 5, 1, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(9, 13, 5, 2, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
