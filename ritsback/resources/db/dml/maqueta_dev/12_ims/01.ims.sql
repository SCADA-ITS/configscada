...
(2, 1, 'LEVEL_1', 'Preemergencia', 'LBL_IMS_INCIDENT_GROUP_LEVEL_1', null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(3, 2, 'LEVEL_2', 'Emergencia de Nivel 1', 'LBL_IMS_INCIDENT_GROUP_LEVEL_2', null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(4, 3, 'LEVEL_3', 'Emergencia de Nivel 2', 'LBL_IMS_INCIDENT_GROUP_LEVEL_3', null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
