...
(070136, 36, 1, 4, '7 - V04 - VENTILACIÓN', 'Ventilación auxiliar en modo accidental', null, true, 8, false,  'SendPressurizationOn', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(010336, 36, 3, 6, '1 - AVISO', '','Equipo de primera intervención - Jefe de Seguridad - Jefe de Explotación - Guardia Civil de Trafico - CECEM-112', false, 2, false, null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(020336, 36, 3, 1, '2 - S01 - SEÑALIZACIÓN', 'cierre de tubo no afectado', null, false, 3, false, null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(030336, 36, 3, 2, '3 - I02 - ILUMINACIÓN', 'Reforzar iluminación en túnel', null, false, 4, false, 'TaskTypeTunnelLighting/SetIlluminationByFireDetTask', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(040336, 36, 3, 2, '4 - I04 - ILUMINACIÓN', 'Iluminación de evacuación ambos sentidos', null, false, 5, false, 'TaskTypeTunnelLighting/EvacuationByFireDetTask', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(050336, 36, 3, 7, '5 - C02 - CCTV', 'Barrido del túnel', 'Secuencia predeterminada de visualización de cámaras de cctv que permite realizar un barrido de todo el túnel.', false, 6, false, null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(060336, 36, 3, 9, '6 - M20 - MEGAFONIA', 'Evacuación del tunel ambos sentidos', null, false, 7, false, 'ByFireDet/SendMessagePAGroupByFireDetTask', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(070336, 36, 3, 9, '7 - R03 - RADIODIFUSIÓN', 'Evacuación del tunel ambos sentidos', null, false, 8, false, 'ByFireDet/SendMessagePAZoneByFireDetTask', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(100436, 36, 4, 4, '16 - V04 - VENTILACIÓN', 'Parar ventilación auxiliar en modo accidental', null, true, 8, false,  'SendPressurizationOff', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
