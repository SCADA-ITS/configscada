UPDATE conf.alarm_configs SET alarm_level_id = 1, enabled = True, treatment = False WHERE element_type_id = 1 AND alarm_config_id = 10001; --LBL_ALARM_CONFIGS_ALARM_WS_NO_CONNECTION
