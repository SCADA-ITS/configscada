...
'{	
	...
	"ventilationRegimes": [{
				...
				"description": "Regimen 0 tunel Monte Mayor para el sentido Málaga",
			...
			},
			{
				"id": 2,
				"alias": "REGIMEN_BAJO",
				"description": "Regimen bajo tunel Monte Mayor  para el sentido Málaga",
			...
			},
			{
				"id": 3,
				"alias": "REGIMEN_MEDIO",
				"description": "Regimen medio tunel Monte Mayor para el sentido Málaga",
			...
			},
			{
				"id": 4,
				"alias": "REGIMEN_ALTO",
				"description": "Regimen alto tunel Monte Mayor  para el sentido Málaga",
			...
			},
			{
				...
				"description": "Emergencia E1-AMB-01 tunel Rio Verde  para el sentido Málaga",
				"labelAlias": "LBL_REGIME_EMERGENCIA_E1_AMB_01",
				"fans": 6,
				"incidentTypeId": "ImsIncidentType:22",
				"locationId": "Location:1008"
			},
			{
				"id": 6,
				"alias": "EMERGENCIA E1-AMB-02",
				"description": "Emergencia E1-AMB-02 tunel Rio Verde  para el sentido Málaga",
