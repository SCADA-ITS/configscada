...
(10, 1, 01010503, 'Inicio de evento de atletismo: Carrera                                                                                                       
@alias                                                                                                                                                          
@tipo                                                                                                                                                           
@localizacion                                                                                                                                                   
@afeccion                                                                                                                                                       
...
(8, 1, 03010503, 'monica.labat.villalba@navarra.es,alberto.egea.corella@navarra.es', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),                         
(8, 4, 03010503, 'Aviso de accidente', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),		                                                                
(8, 5, 03010503, '¡ACCIDENTE CON HERIDOS GRAVES Y FALLECIDOS!', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                              
