...
(module_type_id, module_id, alias, description, enabled, visible, created_at, updated_at)
VALUES(1, 1, 'MANGO', 'MANGO', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(module_type_id, module_id, module_type_param_id, value, enabled, visible, created_at, updated_at)
VALUES(1, 1, 1, 'true', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(1, 1, 13, 'http://192.168.88.38:8080/rest/v1', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1, 1, 14, 'http://192.168.88.38:8080/rest/v2/login', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1, 1, 15, 'admin', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1, 1, 16, 'ofargentina', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
