...
(060201, 201, 1, 1, 'SEÑALIZACIÓN', 'Lluvia intensa', null, true, 5, false, 'SendSignallingToStretch', null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(050221, 201, 1, 6, 'AVISO', 'Equipo de primera intervención - Jefe de Seguridad', null, false, 4, false, null, null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
