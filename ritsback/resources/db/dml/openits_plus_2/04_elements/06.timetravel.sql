...
(6, 4, 1, 1, NULL, 'Marb', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
...
(6, 4, 1, 2, NULL, 'SPeA', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
...
(6, 4, 1, 3, NULL, 'EST', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
...
(6, 4, 1, 4, NULL, 'Marb', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
...
(6, 4, 1, 5, NULL, 'EST', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
...
(6, 4, 1, 6, NULL, 'EST', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
