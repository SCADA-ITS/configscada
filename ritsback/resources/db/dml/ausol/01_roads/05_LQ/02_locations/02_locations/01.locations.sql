...
(1021, 2, 'LQ-TUNEL', 'Tunel de La Quinta', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1022, 2, 'LQ-TSM', 'Boca sentido Málaga del tunel de La Quinta', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1023, 2, 'LQ-TSC', 'Boca sentido Cádiz del tunel de La Quinta', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
