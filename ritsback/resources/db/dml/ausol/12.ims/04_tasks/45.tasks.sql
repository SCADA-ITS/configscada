...
(050145, 45, 1, 1, '7 - V04 - VENTILACIÓN', 'Ventilación auxiliar en modo accidental', 'Operación de la ventilación auxiliar de las galerías para crear una sobrepresión en las vías de evacuación.', true, 6, false,  'SendPressurizationOn', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(090145, 45, 1, 1, '8 - P01 - COMPUERTA', 'Cierre de compuertas del depósito DLT', null, true, 9, false, 'CloseToxicGate', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(020345, 45, 3, 6, '1 - AVISO', '', 'Equipo de primera intervención - Guardia Civil de Trafico - Jefe de Seguridad - Jefe de Explotación - CECEM-112', true, 2, false, null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(030345, 45, 3, 1, '2 - S01 - SEÑALIZACIÓN', 'Cierre de tunel no afectado', null, true, 3, false, null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(040345, 45, 3, 2, '3 - I02 - ILUMINACIÓN', 'Reforzar iluminación en túnel 100% diurno', 'Encendido de todos los circuitos de alumbrado del túnel con objeto de mejorar las condiciones de visibilidad por existencia de humos en caso de fuego.', true, 4, false, 'TaskTypeTunnelLighting/SetIlluminationByFireDetTask', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(050345, 45, 3, 2, '4 - I04 - ILUMINACIÓN', 'Iluminación de evacuación', 'Encendido del circuito de alumbrado de evacuación del túnel con objeto de mejorar las condiciones de visibilidad para evacuación del mismo.', true, 5, false, 'TaskTypeTunnelLighting/EvacuationByFireDetTask', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(060345, 45, 3, 7, '5 - C02 - CCTV', 'Barrido del túnel', 'Secuencia predeterminada de visualización de cámaras de cctv que permite realizar un barrido de todo el túnel.', true, 6, false, null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(070345, 45, 3, 9, '6 - M20 - MEGAFONIA', 'Evacuación del tunel', 'Emisión de los mensajes pregrabados establecidos en el protocolo de evacuación del túnel.', true, 7, false, 'ByFireDet/SendMessagePAGroupByFireDetTask', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(080345, 45, 3, 9, '7 - R03 - RADIODIFUSIÓN', 'Evacuación del tunel', 'Emisión de los mensajes pregrabados establecidos en el protocolo de evacuación del túnel.', true, 8, false, 'ByFireDet/SendMessagePAZoneByFireDetTask', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(050445, 45, 4, 1, '14 - V04 - VENTILACIÓN', 'Parar ventilación auxiliar en modo accidental',null, true, 5, false,  'SendPressurizationOff', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(090245, 45, 2, 1, '23 - P02 - COMPUERTA', 'Apertura de compuertas del depósito DLT', null, true, 9, false, 'OpenToxicGate', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(070245, 45, 2, 7, '24 - C05 - CCTV', 'Salvar grabación de video', 'Operación de salvaguarda de las grabaciones digitales de vídeo correspondientes a un intervalo de tiempo en el que haya ocurrido algo que requiera ser registrado para su posterior informe o análisis.', true, 7, false, null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
