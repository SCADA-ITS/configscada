...
'{	
	...
	"ventilationRegimes": [{
				...
				"description": "Regimen 0 tunel Santa Mária II para el sentido Cádiz",
			...
			},
			{
				"id": 2,
				"alias": "REGIMEN_BAJO",
				"description": "Regimen bajo tunel Santa Mária II para el sentido Cádiz",
			...
			},
			{
				"id": 3,
				"alias": "REGIMEN_MEDIO",
				"description": "Regimen medio tunel Santa Mária II para el sentido Cádiz",
			...
			},
			{
				"id": 4,
				"alias": "REGIMEN_ALTO",
				"description": "Regimen alto tunel Santa Mária II  para el sentido Cádiz",
			...
			},
			{
				...
				"description": "Emergencia E1-AMB-01 tunel Santa Mária II  para el sentido Cádiz",
				"labelAlias": "LBL_REGIME_EMERGENCIA_E1_AMB_01",
				"fans": 6,
				"incidentTypeId": "ImsIncidentType:22",
				"locationId": "Location:1066"
			},
			{
				"id": 6,
				"alias": "EMERGENCIA E1-AMB-02",
				"description": "Emergencia E1-AMB-02 tunel Santa Mária II  para el sentido Cádiz",
