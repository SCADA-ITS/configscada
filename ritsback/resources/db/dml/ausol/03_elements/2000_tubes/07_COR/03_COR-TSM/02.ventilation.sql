...
'{	
	...
	"ventilationRegimes": [{
				...
				"description": "Regimen 0 tunel Corominas para el sentido Málaga",
			...
			},
			{
				"id": 2,
				"alias": "REGIMEN_BAJO",
				"description": "Regimen bajo tunel Corominas para el sentido Málaga",
			...
			},
			{
				"id": 3,
				"alias": "REGIMEN_MEDIO",
				"description": "Regimen medio tunel Corominas para el sentido Málaga",
			...
			},
			{
				"id": 4,
				"alias": "REGIMEN_ALTO",
				"description": "Regimen alto tunel Corominas  para el sentido Málaga",
			...
			},
			{
				...
				"description": "Emergencia E1-AMB-01 tunel Corominas  para el sentido Málaga",
				"labelAlias": "LBL_REGIME_EMERGENCIA_E1_AMB_01",
				"fans": 10,
				"incidentTypeId": "ImsIncidentType:22",
				"locationId": "Location:1054"
			},
			{
				"id": 6,
				"alias": "EMERGENCIA E1-AMB-02",
				"description": "Emergencia E1-AMB-02 tunel Corominas  para el sentido Málaga",
