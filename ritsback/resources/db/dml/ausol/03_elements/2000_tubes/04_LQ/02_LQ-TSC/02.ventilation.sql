...
'{	
	...
	"ventilationRegimes": [{
				...
				"description": "Regimen 0 tunel La Quinta para el sentido Cádiz",
			...
			},
			{
				"id": 2,
				"alias": "REGIMEN_BAJO",
				"description": "Regimen bajo tunel La Quinta para el sentido Cádiz",
			...
			},
			{
				"id": 3,
				"alias": "REGIMEN_MEDIO",
				"description": "Regimen medio tunel La Quinta para el sentido Cádiz",
			...
			},
			{
				"id": 4,
				"alias": "REGIMEN_ALTO",
				"description": "Regimen alto tunel La Quintapara el sentido Cádiz",
			...
			},
			{
				...
				"description": "Emergencia E1-AMB-01 tunel La Quinta para el sentido Cádiz",
				"labelAlias": "LBL_REGIME_EMERGENCIA_E1_AMB_01",
				"fans": 16,
				"incidentTypeId": "ImsIncidentType:22",
				"locationId": "Location:10023"
			},
			{
				"id": 6,
				"alias": "EMERGENCIA E1-AMB-02",
				"description": "Emergencia E1-AMB-02 tunel Monte Mayor para el sentido Cádiz",
				"labelAlias": "LBL_REGIME_EMERGENCIA_E1_AMB_02",
				"fans": 16,
				"incidentTypeId": "ImsIncidentType:23",
				"locationId": "Location:1023"
			}],
	"smConfigs": [
		{
			"id": 1,
