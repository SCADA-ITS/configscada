...
'{	
	...
	"ventilationRegimes": [{
				...
				"description": "Regimen 0 tunel Rio Verde para el sentido Cádiz",
			...
			},
			{
				"id": 2,
				"alias": "REGIMEN_BAJO",
				"description": "Regimen bajo tunel Rio Verde  para el sentido Cádiz",
			...
			},
			{
				"id": 3,
				"alias": "REGIMEN_MEDIO",
				"description": "Regimen medio tunel Rio Verde para el sentido Cádiz",
			...
			},
			{
				"id": 4,
				"alias": "REGIMEN_ALTO",
				"description": "Regimen alto tunel Rio Verde  para el sentido Cádiz",
			...
			},
			{
				...
				"description": "Emergencia E1-AMB-01 tunel Rio Verde  para el sentido Cádiz",
			...
			},
			{
				...
				"description": "Emergencia E1-AMB-02 tunel Rio Verde  para el sentido Cádiz",
