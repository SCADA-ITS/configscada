...
(0301, 3, 'CREPUSCULAR', 'CREPUSCULAR', 'LBL_SM_STATE_CREPUSCULAR', NULL, false, 5, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(0301, 4, 'NUBLADO', 'NUBLADO', 'LBL_SM_STATE_NUBLADO', NULL, false, 5, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(0301, 3, 1, false, 2, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), -- CREPUSCULAR --> SOLEADO
(0301, 3, 2, false, 4, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), -- CREPUSCULAR --> NUBLADO
(0301, 3, 3, false, 5, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), -- CREPUSCULAR --> NOCTURNO
-- Desde Nublado al resto de estados
(0301, 4, 1, false, 2, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), -- NUBLADO --> SOLEADO
(0301, 4, 2, false, 3, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), -- NUBLADO --> CREPUSCULAR
(0301, 4, 3, false, 5, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), -- NUBLADO --> NOCTURNO
...
(0301, 'Threshold_LUM_MAYOR_1000', 'Threshold_LUM_MAYOR_1000', 'LBL_THRESHOLD_LUM_MAYOR_1000', 'LBL_THRESHOLD_LUM_MAYOR_1000', 3, '1000', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),							-- Soleado > 1000 lux
(0302, 'Threshold_LUM_ENTRE_1000_Y_800', 'Threshold_LUM_ENTRE_1000_Y_800', 'LBL_THRESHOLD_LUM_ENTRE_1000_Y_800', 'LBL_THRESHOLD_LUM_ENTRE_1000_Y_800', 3, '800', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),	-- Crepusuclar < 1000 lux y > 800 lux
(0303, 'Threshold_LUM_ENTRE_800_Y_500', 'Threshold_LUM_ENTRE_800_Y_500', 'LBL_THRESHOLD_LUM_ENTRE_800_Y_500', 'LBL_THRESHOLD_LUM_ENTRE_800_Y_500', 3, '500', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),	-- Nublado < 800 lux y > 500 lux
(0304, 'Threshold_LUM_MENOR_500', 'Threshold_LUM_MENOR_500', 'LBL_THRESHOLD_LUM_MENOR_500', 'LBL_THRESHOLD_LUM_MENOR_500', 3, '500', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);	-- Nocturno < 500 lux
...
(0301, 4, 0301, NULL, 14, 2, 2, NULL, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), -- > 1000 lux
(0302, 1, 0302, 0301, 14, 2, 2, NULL, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), -- < 1000 lux y > 800 lux
(0303, 1, 0303, 0302, 14, 2, 2, NULL, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), -- < 800 lux y > 500 lux
(0304, 6, 0304, NULL, 14, 2, 2, NULL, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP); -- < 500 lux
