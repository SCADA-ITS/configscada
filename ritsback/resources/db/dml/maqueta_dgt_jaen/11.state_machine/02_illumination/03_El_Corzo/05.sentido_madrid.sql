...
(0501, 'LIGHTING_SERVICE_EL_CORZO_SENTIDO_MADRID_AUT', 'States machine to calulate service lighting regime in El Corzo Aut', NULL, NULL, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(0501, 3, 'CREPUSCULAR', 'CREPUSCULAR', 'LBL_SM_STATE_CREPUSCULAR', NULL, false, 5, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(0501, 4, 'NUBLADO', 'NUBLADO', 'LBL_SM_STATE_NUBLADO', NULL, false, 5, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(0501, 3, 1, false, 2, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), -- CREPUSCULAR --> SOLEADO
(0501, 3, 2, false, 4, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), -- CREPUSCULAR --> NUBLADO
(0501, 3, 3, false, 5, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), -- CREPUSCULAR --> NOCTURNO
-- Desde Nublado al resto de estados
(0501, 4, 1, false, 2, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), -- NUBLADO --> SOLEADO
(0501, 4, 2, false, 3, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), -- NUBLADO --> CREPUSCULAR
(0501, 4, 3, false, 5, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), -- NUBLADO --> NOCTURNO
...
(0501, 'Threshold_LUM_MAYOR_1000', 'Threshold_LUM_MAYOR_1000', 'LBL_THRESHOLD_LUM_MAYOR_1000', 'LBL_THRESHOLD_LUM_MAYOR_1000', 3, '1000', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),							-- Soleado > 1000 lux
(0502, 'Threshold_LUM_ENTRE_1000_Y_800', 'Threshold_LUM_ENTRE_1000_Y_800', 'LBL_THRESHOLD_LUM_ENTRE_1000_Y_800', 'LBL_THRESHOLD_LUM_ENTRE_1000_Y_800', 3, '800', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),	-- Crepusuclar < 1000 lux y > 800 lux
(0503, 'Threshold_LUM_ENTRE_800_Y_500', 'Threshold_LUM_ENTRE_800_Y_500', 'LBL_THRESHOLD_LUM_ENTRE_800_Y_500', 'LBL_THRESHOLD_LUM_ENTRE_800_Y_500', 3, '500', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),	-- Nublado < 800 lux y > 500 lux
(0504, 'Threshold_LUM_MENOR_500', 'Threshold_LUM_MENOR_500', 'LBL_THRESHOLD_LUM_MENOR_500', 'LBL_THRESHOLD_LUM_MENOR_500', 3, '500', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);	-- Nocturno < 500 lux
...
(0501, 4, 0501, NULL, 14, 2, 2, NULL, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), -- > 1000 lux
(0502, 1, 0502, 0501, 14, 2, 2, NULL, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), -- < 1000 lux y > 800 lux
(0503, 1, 0503, 0502, 14, 2, 2, NULL, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), -- < 800 lux y > 500 lux
(0504, 6, 0504, NULL, 14, 2, 2, NULL, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP); -- < 500 lux
