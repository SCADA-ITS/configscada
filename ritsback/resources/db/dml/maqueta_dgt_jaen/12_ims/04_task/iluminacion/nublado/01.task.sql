...
(00010601, 601, 1, 3, 'Desactivar alarma', 'Desactivar alarma',null, true, 1, true, 'DeactivateIlumChangeRegimeAlarms', null, null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
