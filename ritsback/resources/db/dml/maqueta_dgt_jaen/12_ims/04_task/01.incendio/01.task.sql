...
(00010101, 101, null, 7, 'CCTV', 'Enclavamiento CCTV Zona afectada',null, true, 1, true, 'LockCamFireZone', null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(01050101, 101, 1, 1, 'SEÑALIZACIÓN PMV', 'Incendio', 'Señalización de cierre de túnel', true, 4, false, null, null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(01070101, 101, 1, 1, 'SEÑALIZACIÓN', 'Bajada de barreras', 'Bajada de barreras', true, 5, false, null, null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(03010101, 101, 3, 1, 'SEÑALIZACIÓN', 'Túnel con normalidad', 'Señalización de normalidad en el túnel', true, 1, false, null, null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
