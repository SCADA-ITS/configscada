...
(0302201, 201, 1, 6, 'AVISO', 'Aviso a jefe de emergencias', 'Aviso al jefe de emergencias para que revise el equipo en caso de falsa alarma', false, 4, false, null, null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(0402201, 201, 1, 6, 'COMPROBACION DE SISTEMA DE VENTILACION', 'Comprobar sistema de ventilación', 'Comprobación del sistema de ventilación para determinar su buen funcionamiento', true, 3, false, null, null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
