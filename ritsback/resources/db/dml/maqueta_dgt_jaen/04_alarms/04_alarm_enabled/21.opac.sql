...
UPDATE conf.alarm_configs SET alarm_level_id = 5, enabled = true, treatment = True WHERE element_type_id = 21 AND alarm_config_id = 20021; --LBL_ALARM_CONFIGS_ALARM_OPAC_SENSOR
