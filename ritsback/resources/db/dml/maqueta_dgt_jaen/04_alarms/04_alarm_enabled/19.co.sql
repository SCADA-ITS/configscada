...
UPDATE conf.alarm_configs SET alarm_level_id = 5, enabled = true, treatment = True WHERE element_type_id = 19 AND alarm_config_id = 20019; --LBL_ALARM_CONFIGS_ALARM_CO_SENSOR
...
UPDATE conf.alarm_configs SET alarm_level_id = 4, enabled = true, treatment = True WHERE element_type_id = 19 AND alarm_config_id = 3010019; --LBL_ALARM_CONFIGS_ALARM_HIGH_CONCENTRATION
