...
UPDATE master.element_type_params
SET enabled=false
WHERE element_type_id=66 AND param_type_id = 2 AND element_type_param_id NOT IN(1,5);
...
UPDATE master.command_element_types
SET enabled=false
WHERE element_type_id=2000 AND command_element_type_id NOT IN(1,2,3,4,5);
