...
('es_ES', 1, 'LBL_ALARM_CONFIGS_ALARM_OPAC_VISIBILITY', 'Opacímetros visibilidad reducida (0.0025 m-1 < k <0.005 m-1)', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('es_ES', 1, 'LBL_ALARM_CONFIGS_ALARM_OPAC_REDUCED_VISIBILITY', 'Opacímetros visibilidad reducida (0.005 m-1 < k <0.009 m-1)', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('es_ES', 1, 'LBL_ALARM_CONFIGS_ALARM_OPAC_EXCESSIVE_OPACITY', 'Opacímetro visibilidad muy reducida (k > 0.009 m-1))', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
