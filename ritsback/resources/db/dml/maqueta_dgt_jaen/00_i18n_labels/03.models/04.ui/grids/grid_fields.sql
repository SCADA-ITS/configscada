...
--es_ES
    ...
    --Luminancimetro
    ('es_ES', 1, 'LBL_GRID_FIELD_LUMINANCE', 'Luminancia (cd/m2)', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
--en_GB
    ...
    --Luminancimetro
    ('en_GB', 1, 'LBL_GRID_FIELD_LUMINANCE', 'Luminance (cd/m2)', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
--es_CL
    ...
    --Luminancimetro
    ('es_CL', 1, 'LBL_GRID_FIELD_LUMINANCE', 'Luminancia (cd/m2)', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
