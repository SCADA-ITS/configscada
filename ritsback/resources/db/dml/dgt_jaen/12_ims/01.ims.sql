...
(2, false, 'WORKS', 'WORKS', 'LBL_IMS_INCIDENT_STATE_WORKS', null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(2, 1, 'LEVEL_1', 'Emergencia de Nivel Leve', 'LBL_INCIDENT_LEVEL_1', null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(3, 2, 'LEVEL_2', 'Emergencia de Nivel Medio', 'LBL_INCIDENT_LEVEL_2', null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(4, 3, 'LEVEL_3', 'Emergencia de Nivel Grave', 'LBL_INCIDENT_LEVEL_3', null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
