...
(01060101, 101, 1, 6, 'COMPROBACION DE SISTEMA DE VENTILACION', 'Comprobar sistema de ventilación', 'Comprobación del sistema de ventilación para determinar su buen funcionamiento', true, 6, false, null, null,null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(01080101, 101, 1, 6, 'COMPROBACION ESTADO TRAFICO', 'BAJADA DE BARRERAS', 'Comprobación del estado del tráfico y proceder a bajar barreras si las condiciones lo permiten', true, 7, false, null, null,null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(01090101, 101, 1, 6, 'AVISO', 'Aviso a emergencias (112)', 'Aviso a emergencias (112)', true, 8, false, null, null,null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
