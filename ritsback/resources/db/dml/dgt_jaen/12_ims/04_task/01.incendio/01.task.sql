...
(01020101, 101, 1, 1, 'PRESURIZACIÓN', 'Presurización', 'Encendido de presurización', true, 3, true, 'SendSignallingToStretchByLocation', null, null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(01040101, 101, 1, 1, 'SEÑALIZACIÓN', 'Incendio', 'Señalización de cierre de túnel', true, 5, true, 'SendSignallingToStretchByLocation', null, null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(01120101, 101, 1, 1, 'ILUMINACIÓN DE EMERGENCIA', 'Encender iluminacion de emergencia al 100%', 'Encender iluminacion de emergencia al 100%.', true, 6, true, 'SendSignallingToStretchByLocation', null, null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(03020101, 101, 3, 1, 'PRESURIZACIÓN', 'Presurización', 'Apagado de presurización', true, 3, true, 'SendSignallingToStretchByLocation', null,null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(03050101, 101, 3, 1, 'ILUMINACIÓN DE EMERGENCIA', 'Apagar iluminacion de emergencia al 100%', 'Apagar iluminacion de emergencia al 100%.', true, 5, true, 'SendSignallingToStretchByLocation', null, null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

--ETAPA = AL CANCELAR LA INCIDENCIA
(101020101, 101, 101, 1, 'PRESURIZACIÓN', 'Presurización', 'Apagado de presurización', true, 3, true, 'SendSignallingToStretchByLocation', null,null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(101050101, 101, 101, 1, 'ILUMINACIÓN DE EMERGENCIA', 'Apagar iluminacion de emergencia al 100%', 'Apagar iluminacion de emergencia al 100%.', true, 5, true, 'SendSignallingToStretchByLocation', null, null, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
