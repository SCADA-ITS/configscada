operINSERT INTO conf.elements (element_type_id, element_subtype_id, element_id, location_id, keep_values_on_disconnected, inherit_state_id, alias, description, on_change_alarm, on_change_state, on_change_measure, on_schedule, enabled, visible, alert, alarm_count, created_at, updated_at) VALUES
...
(1, 4001, 1, 1, NULL, '172.21.17.253', true, true, CURRENT_TIMESTAMP,CURRENT_TIMESTAMP), 
(1, 4002, 1, 1, NULL, '4001', true, true, CURRENT_TIMESTAMP,CURRENT_TIMESTAMP), 
...
(1, 4001, 1, 2, NULL, '172.21.57.82', true, true, CURRENT_TIMESTAMP,CURRENT_TIMESTAMP), 
(1, 4002, 1, 2, NULL, '4001', true, true, CURRENT_TIMESTAMP,CURRENT_TIMESTAMP), 
...
(1, 4005, 1, 2, NULL, '0x20', true, true, CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
