...
(66, NULL, 2, 0020066, NULL, NULL, 'ANX-VEL-1-01-DP', 'ANX-VEL-1-01-DP', NULL, NULL, NULL, NULL, true, true, false, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO conf.element_values (element_type_id, element_type_param_id, param_type_id, element_id, element_value_state_id, value, enabled, visible, created_at, updated_at) VALUES
(66, 1003, 1, 1, NULL, 'ANX-VEL-1-02-DP', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 

(66, 1003, 1, 2, NULL, 'ANX-VEL-1-01-DP', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
