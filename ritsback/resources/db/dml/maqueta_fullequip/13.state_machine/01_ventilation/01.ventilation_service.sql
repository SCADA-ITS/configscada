...
(1, 7, 'EMERGENCY E1-AMB-01', 'Emergency E1-AMB-01', 'LBL_SM_STATE_EMERGENCY_CO_NO', NULL, false, 5, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1, 8, 'EMERGENCY E1-AMB-02', 'Emergency E1-AMB-02', 'LBL_SM_STATE_EMERGENCY_K', NULL, false, 5, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(1, 5, 1, false, 7, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), -- ALARM_BY_THRESHOLD --> EMERGENCY E1-AMB-01
(1, 5, 2, false, 8, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), -- ALARM_BY_THRESHOLD --> EMERGENCY E1-AMB-02
(1, 5, 3, true, 3, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), -- ALARM_BY_THRESHOLD --> ALERT_BY_THRESHOLD

(1, 6, 1, false, 7, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), -- ALARM_BY_TIMER --> EMERGENCY  E1-AMB-01
(1, 6, 2, false, 8, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), -- ALARM_BY_TIMER --> EMERGENCY  E1-AMB-02
(1, 6, 3, true, 3, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP); -- ALARM_BY_TIMER --> ALERT_BY_THRESHOLD
...
-- ALARM_BY_THRESHOLD --> EMERGENCY E1-AMB-01
-- CO > Threshold_CO_4 || NO2 > Threshold_NO2_4
-- Timer_CO_3 > Threshold_Timer_CO_3 || Timer_NO2_1 > Threshold_Timer_NO2_3
...
-- ALARM_BY_THRESHOLD --> EMERGENCY E1-AMB-02
--  K > Threshold_K_4 
-- Timer_K_3 > Threshold_Timer_K_3 
(1, 5, 2, 14, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),  
(1, 5, 2, 20, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),  

-- ALARM_BY_THRESHOLD --> ALERT_BY_THRESHOLD 
-- CO < Threshold_CO_2 && K < Threshold_K_2  && NO2 > Threshold_NO2_2
(1, 5, 3, 7, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),  
(1, 5, 3, 17, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),  
(1, 5, 3, 27, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),  


-- ALARM_BY_TIMER --> EMERGENCY E1-AMB-01
-- CO > Threshold_CO_4 || NO2 > Threshold_NO2_4
-- Timer_CO_3 > Threshold_Timer_CO_3 || Timer_NO2_1 > Threshold_Timer_NO2_3
...
-- ALARM_BY_TIMER --> EMERGENCY E1-AMB-02
-- K > Threshold_K_4
-- Timer_K_3 > Threshold_Timer_K_3
(1, 6, 2, 14, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),  
(1, 6, 2, 20, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),  

-- ALARM_BY_TIMER --> ALERT_BY_THRESHOLD 
-- CO < Threshold_CO_1 && K < Threshold_K_1  && NO2 > Threshold_NO2_1
(1, 6, 3, 6, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),  
(1, 6, 3, 16, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),  
(1, 6, 3, 26, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
