...
--ETAPA = INICIAL
(01010339, 101, 1, 1, 'SEÑALIZACION ALTO FLUJO VEHICULAR', 'Plan de señalización de alto flujo vehicular', true, 1, false, 'SendSignallingToSpath', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(01020339, 101, 1, 1, 'MEGAFONIA', 'Activacion de megafonía', false, 2, false, 'SendSignallingToSpath', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
--ETAPA = RESTITUCION
(03020339, 101, 3, 1, 'RESTITUCIÓN SEÑALIZACION', 'Restitución de señalizacióna a estado normalizado', true, 2, false, 'SendSignallingToSpath', true, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(03030339, 101, 3, 1, 'RESTITUCIÓN MEGAFONÍA', 'Desactivación de megafonía', false, 3, false, 'SendSignallingToSpath', false, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
