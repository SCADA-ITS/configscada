...
'{	
	...
	"ventilationRegimes": [{
				...
				"description": "Regimen 0 tunel La Quinta para el sentido Málaga",
			...
			},
			{
				"id": 2,
				"alias": "REGIMEN_BAJO",
				"description": "Regimen bajo tunel La Quinta para el sentido Málaga",
			...
			},
			{
				"id": 3,
				"alias": "REGIMEN_MEDIO",
				"description": "Regimen medio tunel La Quinta para el sentido Málaga",
			...
			},
			{
				"id": 4,
				"alias": "REGIMEN_ALTO",
				"description": "Regimen alto tunel La Quinta para el sentido Málaga",
			...
			},
			{
				...
				"description": "Emergencia E1-AMB-01 tunel La Quinta para el sentido Málaga",
				"labelAlias": "LBL_REGIME_EMERGENCIA_E1_AMB_01",
				"fans": 6,
				"incidentTypeId": "ImsIncidentType:22",
				"locationId": "Location:1022"
			},
			{
				"id": 6,
				"alias": "EMERGENCIA E1-AMB-02",
				"description": "Emergencia E1-AMB-02 tunel La Quinta para el sentido Málaga",
