...
(1, 4, 6, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1, 4, 7, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1, 4, 8, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
