...
(1, 1, 'admin', 'Revenga.19', NULL, NULL, NULL, true, true, 'System admin', 'admin@revenga.com', 'es_ES', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 2, 'oper1', 'oper1', NULL, NULL, NULL, true, true, 'System oper 1', 'oper1@revenga.com', 'es_ES', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(3, 2, 'oper2', 'oper2', NULL, NULL, NULL, true, true, 'System oper 2', 'oper2@revenga.com', 'es_ES', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(4, 2, 'operator1', 'operator1', NULL, NULL, NULL, true, true, 'System oper 1', 'operator1@revenga.com', 'en_GB', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 2, 'operator2', 'operator2', NULL, NULL, NULL, true, true, 'System oper 2', 'operator2@revenga.com', 'en_GB', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(6, 2, 'admin_operator', 'admin', NULL, NULL, NULL, true, true, 'Admin operator', 'admin_operator@revenga.com', 'en_GB', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
