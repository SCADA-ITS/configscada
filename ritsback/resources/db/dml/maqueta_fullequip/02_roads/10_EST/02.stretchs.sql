...
(4076, 2, 'EST-TSM', 'Tubo sentido Málaga del tunel de Estepona', 0, 0, 0, 2, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(4077, 2, 'EST-TSC', 'Tubo sentido Cádiz del tunel de Estepona', 0, 0, 0, 2, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);