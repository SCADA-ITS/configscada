...
(1018, 2, 'STMI-TUNEL', 'Tunel de Santa María I', 0, 0, 0, 1, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
--incidencias tipo stretch
(4019, 2, 'STMI-TSM', 'Tubo sentido Málaga del tunel de Santa María I', 0, 0, 0, 1, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(4020, 2, 'STMI-TSC', 'Tubo sentido Cádiz del tunel de Santa María I', 0, 0, 0, 1, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
