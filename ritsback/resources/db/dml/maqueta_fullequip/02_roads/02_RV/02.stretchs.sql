...
--incidencias
(4001, 2, 'RV-TSM', 'Tubo sentido Málaga del tunel de Río Verde', 0, 0, 0, 1, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(4002, 2, 'RV-TSC', 'Tubo sentido Cádiz del tunel de Río Verde', 0, 0, 0, 1, true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
