...
(1, 'C4', 'Incidencias generadas en sistema C4', 'LBL_EXT_ENTITY_TYPE_C4', 'LBL_EXT_ENTITY_TYPE_C4_DESC', true, '0 0/1 * * * ? *', '{
  ...
  "extEntityParamsMapping": [ {"field": "referencia", "extEntityTypeParamId": "ExtEntityTypeParam:1:1"},
                ...
                {"field": "numero_heridos_graves", "extEntityTypeParamId": "ExtEntityTypeParam:1:10"},
                ...
                {"field": "pk", "extEntityTypeParamId": "ExtEntityTypeParam:1:13"},
                {"field": "sentido", "extEntityTypeParamId": "ExtEntityTypeParam:1:14"},
                {"field": "observaciones", "extEntityTypeParamId": "ExtEntityTypeParam:1:15"},
                {"field": "estado", "extEntityTypeParamId": "ExtEntityTypeParam:1:16"},
                {"field": "fecha_cierre", "extEntityTypeParamId": "ExtEntityTypeParam:1:17"},
                {"field": "hora_cierre", "extEntityTypeParamId": "ExtEntityTypeParam:1:18"},
                {"field": "hm", "extEntityTypeParamId": "ExtEntityTypeParam:1:19"}
              ],
