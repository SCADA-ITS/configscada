...
(1, 1, 'admin', 'PTp8841/XyOkxeVUCyNf+w==', NULL, 86400, NULL, true, true, 'System admin', 'admin@rits.com', 'es_CL', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 2, 'oper', 'MR6Du+y0wfkaYpReBdYHkw==', NULL, 86400, NULL, true, true, 'System operator', 'oper@rits.com', 'es_CL', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(3, 1, 'jmoreno', 'kKM7o3AmhnLw0JB/ZuP3Eg==', NULL, 86400, NULL, true, true, 'Jorge  Moreno ', 'jmoreno@globe.cl', 'es_CL', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(4, 1, 'rgaete', 'Ro2u5oxUW981erBa7M/seQ==', NULL, 86400, NULL, true, true, 'Roberto Gaete ', 'rgaete@globe.cl', 'es_CL', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 1, 'cduben', 'Ro2u5oxUW981erBa7M/seQ==', NULL, 86400, NULL, true, true, 'Carlos Duben ', 'cduben@globe.cl', 'es_CL', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
