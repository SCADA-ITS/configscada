...
UPDATE conf.alarm_configs SET alarm_level_id = 6, enabled = True, treatment = True WHERE element_type_id = 18 AND alarm_config_id = 40018; --LBL_ALARM_CONFIGS_ALARM_ANEM_INT_INHIBIR
