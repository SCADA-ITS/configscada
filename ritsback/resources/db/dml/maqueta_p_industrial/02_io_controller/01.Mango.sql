...
(1, 1, 13, 'http://192.168.88.82:8080/rest/v3', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1, 1, 14, 'http://192.168.88.82:8080/rest/v3/login', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1, 1, 15, 'admin', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1, 1, 16, 'PIN_5064', true, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
