...
--
	...
	ALTER TABLE master.system_params SET TABLESPACE tbl_master;
...
--
	...
	ALTER TABLE master.system_permissions SET TABLESPACE tbl_master;
...
--
	...
	ALTER TABLE conf.system_param_values SET TABLESPACE tbl_conf;
...
--
	...
	ALTER TABLE conf.roles SET TABLESPACE tbl_conf;
...
--
	...
	ALTER TABLE conf.users SET TABLESPACE tbl_conf;
...
--
	...
	ALTER TABLE conf.roles_users SET TABLESPACE tbl_conf;
