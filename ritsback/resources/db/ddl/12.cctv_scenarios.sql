...
ALTER TABLE conf.cctv_scenarios SET TABLESPACE tbl_conf;
...
ALTER TABLE conf.cctv_scenario_elements SET TABLESPACE tbl_conf;
...
ALTER TABLE conf.cctv_scenario_nodes SET TABLESPACE tbl_conf;
...
ALTER TABLE conf.cctv_scenario_node_hierarchies SET TABLESPACE tbl_conf;
