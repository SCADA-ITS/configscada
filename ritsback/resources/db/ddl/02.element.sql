...
--
	...
	ALTER TABLE master.threshold_operations SET TABLESPACE tbl_master;
...
--
	...
	ALTER TABLE master.element_type_param_unit SET TABLESPACE tbl_master;
...
--
	...
	ALTER TABLE master.location_types SET TABLESPACE tbl_master;
...
--
	...
	ALTER TABLE master.stretch_types SET TABLESPACE tbl_master;
...
--
	...
	ALTER TABLE master.road_types SET TABLESPACE tbl_master;
...
--
	...
	ALTER TABLE master.road_impacts SET TABLESPACE tbl_master;
-- 
...
--
	...
	ALTER TABLE master.element_groups SET TABLESPACE tbl_master;
...
--
	...
	ALTER TABLE master.element_types SET TABLESPACE tbl_master;
...
--
	...
	ALTER TABLE master.element_type_states SET TABLESPACE tbl_master;
...
--
	...
	ALTER TABLE master.element_hierarchies_allowed SET TABLESPACE tbl_master;
...
--
	...
	ALTER TABLE master.data_types SET TABLESPACE tbl_master;
...
--
	...
	ALTER TABLE master.param_types SET TABLESPACE tbl_master;
...
--
	...
	ALTER TABLE master.element_type_params SET TABLESPACE tbl_master;
...
--
	...
	ALTER TABLE master.element_value_states SET TABLESPACE tbl_master;
...
--
	...
	ALTER TABLE master.element_subtypes SET TABLESPACE tbl_master;
...
--
	...
	ALTER TABLE static.management_areas SET TABLESPACE tbl_static;	
...
--
	...
	ALTER TABLE conf.locations SET TABLESPACE tbl_conf;
...
--
	...
	ALTER TABLE conf.spaths SET TABLESPACE tbl_conf;
...
--
	...
	ALTER TABLE conf.roads SET TABLESPACE tbl_conf;
...
--
	...
	ALTER TABLE conf.stretchs SET TABLESPACE tbl_conf;
...
--
	...
	ALTER TABLE conf.stretch_stretchs SET TABLESPACE tbl_conf;
...
--
	...
	ALTER TABLE conf.stretch_stretchs_stretchs SET TABLESPACE tbl_conf;
-- 
...
--
	...
	ALTER TABLE conf.stretch_locations SET TABLESPACE tbl_conf;
...
--
	...
	ALTER TABLE conf.spath_stretchs SET TABLESPACE tbl_conf;
...
--
	...
	ALTER TABLE conf.elements SET TABLESPACE tbl_conf;
...
--
	...
	ALTER TABLE conf.element_hierarchies SET TABLESPACE tbl_conf;
...
--
	...
	ALTER TABLE conf.element_values SET TABLESPACE tbl_conf;
...
--
	...
	ALTER TABLE conf.modbus_element_element_type_states SET TABLESPACE tbl_conf;
...
--
	...
	ALTER TABLE conf.modbus_element_element_type_params SET TABLESPACE tbl_conf;
