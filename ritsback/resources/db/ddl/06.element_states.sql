...
--
	...
	ALTER TABLE master.element_type_state_transitions SET TABLESPACE tbl_master;
...
--
	...
	ALTER TABLE conf.element_spread_states SET TABLESPACE tbl_conf;
...
--
	...
	ALTER TABLE conf.element_state_alarms SET TABLESPACE tbl_conf;