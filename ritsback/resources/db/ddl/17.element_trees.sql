...
ALTER TABLE conf.element_trees SET TABLESPACE tbl_conf;
...
ALTER TABLE conf.element_tree_nodes SET TABLESPACE tbl_conf;
...
ALTER TABLE conf.element_tree_node_hierarchies SET TABLESPACE tbl_conf;