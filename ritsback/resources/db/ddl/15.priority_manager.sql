...
ALTER TABLE master.pm_queues SET TABLESPACE tbl_master;
...
ALTER TABLE master.pm_queue_priorities SET TABLESPACE tbl_master;
...
ALTER TABLE master.pm_element_type_queues SET TABLESPACE tbl_master;
...
ALTER TABLE conf.pm_disabled_queue_priorities SET TABLESPACE tbl_conf;
