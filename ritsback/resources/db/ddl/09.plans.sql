...
--
	...
	ALTER TABLE master.plan_schedule_state_types SET TABLESPACE tbl_master;
...
--
	...
	ALTER TABLE master.plan_state_types SET TABLESPACE tbl_master;
...
--
	...
	ALTER TABLE master.plan_order_state_types SET TABLESPACE tbl_master;
...
--
	...
	ALTER TABLE master.plan_order_types SET TABLESPACE tbl_master;
...
--
	...
	ALTER TABLE master.plan_order_type_params SET TABLESPACE tbl_master;
...
--
	...
	ALTER TABLE master.plan_mode_types SET TABLESPACE tbl_master;
...
--
	...
	ALTER TABLE conf.plans SET TABLESPACE tbl_conf;
...
--
	...
	ALTER TABLE conf.plan_orders SET TABLESPACE tbl_conf;
...
--
	...
	ALTER TABLE conf.plan_order_values SET TABLESPACE tbl_conf;
...
--
	...
	ALTER TABLE conf.plan_order_element_values SET TABLESPACE tbl_conf;
...
--
	...
	ALTER TABLE conf.plan_order_element_type_states SET TABLESPACE tbl_conf;
...
--
	...
	ALTER TABLE conf.plan_order_conditions SET TABLESPACE tbl_conf;
...
--
	...
	ALTER TABLE conf.plan_schedules SET TABLESPACE tbl_conf;
...
--
	...
	ALTER TABLE conf.plan_order_command_elements SET TABLESPACE tbl_conf;
...
ALTER TABLE conf.plan_nodes SET TABLESPACE tbl_conf;
...
ALTER TABLE conf.plan_node_hierarchies SET TABLESPACE tbl_conf;
