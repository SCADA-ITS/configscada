...
--
	...
	ALTER TABLE master.alarm_levels SET TABLESPACE tbs_controltrafico_master;
...
--
	...
	ALTER TABLE master.alarm_types SET TABLESPACE tbs_controltrafico_master;
...
--
	...
	ALTER TABLE conf.alarm_configs SET TABLESPACE tbs_controltrafico_conf;	
...
--
	...
	ALTER TABLE conf.alarm_config_measures SET TABLESPACE tbs_controltrafico_conf;
...
--
	...
	ALTER TABLE conf.alarm_target_elements SET TABLESPACE tbs_controltrafico_conf;
...
--
	...
	ALTER TABLE conf.alarms_filtered SET TABLESPACE tbs_controltrafico_conf;
...
--
	...
	ALTER TABLE conf.modbus_element_alarm_configs SET TABLESPACE tbs_controltrafico_conf;
