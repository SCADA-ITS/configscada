...
--
	...
	ALTER TABLE static.transit_state_transitions ADD CONSTRAINT fk_transit_state_transitions_transit_states_1 FOREIGN KEY (parent_transit_state_id) REFERENCES static.transit_states(transit_state_id);
	ALTER TABLE static.transit_state_transitions ADD CONSTRAINT fk_transit_state_transitions_transit_states_2 FOREIGN KEY (child_transit_state_id) REFERENCES static.transit_states(transit_state_id);
