...
--
	...
	ALTER TABLE master.io_controller_module_types SET TABLESPACE tbs_controltrafico_master;
...
--
	...
	ALTER TABLE master.io_controller_module_type_params SET TABLESPACE tbs_controltrafico_master;
...
--
	...
	ALTER TABLE master.io_controller_module_type_element_types SET TABLESPACE tbs_controltrafico_master;
...
--
	...
	ALTER TABLE master.command_element_types SET TABLESPACE tbs_controltrafico_master;
...
--
	...
	ALTER TABLE master.command_element_type_params SET TABLESPACE tbs_controltrafico_master;
...
CREATE TABLE conf.command_element_preconditions (
	...
	ALTER TABLE conf.command_element_preconditions SET TABLESPACE tbs_controltrafico_conf;
...
--
	...
	ALTER TABLE conf.command_element_value_preconditions SET TABLESPACE tbs_controltrafico_conf;
...
--
	...
	ALTER TABLE conf.io_controller_modules SET TABLESPACE tbs_controltrafico_conf;
...
--
	...
	ALTER TABLE conf.io_controller_module_values SET TABLESPACE tbs_controltrafico_conf;
...
--
	...
	ALTER TABLE conf.element_io_controller_modules SET TABLESPACE tbs_controltrafico_conf;	
...
--
    ...
    ALTER TABLE conf.command_elements SET TABLESPACE tbs_controltrafico_conf;
...
-- 
	...
	ALTER TABLE conf.command_element_values SET TABLESPACE tbs_controltrafico_conf;
...
--
	...
	ALTER TABLE conf.modbus_element_command_element_types SET TABLESPACE tbs_controltrafico_conf;
