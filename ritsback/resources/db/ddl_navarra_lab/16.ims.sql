...
ALTER TABLE master.ims_incident_groups SET TABLESPACE tbs_controltrafico_master;
...
--
	...
	ALTER TABLE master.ims_task_types SET TABLESPACE tbs_controltrafico_master;
...
--
	...
	ALTER TABLE master.ims_task_type_params SET TABLESPACE tbs_controltrafico_master;
...
--
	...
	ALTER TABLE master.ims_incident_alarm_condition_alarm_types SET TABLESPACE tbs_controltrafico_master;
...
--
	...
	ALTER TABLE master.ims_delayed_incident_state_types SET TABLESPACE tbs_controltrafico_master;
...
--
	...
	ALTER TABLE static.ims_incident_states SET TABLESPACE tbs_controltrafico_static;
...
--
	...
	ALTER TABLE static.ims_incident_levels SET TABLESPACE tbs_controltrafico_static;
...
--
	...
	ALTER TABLE conf.ims_incident_types SET TABLESPACE tbs_controltrafico_conf;
...
--
	...
	ALTER TABLE conf.ims_incident_type_causes SET TABLESPACE tbs_controltrafico_conf;
...
--
	...
	ALTER TABLE conf.ims_incident_type_state_transitions SET TABLESPACE tbs_controltrafico_conf;
...
--
	...
	ALTER TABLE conf.ims_incident_type_tasks SET TABLESPACE tbs_controltrafico_conf;
...
--
	...
	ALTER TABLE conf.ims_incident_type_task_values SET TABLESPACE tbs_controltrafico_conf;
...
--
	...
	ALTER TABLE conf.ims_incident_type_stretchs SET TABLESPACE tbs_controltrafico_conf;
...
--
	...
	ALTER TABLE conf.ims_incident_type_road_impacts SET TABLESPACE tbs_controltrafico_conf;
...
-- 
	...
	ALTER TABLE conf.ims_incident_alarm_conditions SET TABLESPACE tbs_controltrafico_conf;
...
-- 
	...
	ALTER TABLE conf.ims_incident_alarm_condition_alarms SET TABLESPACE tbs_controltrafico_conf;
...
--
	...
	ALTER TABLE conf.ims_incident_task_plans SET TABLESPACE tbs_controltrafico_conf;
...
--
	...
	ALTER TABLE static.ims_incident_param_groups SET TABLESPACE tbs_controltrafico_static;
...
--
	...
	ALTER TABLE static.ims_incident_params SET TABLESPACE tbs_controltrafico_static;
...
--
	...
	ALTER TABLE static.ims_incident_enum_params SET TABLESPACE tbs_controltrafico_static;
