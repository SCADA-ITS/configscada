...
--
	...
	ALTER TABLE conf.management_area_users SET TABLESPACE tbs_controltrafico_conf;
...
--
	...
	ALTER TABLE conf.management_area_elements SET TABLESPACE tbs_controltrafico_conf;
