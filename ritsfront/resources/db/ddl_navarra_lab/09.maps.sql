...
--
	...
	ALTER TABLE ui.maps SET TABLESPACE tbs_controltrafico_ui;
...
--
	...
	ALTER TABLE ui.map_incidents SET TABLESPACE tbs_controltrafico_ui;
...
--
	...
	CREATE INDEX idx_map_ext_entities_default_graphic_icon_id ON ui.map_ext_entities USING btree (default_graphic_icon_id);
	CREATE INDEX idx_map_ext_entities_default_module_action_id ON ui.map_ext_entities USING btree (default_module_action_id);
	
	ALTER TABLE ui.map_ext_entities ADD CONSTRAINT fk_map_ext_entities_default_graphic_icon_id FOREIGN KEY (default_graphic_icon_id) REFERENCES ui.graphic_icons(id);
	...
	ALTER TABLE ui.map_ext_entities SET TABLESPACE tbs_controltrafico_ui;
...
--
	...
	ALTER TABLE ui.map_routes SET TABLESPACE tbs_controltrafico_ui;
...
--
	...
	ALTER TABLE ui.map_layers SET TABLESPACE tbs_controltrafico_ui;
...
--
	...
	ALTER TABLE ui.map_layer_relationships SET TABLESPACE tbs_controltrafico_ui;
...
--
	...
	ALTER TABLE ui.map_layer_elements SET TABLESPACE tbs_controltrafico_ui;
...
--
	...
	ALTER TABLE ui.map_layer_element_zooms SET TABLESPACE tbs_controltrafico_ui;
...
--
	...
	ALTER TABLE ui.map_zones SET TABLESPACE tbs_controltrafico_ui;
