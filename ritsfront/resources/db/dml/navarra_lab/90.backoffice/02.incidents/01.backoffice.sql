DO $$ 
BEGIN
  IF EXISTS (SELECT 1 FROM pg_namespace WHERE nspname = 'tbs_controltrafico_incidents') THEN
	...
	(0102, 1, 'indicent_type', 'tipo incidencia', NULL, true, '{"position": 2, "editable": false,}'),
	...
	(0106, 1, 'municpalites', 'municipios', NULL, true, '{"position": 6, "editable": false}'),
