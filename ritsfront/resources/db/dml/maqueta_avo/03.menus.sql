...
(0102, 1, 2, 200, 'LBL_MENU_ITEM_MAP', 'img/menu/map-menu.png', 'AVO_MAP', 'AVO_MAP', true, true),
...
(0204, 2, 4, 1030, 'LBL_MENU_ITEM_PAS_SIGNALLING', 'img/menu/pas-menu.png', 'Menu item PAS Signaling', 'Menu item PAS Signaling', true, true),
(0205, 2, 5, 1027, 'LBL_MENU_ITEM_VENTILATION_MANAGER', 'img/menu/ventilation-menu.png', 'Menu item Ventilation Manager', 'Menu item Ventilation Manager', true, true),
(0206, 2, 6, 1028, 'LBL_MENU_ITEM_LIGHTING_MANAGER', 'img/menu/light-menu.png', 'Menu item Lighting Manager', 'Menu item Lighting Manager', true, true),
...
(0402, 4, 2, 401, 'LBL_MENU_ITEM_VIDEOWALL', 'img/menu/default.png', 'Menu item Videowall', 'Menu item Videowall', true, true);
