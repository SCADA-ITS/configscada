...
(912, 'TREE_WS', 'TREE_WS', 'LBL_SYNOPTIC_WS', NULL, 'img/synoptics/Bratislava_Meteo.svg', false);
...
(91200100, 912, 'METEOS', 'LBL_SYNOPTIC_WS', true),
(91202300, 912, 'INCIDENT', 'LBL_INCIDENT', true);
...
(104, 912, 3, 'LBL_INCIDENTS_ENABLE', 'mdi mdi-pencil', false, 101701, '{"selectedPks":["Element:23:1"]}', 2, false, NULL, false, false);
...
(91200100, 'Element:1:24', 000001, 'MDMP01', 488, 206, false, NULL, true, false, NULL, true),--se pide por parte del cliente borrar este equipo del scada
...
(91202300, 'Element:23:1', 000023, 'Imanager', 1816, 47, false, NULL, true, false, NULL, true);
