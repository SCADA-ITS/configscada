...
('ElementType:69','RFID','RFID','LBL_ELEMENT_TYPE_RFID',null,True,False,false,null,225.0,3,null,69,2,True);

INSERT INTO ui.equip_viewer_tabs (equip_viewer_id, module_action_id, alias, description, "label", icon, "position", visible) VALUES
('ElementType:69',100501,'Alarms module' ,'Alarms module', 'LBL_ALARMS', null,  1, True );
...
(00006901, 'ElementType:69', 'Measures', 'Measures', 'LBL_GRP_MEASURES', null, 1, True);