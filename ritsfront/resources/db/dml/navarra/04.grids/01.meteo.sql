...
(010006, 1, 3, 6, true, false, false, false, 'LBL_ELEMENT_TYPE_PARAM_SURFACE_TEMPERATURE', 'LBL_ELEMENT_TYPE_PARAM_SURFACE_TEMPERATURE', 'ElementTypeParam:1:2:1', false, false, 'left', false, false, 250, NULL, true, true, NULL, NULL, NULL, NULL, NULL),
(010008, 1, 2, 8, true, false, false, false, 'LBL_ELEMENT_TYPE_PARAM_RELATIVE_HUMIDITY', 'LBL_ELEMENT_TYPE_PARAM_RELATIVE_HUMIDITY', 'ElementTypeParam:1:2:10', false, false, 'left', false, false, 250, NULL, true, true, NULL, NULL, NULL, NULL, NULL),
(010009, 1, 3, 9, true, false, false, false, 'LBL_ELEMENT_TYPE_PARAM_PRECIPITATION_INTENSITY', 'LBL_ELEMENT_TYPE_PARAM_PRECIPITATION_INTENSITY', 'ElementTypeParam:1:2:11', false, false, 'left', false, false, 250, NULL, true, true, NULL, NULL, NULL, NULL, NULL),
(010010, 1, 3, 10, true, false, false, false, 'LBL_ELEMENT_TYPE_PARAM_GUST_WIND_SPEED', 'LBL_ELEMENT_TYPE_PARAM_GUST_WIND_SPEED', 'ElementTypeParam:1:2:15', false, false, 'left', false, false, 250, NULL, true, true, NULL, NULL, NULL, NULL, NULL),
(010011, 1, 2, 11, true, false, false, false, 'LBL_ELEMENT_TYPE_PARAM_GUST_WIND_DIRECTION', 'LBL_ELEMENT_TYPE_PARAM_GUST_WIND_DIRECTION', 'ElementTypeParam:1:2:16', false, false, 'left', false, false, 250, NULL, true, true, NULL, NULL, NULL, NULL, NULL),
(010012, 1, 2, 12, true, false, false, false, 'LBL_ELEMENT_TYPE_PARAM_PRECIPITATION_TYPE', 'LBL_ELEMENT_TYPE_PARAM_PRECIPITATION_TYPE', 'ElementTypeParam:1:2:19', false, false, 'center', true, false, 250, NULL, true, true, NULL, NULL, NULL, NULL, NULL),
(010013, 1, 3, 13, true, false, false, false, 'LBL_ELEMENT_TYPE_PARAM_VISIBILITY', 'LBL_ELEMENT_TYPE_PARAM_VISIBILITY', 'ElementTypeParam:1:2:20', false, false, 'left', false, false, 250, NULL, true, true, NULL, NULL, NULL, NULL, NULL);

INSERT INTO ui.grid_field_replacements(grid_field_id, "label", value, enabled) VALUES
--Ventilación
(010012, 'Sin precipitaciones', '0', true),
(010012, 'Lluvia', '1', true),
(010012, 'Nieve', '2', true);
