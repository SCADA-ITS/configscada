...
BEGIN
  IF EXISTS (SELECT 1 FROM pg_namespace WHERE nspname = 'backoffice') THEN
	...
	(27, 'road_condition_id', 'Condiciones calzada', 'Condiciones calzada', 'Condiciones calzada', 'mdi mdi-message-alert', true, true, null),
	(28, 'road_type_id', 'Tipo', 'Tipo', 'Tipo', 'mdi mdi-message-alert', true, true, null),
	(29, 'road_state_id', 'Estado', 'Estado', 'Estado', 'mdi mdi-message-alert', true, true, null),
	(30, 'weather_state_id', 'Estado atmosférico', 'Estado atmosférico', 'Estado atmosférico', 'mdi mdi-message-alert', true, true, null),
	(31, 'luminosity_id', 'Luminosidad', 'Luminosidad', 'Luminosidad', 'mdi mdi-message-alert', true, true, null),
	(32, 'ligth_id', 'Luz artificial', 'Luz artificial', 'Luz artificial', 'mdi mdi-message-alert', true, true, null),
	(33, 'cause_id', 'Causa probable', 'Causa probable', 'Causa probable', 'mdi mdi-message-alert', true, true, null);
	...
	(0112, 1, 'road_condition_id', 'Condiciones calzada', NULL, true, '{"position": 12, "editable": true}'),
	(0113, 1, 'road_type_id', 'Tipo carpeta', NULL, true, '{"position": 13, "editable": true}'),
	(0114, 1, 'road_state_id', 'Estado carpeta', NULL, true, '{"position": 14, "editable": true}'),
	(0115, 1, 'weather_state_id', 'Estado atmosférico', NULL, true, '{"position": 15, "editable": true}'),
	(0116, 1, 'luminosity_id', 'Luminosidad', NULL, true, '{"position": 16, "editable": true}'),
	(0117, 1, 'ligth_id', 'Luz artificial', NULL, true, '{"position": 17, "editable": true}'),
	(0118, 1, 'cause_id', 'Causa probable', NULL, true, '{"position": 18, "editable": true}'),
	(0119, 1, 'comments', 'Redacción', NULL, true, '{"multiline": 5, "position": 19, "editable": true}'),
	(0120, 1, 'report_by', 'Denuncia realizada por', NULL, true, '{"position": 20, "editable": true}'),
	(0121, 1, 'stamped', 'Estampado de carabineros de', NULL, true, '{"position": 21, "editable": true}'),
	(0122, 1, 'court', 'Citado al juzgado de', NULL, true, '{"position": 22, "editable": true}'),
	(0123, 1, 'citattion_date', 'Fecha de citación', NULL, true, '{"position": 23, "editable": true}'),
	(0124, 1, 'report_number', 'Número de parte', NULL, true, '{"position": 24, "editable": true}'),
	(0125, 1, 'station', 'Plaza', NULL, true, '{"position": 25, "editable": true}'),
	(0126, 1, 'file_number', 'Número de folio', NULL, true, '{"position": 26, "editable": true}'),
	(0127, 1, 'patrol_name', 'Nombre de patrullero', NULL, true, '{"position": 27, "editable": true}'),
	(0128, 1, 'operator_name', 'Nombre de operador de c.control', NULL, true, '{"position": 28, "editable": true}'),
	(0129, 1, 'supervisor_name', 'Nombre supervisor operaciones', NULL, true, '{"position": 29, "editable": true}'),
