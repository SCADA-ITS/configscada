...
(0402, 'ElementType:4', 'Clas.Velocidad', 'Clas.Velocidad', 'LBL_ELEMENT_CLASSIFICATIONS_VEL', NULL, 2, true),
(0403, 'ElementType:4', 'Clas.Categorias', 'Clas.Categorias', 'LBL_ELEMENT_CLASSIFICATIONS_CAT', NULL, 3, true);
