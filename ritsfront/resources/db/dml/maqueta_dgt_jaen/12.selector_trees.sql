...
(id, selector_tree_id, label, module_id, enabled, visible) VALUES 
(1, 1, 'LBL_SELECTOR_TREE_NODES_SINOPTICOS', NULL, true, true),
(2, 1, 'LBL_SELECTOR_TREE_NODES_SINOPTICO_DESPEÑAPERROS', NULL, true, true),
(3, 1, 'LBL_SELECTOR_TREE_NODES_SINOPTICO_DESPEÑAPERROS_TUNNEL', 901, true, true);
