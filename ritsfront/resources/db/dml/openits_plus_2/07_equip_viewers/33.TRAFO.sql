...
('ElementType:33','TRAFO','TRAFO','LBL_ELEMENT_TYPE_TRAFO',null,True,False,True,null,225.0,3,null,33,2,null);
...
(00003301, 'ElementType:33', 'Measures', 'Measures', 'LBL_GRP_MEASURES', null, 1, True);

INSERT INTO ui.equip_viewer_configs (id, equip_viewer_id, vo_entities_id, "position", visible) VALUES
(003301,'ElementType:33','ElementTypeParam:33:1:1', 1, True),
(003302,'ElementType:33','ElementTypeParam:33:1:2', 2, True);