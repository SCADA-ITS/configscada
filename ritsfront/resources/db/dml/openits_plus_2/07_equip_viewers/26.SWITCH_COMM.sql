...
('ElementType:26','SWITCH_COMM','SWITCH_COMM','LBL_ELEMENT_TYPE_SWITCH_COMM',null,True,False,false,null,225.0,3,null,26,2,null);
...
(00002601, 'ElementType:26', 'Measures', 'Measures', 'LBL_GRP_MEASURES', null, 1, True);

INSERT INTO ui.equip_viewer_configs (id, equip_viewer_id, vo_entities_id, "position", visible) VALUES
(002601,'ElementType:26','ElementTypeParam:26:1:1', 1, True),
(002602,'ElementType:26','ElementTypeParam:26:1:2', 2, True);