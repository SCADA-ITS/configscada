...
('ElementType:12','LUX','LUX','LBL_ELEMENT_TYPE_LUX',null,True,False,false,null,225.0,3,null,12,2,True);
...
(00001201, 'ElementType:12', 'Measures', 'Measures', 'LBL_GRP_MEASURES', null, 1, True);

INSERT INTO ui.equip_viewer_measures (equip_viewer_grp_measure_id, vo_entities_id, position, visible) VALUES
--LUX
(00001201,'ElementTypeParam:12:2:1', 1, True);

INSERT INTO ui.equip_viewer_configs (id, equip_viewer_id, vo_entities_id, "position", visible) VALUES
(001201,'ElementType:12','ElementTypeParam:12:1:1', 1, True),
(001202,'ElementType:12','ElementTypeParam:12:1:2', 2, True);