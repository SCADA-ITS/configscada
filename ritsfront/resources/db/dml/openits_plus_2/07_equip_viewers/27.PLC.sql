...
('ElementType:27','PLC','PLC','LBL_ELEMENT_TYPE_PLC',null,True,False,false,null,225.0,3,null,27,2,True);
...
(00002701, 'ElementType:27', 'Measures', 'Measures', 'LBL_GRP_MEASURES', null, 1, True);
