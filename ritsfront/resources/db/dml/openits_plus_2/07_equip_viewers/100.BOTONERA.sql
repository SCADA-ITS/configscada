...
('ElementType:100','BOTONERA','BOTONERA','LBL_ELEMENT_TYPE_BOTONERA',null,True,False,false,null,225.0,3,null,100,2,true,true);

INSERT INTO ui.equip_viewer_tabs (equip_viewer_id, module_action_id, alias, description, "label", icon, "position", visible) VALUES
('ElementType:100',100501,'Alarms module' ,'Alarms module', 'LBL_ALARMS', null, 1, True);
...
(010001, 'ElementType:100', 'Measures', 'Measures', 'LBL_GRP_MEASURES', 100, 1, True);

INSERT INTO ui.equip_viewer_measures (equip_viewer_grp_measure_id, vo_entities_id, position, visible) VALUES
--BOTONERA
(010001,'ElementTypeParam:100:2:1', 1, True),
(010001,'ElementTypeParam:100:2:2', 2, True),
(010001,'ElementTypeParam:100:2:3', 4, True);