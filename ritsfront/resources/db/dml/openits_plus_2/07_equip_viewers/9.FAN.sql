...
('ElementType:9','Jetfan Type 1','Jetfan Type 1','LBL_ELEMENT_SUBTYPE_JETFAN_TYPE_1',null,True,False,True,null,225.0,3,null,9,2,null);
...
(01000901,'ElementTypeParam:9:2:14', 14, True),
(01000901,'ElementTypeParam:9:2:15', 15, True);


INSERT INTO ui.equip_viewer_configs (id, equip_viewer_id, vo_entities_id, "position", visible) VALUES
(090101,'ElementType:9','ElementTypeParam:9:1:5', 5, True),
(090102,'ElementType:9','ElementTypeParam:9:1:6', 6, True);