...
('ElementType:55','CT Type 2','CT Type 2','LBL_ELEMENT_SUBTYPE_CT_TYPE_2',null,True,False,false,null,225.0,3,null,55,2,true,true);
...
(02005501, 'ElementType:55', 'Measures', 'Measures', 'LBL_GRP_MEASURES', null, 1, True);
