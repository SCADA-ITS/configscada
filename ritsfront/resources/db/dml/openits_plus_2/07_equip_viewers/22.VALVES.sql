...
('ElementType:22','CO','CO','LBL_ELEMENT_TYPE_VALVULAS',null,True,False,false,null,225.0,3,null,22,2,True, false);
...
(00002201, 'ElementType:22', 'Measures', 'Measures', 'LBL_GRP_MEASURES', null, 1, True);

INSERT INTO ui.equip_viewer_measures (equip_viewer_grp_measure_id, vo_entities_id, position, visible) VALUES
(00002201,'ElementTypeParam:22:2:1', 1, True);