...
('ElementType:30','RADIO','RADIO','LBL_ELEMENT_TYPE_RADIO',null,True,False,false,null,225.0,3,null,30,2,null);
...
(00003001, 'ElementType:30', 'Measures', 'Measures', 'LBL_GRP_MEASURES', null, 1, True);

INSERT INTO ui.equip_viewer_configs (id, equip_viewer_id, vo_entities_id, "position", visible) VALUES
(003001,'ElementType:30','ElementTypeParam:30:1:1', 1, True),
(003002,'ElementType:30','ElementTypeParam:30:1:2', 2, True);