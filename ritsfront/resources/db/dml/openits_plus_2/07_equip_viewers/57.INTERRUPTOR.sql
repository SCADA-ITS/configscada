...
('ElementType:57','INTERRUPTOR','INTERRUPTOR','LBL_ELEMENT_TYPE_INTERRUPTOR',null,True,False,false,null,225.0,3,null,57,2,True);
...
(00005701, 'ElementType:57', 'Measures', 'Measures', 'LBL_GRP_MEASURES', null, 1, True);

INSERT INTO ui.equip_viewer_measures (equip_viewer_grp_measure_id, vo_entities_id, position, visible) VALUES
--INTERRUPTOR
(00005701,'ElementTypeParam:57:2:1', 1, True);

INSERT INTO ui.equip_viewer_configs (id, equip_viewer_id, vo_entities_id, "position", visible) VALUES
(005701,'ElementType:57','ElementTypeParam:57:1:1', 1, True),
(005702,'ElementType:57','ElementTypeParam:57:1:2', 2, True);