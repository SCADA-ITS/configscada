...
('ElementType:56','UNIFILAR','UNIFILAR','LBL_ELEMENT_TYPE_UNIFILAR',null,True,False,false,null,225.0,3,null,56,2,null);
...
(00005601, 'ElementType:56', 'Measures', 'Measures', 'LBL_GRP_MEASURES', null, 1, True);

INSERT INTO ui.equip_viewer_configs (id, equip_viewer_id, vo_entities_id, "position", visible) VALUES
(005601,'ElementType:56','ElementTypeParam:56:1:1', 1, True),
(005602,'ElementType:56','ElementTypeParam:56:1:2', 2, True);