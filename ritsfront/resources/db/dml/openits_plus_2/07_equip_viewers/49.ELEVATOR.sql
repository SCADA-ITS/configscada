...
('ElementType:49','ELEVATOR','ELEVATOR','LBL_ELEMENT_TYPE_ELEVATOR',null,True,False,false,null,225.0,3,null,49,1,True,true);

INSERT INTO ui.equip_viewer_tabs (equip_viewer_id, module_action_id, alias, description, "label", icon, "position", visible) VALUES
('ElementType:49',100501,'Alarms module' ,'Alarms module', 'LBL_ALARMS', null,  1, True );
...
(00004901, 'ElementType:49', 'Measures', 'Measures', 'LBL_ELEMENT_MEASURES', null, 1, True);

INSERT INTO ui.equip_viewer_measures (equip_viewer_grp_measure_id, vo_entities_id, position, visible) VALUES
--ELEVATOR
(00004901,'ElementTypeParam:49:2:1', 1, True);

INSERT INTO ui.equip_viewer_configs (id, equip_viewer_id, vo_entities_id, "position", visible) VALUES
(004901,'ElementType:49','ElementTypeParam:49:1:1', 1, True),
(004902,'ElementType:49','ElementTypeParam:49:1:2', 2, True);