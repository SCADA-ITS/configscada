...
('ElementType:31','PHOTOCELL','PHOTOCELL','LBL_ELEMENT_TYPE_PHOTOCELL',null,True,False,false,null,225.0,3,null,31,2,True);
...
(00003101, 'ElementType:31', 'Measures', 'Measures', 'LBL_GRP_MEASURES', null, 1, True);

INSERT INTO ui.equip_viewer_measures (equip_viewer_grp_measure_id, vo_entities_id, position, visible) VALUES
--PHOTOCELL
(00003101,'ElementTypeParam:31:2:1', 1, True);

INSERT INTO ui.equip_viewer_configs (id, equip_viewer_id, vo_entities_id, "position", visible) VALUES
(003101,'ElementType:31','ElementTypeParam:31:1:1', 1, True),
(003102,'ElementType:31','ElementTypeParam:31:1:2', 2, True);