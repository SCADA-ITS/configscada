...
('ElementType:2', 'CAMERA_DOMO', 'CAMERA_DOMO', 'LBL_ELEMENT_TYPE_CAMERA', NULL, false, false, false, 2, 300, 3, null,000002,2,null);
...
(010201, 'ElementType:2', 'Values element type camera_domo', 'Values element type camera_domo', 'LBL_ELEMENT_MEASURES', NULL, 1, true);
...
(20103, 'ElementType:2', 'ElementTypeParam:2:1:1' , 1, true),
(20203, 'ElementType:2', 'ElementTypeParam:2:1:2' , 1, true);
