...
BEGIN
  IF EXISTS (SELECT 1 FROM pg_namespace WHERE nspname = 'gip') THEN
	...
	VALUES(3, 'gip', NULL, NULL, 'jdbc:postgresql://192.168.88.71:5430/rits', 'rits', 'uMuD7Uy0gpCRL4Jo1w6SOQ==', 'gip',
	...
	-- 
  	...
  	--
	INSERT INTO gip.sg_metadata_tables (id, name, label, label_singular, label_description, mdi_icon, support_images, support_attachments, metadata) VALUES
	...
	INSERT INTO gip.sg_metadata_columns (id, sg_metadata_table_id, column_name, "label", label_description, needs_translation, metadata) VALUES
