...
(0102, 1, 2, 401, 'LBL_MENU_ITEM_MAP', 'img/menu/map-menu.png', 'External map', 'External map', true, true),
...
(0302, 3, 2, 1950, 'LBL_C4', 'img/menu/default.png', 'incidenciasc4', 'incidenciasc4', true, true),
