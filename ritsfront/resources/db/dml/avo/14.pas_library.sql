...
(1, 1, 'Mensajes Pas', null, 'LBL_PAS_LIBRARY_PLAYER_HEADER', null, true, true),
	(2, 1, 'Mensaje de Congestion', null, 'LBL_PAS_CONGESTION', 1, true, true),
	(3, 1, 'Mensaje de Reducir', null, 'LBL_PAS_REDUCIR', 2, true, true),
	(4, 1, 'Mensaje de Detenerse', null, 'LBL_PAS_DETENERSE', 3, true, true),
	(5, 1, 'Mensaje de Accidente', null, 'LBL_PAS_ACCIDENTE', 4, true, true),
	(6, 1, 'Mensaje de Precaucion', null, 'LBL_PAS_PRECAUCION', 5, true, true),
	(7, 1, 'Mensaje de PI Cortado', null, 'LBL_PAS_CI_CORTADO', 6, true, true),
	(8, 1, 'Mensaje de PC Cortado', null, 'LBL_PAS_CC_CORTADO', 7, true, true),
	(9, 1, 'Mensaje de PD Cortado', null, 'LBL_PAS_CD_CORTADO', 8, true, true),
	(10, 1, 'Mensaje de Salida', null, 'LBL_PAS_SALIDA', 9, true, true),
	(11, 1, 'Mensaje de Emergencia', null, 'LBL_PAS_EMERGENCIA', 10, true, true),
	(12, 1, 'Mensaje de Incendio', null, 'LBL_PAS_INCENDIO', 11, true, true),
	(13, 1, 'Mensaje de Salida de Emergencia', null, 'LBL_PAS_SALIDA_EMERGENCIA', 12, true, true),
	(14, 1, 'Mensaje de Bocas', null, 'LBL_PAS_BOCAS', 13, true, true),
	(15, 1, 'Mensaje de Ciclista', null, 'LBL_PAS_CICLISTA', 14, true, true),
	(16, 1, 'Mensaje de Peaton', null, 'LBL_PAS_PEATON', 15, true, true),
	(17, 1, 'Mensaje de Poste SOS', null, 'LBL_PAS_POSTE_SOS', 16, true, true),
	(18, 1, 'Mensaje de Trabajos', null, 'LBL_PAS_TRABAJOS', 17, true, true),
	(19, 1, 'Mensaje de Objeto', null, 'LBL_PAS_OBJETO', 18, true, true),
	(20, 1, 'Mensaje de Sentido Contrario', null, 'LBL_PAS_SENT_CONTRARIO', 19, true, true);
