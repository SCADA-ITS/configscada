...
(3, NULL, 2, 'Layer Paneles', 'Layer Paneles', 'LBL_VMS', NULL, true);
...
(4, 2, 1, 'LBL_ALARMS', 'mdi mdi-pencil', false, 100501, NULL, 2, true, NULL, false, true),
(5, 2, 2, 'LBL_ELEMENT', 'mdi mdi-pencil', true, 101401, NULL, 2, false, NULL, true, true),
(6, 2, 3, 'LBL_COMMAND_EQUIPMENT', 'mdi mdi-pencil', false, 101701, NULL, 2, true, NULL, false, true);
