...
(400001, 4, 'LBL_MASTER', null, null, true, true),
	(40000102, 4, 'LBL_ELEMENTS_PARTES', null, 6046, true, true),
	(40000104, 4, 'LBL_ACTIONS', null, 6047, true, true),
	(40000105, 4, 'LBL_CAUSES', null, 6048, true, true),
	(40000106, 4, 'LBL_ROAD_IMPACTS', null, 6049, true, true),

(400002, 4, 'LBL_PARTES_TRABAJOS', null, null, true, true),
	(40000201, 4, 'LBL_PARTES_TRABAJOS', null, 6045, true, true),


(500001, 5, 'LBL_MASTER', null, null, true, true),
	(50000103, 5, 'LBL_SELECTOR_TREE_NODES_NORMALIZE_PROCEDURES', null, 6041, true, true),
	(50000104, 5, 'LBL_SELECTOR_TREE_NODES_POSSIBLE_CAUSES', null, 6042, true, true),
	(50000105, 5, 'LBL_SELECTOR_TREE_NODES_RESPONSIBILITIES', null, 6043, true, true),
(500002, 5, 'LBL_REGISTERS', null, null, true, true),
	(50000106, 5, 'LBL_SELECTOR_TREE_NODES_ALARMS_REGISTERS', null, 6044, true, true);
...
(4,  400001, 40000102, true, true),
(4,  400001, 40000104, true, true),
(4,  400001, 40000105, true, true),
(4,  400001, 40000106, true, true),


(4,  400002, 40000201, true, true),

(5,  500001, 50000103, true, true),
	(5,  500001, 50000104, true, true),
	(5,  500001, 50000105, true, true),
(5,  500002, 50000106, true, true);
