...
BEGIN
  IF EXISTS (SELECT 1 FROM pg_namespace WHERE nspname = 'nogales_gip') THEN
	...
	(0404, 4, 'resource_id', NULL, NULL, false, '{"position": 4 }'),
	(0405, 4, 'notice_date', 'LBL_NOTICE_DATE', NULL, false, '{"position": 5 }'),
	(0406, 4, 'arrival_date', 'LBL_ARRIVAL_DATE', NULL, false, '{"position": 6 }'),
	(0407, 4, 'release_date', 'LBL_RELEASE_DATE', NULL, false, '{"position": 7 }'),
	(0408, 4, 'comment', 'LBL_COMMENT', NULL, false, '{ "multiline": 8, "position": 8 }'),
	...
	(1205, 12, 'km_start', 'LBL_KM_START', NULL, false, '{ "position": 5, "editable": true}'),
	(1206, 12, 'km_end', 'LBL_KM_END', NULL, false, '{ "position": 6, "editable": true}'),
	(1207, 12, 'type_detection', 'LBL_TYPE_DETECTION', NULL, true, '{"position": 7, "editable": false}'),
	(1208, 12, 'source_id', 'LBL_SOURCE_FIELD', NULL, false, '{"position": 8 }'),
	(1209, 12, 'element_id', 'LBL_ELEMENT_FIELD', NULL, false, '{"position": 9 }'),
	(1210, 12, 'user_n', 'LBL_USER', NULL, false, '{"position": 10 }'),
	(1211, 12, 'phone', 'LBL_PHONE', NULL, false, '{"position": 11 }'),
    (1212, 12, 'comment', 'LBL_COMMENT', NULL, false, '{ "multiline": 5, "position": 12 }'),
	(1213, 12, 'created_at', 'LBL_CREATE_AT', NULL, false, '{"position": 13 }'),
	
	(2501, 25, 'incident_report_id', NULL, NULL, false, '{"position": 1 }'),
	(2502, 25, 'name', 'LBL_NAME', NULL, false, '{"position": 2 }'),
	(2503, 25, 'rut', 'LBL_RUT', NULL, false, '{"position": 3 }'),
	(2504, 25, 'address', 'LBL_ADDRESS', NULL, false, '{"position": 4 }'),
	(2505, 25, 'phone', 'LBL_PHONE_INFO', NULL, false, '{"position": 5 }'),
	(2506, 25, 'age', 'LBL_AGE', NULL, false, '{"position": 6 }'),
	(2507, 25, 'gender_id', 'LBL_GENDER', NULL, false, '{"position": 7 }'),
	(2508, 25, 'stage_id', 'LBL_STAGE_ID', NULL, false, '{"position": 8 }'),
	(2509, 25, 'user_type_id', 'LBL_USER_TYPE_ID', NULL, false, '{"position": 9 }'),
	(2510, 25, 'injury_type_id', 'LBL_INJURY_TYPE_ID', NULL, false, '{"position": 10 }'),
	(2511, 25, 'injury_level_id', 'LBL_INJURY_LEVEL_ID', NULL, false, '{"position": 11 }'),
	(2512, 25, 'participant_assistance_type_id', 'LBL_PARTICIPANT_ASSISTANCE_TYPE_ID', NULL, false, '{"position": 12 }'),
	(2513, 25, 'participant_transfer_place_id', 'LBL_PARTICIPANT_TRANSFER_PLACE_ID', NULL, false, '{"position": 13 }'),
	
	(3301, 33, 'incident_report_id', NULL, NULL, true, '{"position": 1 }'),
	(3302, 33, 'count', 'LBL_COUNT', NULL, true, '{"position": 2 }'),
	(3303, 33, 'clousing_count', 'LBL_CLOUSING_COUNT', NULL, true, '{"position": 3 }'),
	(3304, 33, 'lane_action_id', 'LBL_LANE_ACTION', NULL, true, '{"position": 4 }'),
	(3305, 33, 'lane_id', 'LBL_LANE', NULL, true, '{"position": 5 }'),
	(3306, 33, 'start_action', 'LBL_START_ACTION', NULL, true, '{"position": 6 }'),
	(3307, 33, 'comment', 'LBL_COMMENT', NULL, true, '{ "multiline": 8, "position": 7 }'),
