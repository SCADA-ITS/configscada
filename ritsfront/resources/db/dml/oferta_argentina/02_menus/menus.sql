...
(0203, 2, 1, 1020, 'LBL_MENU_ITEM_CCTV', 'img/menu/camera-menu.png', 'Menu item CCTV', 'Menu item CCTV', true, true),
...
(0402, 4, 2, 1920, 'LBL_GIP', 'img/menu/default.png', 'NOGALES_GIP', 'Nogales GIP', true, true),
(0403, 4, 3, 6011, 'LBL_GIP_INCIDENT', 'img/menu/default.png', 'NOGALES_GIP_INCIDENT', 'Nogales GIP', true, true),
(0404, 4, 4, 1045, 'LBL_HISTORICAL_CHARTS', 'img/menu/chart-menu.png', 'Historical charts', 'Historical Charts', true, true);