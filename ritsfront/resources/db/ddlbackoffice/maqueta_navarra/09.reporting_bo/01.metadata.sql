...
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tablespace WHERE spcname = 'tbl_reporting_bo') THEN
	...
	-- Table: reporting_bo.sg_metadata_tables
	-- Descripción: 
	-- Scope: 
	--
	CREATE TABLE reporting_bo.sg_metadata_tables (
		id serial NOT NULL,
	...
	-- Scope: 
	--
	CREATE TABLE reporting_bo.sg_metadata_table_images (
		id serial NOT NULL,
	...
	CREATE INDEX idx_sg_metadata_table_images_sg_metadata_table_id ON reporting_bo.sg_metadata_table_images USING btree (sg_metadata_table_id);
	...
	-- Scope: 
	--
	CREATE TABLE reporting_bo.sg_metadata_table_attachments (
		id serial NOT NULL,
		sg_metadata_table_id int NOT NULL,
		id_value int NOT NULL,
		group_name varchar NOT NULL,
	...
	CREATE INDEX idx_sg_metadata_table_attachments_sg_metadata_table_id ON reporting_bo.sg_metadata_table_attachments USING btree (sg_metadata_table_id);
	...
	-- Scope: 
	--
	CREATE TABLE reporting_bo.sg_metadata_table_triggers (
		id serial NOT NULL,
		sg_metadata_table_id int NOT NULL,
		name varchar NULL,
	...
	CREATE INDEX idx_sg_metadata_table_triggers_sg_metadata_table_id ON reporting_bo.sg_metadata_table_triggers USING btree (sg_metadata_table_id);
	...
	-- Scope: 
	--
	CREATE TABLE reporting_bo.sg_metadata_table_commands (
		id serial NOT NULL,
		sg_metadata_table_id int NOT NULL,
	...
	CREATE INDEX idx_sg_metadata_table_commands_sg_metadata_table_id ON reporting_bo.sg_metadata_table_commands USING btree (sg_metadata_table_id);

	ALTER TABLE reporting_bo.sg_metadata_table_commands ADD CONSTRAINT fk_sg_metadata_table_commands_sg_metadata_table_id FOREIGN KEY (sg_metadata_table_id) references reporting_bo.sg_metadata_tables(id);
	...
	-- Scope: 
	--
	CREATE TABLE reporting_bo.sg_metadata_columns (
		id serial NOT NULL,
		sg_metadata_table_id int NOT NULL,
	...
	CREATE INDEX idx_sg_metadata_columns_sg_metadata_table_id ON reporting_bo.sg_metadata_columns USING btree (sg_metadata_table_id);

	ALTER TABLE reporting_bo.sg_metadata_columns ADD CONSTRAINT fk_sg_metadata_columns_sg_metadata_table_id FOREIGN KEY (sg_metadata_table_id) references reporting_bo.sg_metadata_tables(id);
	
	ALTER TABLE reporting_bo.sg_metadata_columns ADD CONSTRAINT fk_sg_metadata_columns_sg_metadata_column_id FOREIGN KEY (ref_view_column_id) references reporting_bo.sg_metadata_columns(id);
	...
	-- Scope: 
	--
	CREATE TABLE reporting_bo.sg_metadata_column_fillers (
		id serial NOT NULL,
	...
	CREATE INDEX idx_sg_metadata_column_fillers_sg_metadata_column_id ON reporting_bo.sg_metadata_column_fillers USING btree (sg_metadata_column_id);
	...
	-- Scope: 
	--
	CREATE TABLE reporting_bo.sg_metadata_tasks (
		id serial NOT NULL,
		name varchar NULL,
	...
	-- Scope:
	--
	CREATE TABLE reporting_bo.sg_i18n_labels (
		id serial NOT NULL,
