...
if [ "$#" -gt 3 ]; then
	psql postgresql://dbo_controltrafico:12hJklfj9.pha9@$2/controltrafico -c "UPDATE ui.data_source_values SET value='http://$4:8082/graphql' WHERE data_source_param_id = 1;"
	psql postgresql://dbo_controltrafico:12hJklfj9.pha9@$2/controltrafico -c "UPDATE ui.data_source_values SET value='ws://$4:61614' WHERE data_source_param_id = 5;"
	psql postgresql://dbo_controltrafico:12hJklfj9.pha9@$2/controltrafico -c "UPDATE ui.data_source_values SET value='http://$4:8082/graphql' WHERE data_source_param_id = 8;"
else
