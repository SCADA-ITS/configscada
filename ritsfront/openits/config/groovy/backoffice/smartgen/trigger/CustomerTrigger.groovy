...
public class CustomerTrigger extends AbstractBackOfficeTrigger {

	public CustomerTrigger(org.apache.logging.log4j.Logger log) {
		super(log);
	}
	...
	private void updateProductStock() throws Exception {
		...
		final String qry = String.format("SELECT od.product_id, od.qty " +
										 "  FROM %s.order_details od, " + 
										 "      %s.orders o, " +
										 "      %s.customers cus " + 
