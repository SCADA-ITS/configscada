...
const PARAM_COMMAND_VALUE_ID = "ElementTypeParam:87:2:1";
			...
			if (cmdGroupValue && treatmentValue) {
				switch (true) {
					...
					case level > 0 && level <= 25:
						this.gLevel25.attr({ "fill-opacity": 1 , "fill" : "red"});
						this.gLevel50.attr({ "fill-opacity": 0 });
						this.gLevel75.attr({ "fill-opacity": 0 });
						this.gLevel100.attr({ "fill-opacity": 0 });
						break;
					...
					case level > 25 && level <= 50:
						this.gLevel25.attr({ "fill-opacity": 1 , "fill" : "orange"});
						this.gLevel50.attr({ "fill-opacity": 1 , "fill" : "orange"});
						this.gLevel75.attr({ "fill-opacity": 0 });
						this.gLevel100.attr({ "fill-opacity": 0 });
						break;

					case level > 50 && level <= 75:
						this.gLevel25.attr({ "fill-opacity": 1 , "fill" : "yellow"});
						this.gLevel50.attr({ "fill-opacity": 1 , "fill" : "yellow"});
						this.gLevel75.attr({ "fill-opacity": 1 , "fill" : "yellow"});
						this.gLevel100.attr({ "fill-opacity": 0 });
						break;

					case level > 75 && level <= 100:
						this.gLevel25.attr({ "fill-opacity": 1 , "fill" : "blue" });
						this.gLevel50.attr({ "fill-opacity": 1 , "fill" : "blue"});
						this.gLevel75.attr({ "fill-opacity": 1 , "fill" : "blue"});
						this.gLevel100.attr({ "fill-opacity": 1 , "fill" : "blue"});
						break;

					default:
						this.gLevel25.attr({ "fill-opacity": 0 , "fill" : "blue" });
						this.gLevel50.attr({ "fill-opacity": 0 , "fill" : "blue" });
						this.gLevel75.attr({ "fill-opacity": 0 , "fill" : "blue" });
						this.gLevel100.attr({ "fill-opacity": 0 , "fill" : "blue" });
						break;
				}
			}
		}
