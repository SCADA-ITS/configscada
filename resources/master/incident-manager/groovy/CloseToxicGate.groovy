...
class CloseToxicGate {

	static final Long ELEMENT_TYPE_TOXIC_CONTROL = 48L;
	static final Long CLOSE_GATE_COMMAND = 2L;

	org.apache.logging.log4j.Logger log;

	CloseToxicGate(org.apache.logging.log4j.Logger log) {
	...
	SignallingCommand rellenaSignallingCommand(Long element){
		...
		signallingCommand.setSignallingCommandId(CLOSE_GATE_COMMAND);
