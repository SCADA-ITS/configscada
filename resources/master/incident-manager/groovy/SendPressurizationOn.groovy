...
class SendPressurizationOn {

	static final Long ELEMENT_TYPE_PRESSURIZACION = 32L;
	static final Long COMMAND_ELEMENT_TYPE_PRESSURIZACION_ON = 1L;
	

	org.apache.logging.log4j.Logger log;

	SendPressurizationOn(org.apache.logging.log4j.Logger log) {
		...
		if (incidentReport.getAffectionStretchId() != null) {
			...
			if (!CollectionUtils.isEmpty(elements)) {
				...
				for (Long elementId : elements) {
					...
					signallingCommand.setSignallingCommandId(COMMAND_ELEMENT_TYPE_PRESSURIZACION_ON);
