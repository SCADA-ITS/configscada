...
import com.revenga.rits.back.equipment.manager.helper.SetFansResetTotalHoursCommandHelper;
...
class SetFansResetTotalHoursCommand {
	...
	List<Command> process(PmCommandElement command) {
		...
		Command cmd = SetFansResetTotalHoursCommandHelper.get(command != null ? command.getElementId() : null);
