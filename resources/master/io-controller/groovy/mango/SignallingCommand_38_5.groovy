...
/**
 *
 * SignallingCommand_38_5: BUS-VAO
 *
 */
class SignallingCommand_38_5 {
    ...
    //static final Long ENCENDER_FLASHING_70 = 5L
    static final boolean OFF = false
    static final boolean ON = true

    org.apache.logging.log4j.Logger log;

    SignallingCommand_38_5(org.apache.logging.log4j.Logger log) {
    ...
    boolean process(String dataSourceXid, SignallingCommand signallingCommand, MangoDriver driver) {
        try {
            ...
            /*
            xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand,'DP_BAL_A_' + BALIZA_CMD, ENCENDER_FLASHING_70);
            xidPointValueTimeModels.add(xidPointValueTimeModel);
            xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand,'DP_BAL_V_' + BALIZA_CMD, ENCENDER_FLASHING_70);
            xidPointValueTimeModels.add(xidPointValueTimeModel);
            */

            xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand,'DP_BUS-VAO_' + C0, ON);
            xidPointValueTimeModels.add(xidPointValueTimeModel);
            xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand,'DP_BUS-VAO_' + C1, ON);
            xidPointValueTimeModels.add(xidPointValueTimeModel);
            xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand,'DP_BUS-VAO_' + C2, ON);
            xidPointValueTimeModels.add(xidPointValueTimeModel);
