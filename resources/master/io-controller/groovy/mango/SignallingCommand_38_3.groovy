...
/**
 *
 * SignallingCommand_38_3: BUS-VAO
 *
 */
class SignallingCommand_38_3 {
    ...
    //static final Long ENCENDER_70 = 3L
    static final boolean OFF = false
    static final boolean ON = true

    org.apache.logging.log4j.Logger log;

    SignallingCommand_38_3(org.apache.logging.log4j.Logger log) {
    ...
    boolean process(String dataSourceXid, SignallingCommand signallingCommand, MangoDriver driver) {
        try {
            ...
            /*
            xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand,'DP_BAL_A_' + BALIZA_CMD, ENCENDER_70);
            xidPointValueTimeModels.add(xidPointValueTimeModel);
            xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand,'DP_BAL_V_' + BALIZA_CMD, ENCENDER_70);
            xidPointValueTimeModels.add(xidPointValueTimeModel);
            */
