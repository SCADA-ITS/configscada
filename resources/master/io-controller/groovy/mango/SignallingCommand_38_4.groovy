...
/**
 *
 * SignallingCommand_38_4: BUS-VAO
 *
 */
class SignallingCommand_38_4 {
    ...
    //static final Long ENCENDER_FLASHING_100 = 4L
    static final boolean OFF = false
    static final boolean ON = true

    org.apache.logging.log4j.Logger log;

    SignallingCommand_38_4(org.apache.logging.log4j.Logger log) {
    ...
    boolean process(String dataSourceXid, SignallingCommand signallingCommand, MangoDriver driver) {
        try {
            ...
            /*
            xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand,'DP_BAL_A_' + BALIZA_CMD, ENCENDER_FLASHING_100);
            xidPointValueTimeModels.add(xidPointValueTimeModel);
            xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand,'DP_BAL_V_' + BALIZA_CMD, ENCENDER_FLASHING_100);
            xidPointValueTimeModels.add(xidPointValueTimeModel);
            */
