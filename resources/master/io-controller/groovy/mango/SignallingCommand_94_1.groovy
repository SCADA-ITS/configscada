...
/**
 * 
 * SignallingCommand_94_1: Call signalling command 
 * 
 */
class SignallingCommand_94_1 {

	GroovyShell shell;
	def signallingCommandUtils;
	
	static final String CALL_SYSTEM_CMD = "call";
	static final Boolean CALL_SYSTEM_ON = 1;
	
	org.apache.logging.log4j.Logger log;
	
	SignallingCommand_94_1(org.apache.logging.log4j.Logger log) {
	...
	boolean process(String dataSourceXid, SignallingCommand signallingCommand, MangoDriver driver) {
		...
		try {
			...
			XidPointValueTimeModel xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand, 
					dataSourceXid + "_" + CALL_SYSTEM_CMD, CALL_SYSTEM_ON);
