...
class InputAdapter_VMS {
	...
	static final String JSON_CLEAN = "[{\"zone\":1,\"alternance_ms\":0,\"flashing_on_ms\":0,\"flashing_off_ms\":0,\"texts\":[],\"graphics\":[{\"id\":1,\"value\":null,\"alternance\":null}],\"align\":\"center\"},{\"zone\":2,\"alternance_ms\":0,\"flashing_on_ms\":0,\"flashing_off_ms\":0,\"texts\":[{\"id\":1,\"value\":null,\"alternance\":null,\"color\":\"#E2943A\"},{\"id\":2,\"value\":null,\"alternance\":null,\"color\":\"#E2943A\"},{\"id\":3,\"value\":null,\"alternance\":null,\"color\":\"#E2943A\"}],\"graphics\":[],\"align\":\"center\"}]";
	...
	public String construirVMS(String content, Element element, boolean intermitence) {
		...
		for (String message : messages) {
			...
			if (message.indexOf("g") == -1){
				...
				texts.add(message.substring(message.indexOf("")).replace("[nl]","#"));
			}else{
