...
/**
 * 
 * SignallingCommand_85_1: Send DALI regime 
 * 
 */
class SignallingCommand_85_1 {
	...
	static final int COMMAND_SEND_REGIME_TYPE_PARAM = 1;
	
	org.apache.logging.log4j.Logger log;
	
	SignallingCommand_85_1(org.apache.logging.log4j.Logger log) {
	...
	boolean process(String dataSourceXid, SignallingCommand signallingCommand, MangoDriver driver) {
		...
		try {			
			...
			XidPointValueTimeModel xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand, COMMAND_SEND_REGIME_TYPE_PARAM,
					dataSourceXid + "_" + DALI_CMD);
