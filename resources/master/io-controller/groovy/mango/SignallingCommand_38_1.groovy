...
/**
 *
 * SignallingCommand_38_1: BUS-VAO
 *
 */
class SignallingCommand_38_1 {
    ...
    //static final Long APAGAR = 1L
    static final boolean OFF = false

    org.apache.logging.log4j.Logger log;

    SignallingCommand_38_1(org.apache.logging.log4j.Logger log) {
    ...
    boolean process(String dataSourceXid, SignallingCommand signallingCommand, MangoDriver driver) {
        try {
            ...
            /*
            xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand,'DP_BAL_A_' + BALIZA_CMD, APAGAR);
            xidPointValueTimeModels.add(xidPointValueTimeModel);
            xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand,'DP_BAL_V_' + BALIZA_CMD, APAGAR);
            xidPointValueTimeModels.add(xidPointValueTimeModel);
            */

            xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand,'DP_BUS-VAO_' + C0, OFF);
            xidPointValueTimeModels.add(xidPointValueTimeModel);
