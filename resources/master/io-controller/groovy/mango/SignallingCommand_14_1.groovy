...
/**
 * 
 * SignallingCommand_14_1: Change Lum Factor Multiplier 
 * 
 */
class SignallingCommand_14_1 {

	GroovyShell shell;
	def signallingCommandUtils;
	
	static final String LUM_CMD = "multiplier";
	
	static final Long PARAM_TYPE_MEASURE = 2L;
	static final int COMMAND_CHANGE_FACTOR_TYPE_PARAM = 1;
	
	org.apache.logging.log4j.Logger log;
	
	SignallingCommand_14_1(org.apache.logging.log4j.Logger log) {
	...
	boolean process(String dataSourceXid, SignallingCommand signallingCommand, MangoDriver driver) {
		...
		try {			
			...
			XidPointValueTimeModel xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand, COMMAND_CHANGE_FACTOR_TYPE_PARAM,
					dataSourceXid + "_" + LUM_CMD);
