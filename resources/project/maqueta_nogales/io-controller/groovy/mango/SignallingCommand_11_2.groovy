...
/**
 *
 * SignallingCommand_11_2: SOS volumen audio signalling command
 *
 */
class SignallingCommand_11_2 {
    ...
    SignallingCommand_11_2(org.apache.logging.log4j.Logger log) {
    ...
    boolean process(String dataSourceXid, SignallingCommand signallingCommand, MangoDriver driver) {
        try {
            ...
            Long vol_audio_writer_value = Integer.parseInt(signallingCommand.getSignallingParams().get(0).getValue());

            XidPointValueTimeModel xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand,
                    dataSourceXid + '_' + VOL_AUDIO, vol_audio_writer_value)
