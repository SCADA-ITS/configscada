...
/**
 *
 * SignallingCommand_11_3: SOS volumen micro signalling command
 *
 */
class SignallingCommand_11_3 {

    GroovyShell shell;
    def signallingCommandUtils;

    static final String VOL_MICRO = 'vol_mic_writer'


    org.apache.logging.log4j.Logger log;

    SignallingCommand_11_3(org.apache.logging.log4j.Logger log) {
    ...
    boolean process(String dataSourceXid, SignallingCommand signallingCommand, MangoDriver driver) {
        try {
            ...
            Long vol_micro_writer_value = Integer.parseInt(signallingCommand.getSignallingParams().get(0).getValue());

            XidPointValueTimeModel xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand,
                    dataSourceXid + '_' + VOL_MICRO, vol_micro_writer_value)
