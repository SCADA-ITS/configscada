...
def void txt(SignallingCommand signallingCommand, String dataSourceXid, MangoDriver driver, Element element, org.apache.logging.log4j.Logger log) {	
	...
	String multi_main_text = "[tr70,1,0,0]", multi_alternate_text = "[tr70,1,0,0]", multi = "";
	...
	if(multi_main_text.equals("[tr70,1,0,0][jl2]") && multi_alternate_text.equals("[tr70,1,0,0][jl2]")){
		multi = "";
	}else if(!multi_main_text.equals("[tr70,1,0,0][jl2]") && multi_alternate_text.equals("[tr70,1,0,0][jl2]")){
		multi = multi_main_text
	}else if(multi_main_text.equals("[tr70,1,0,0][jl2]" && !multi_alternate_text.equals("[tr70,1,0,0][jl2]"))){
