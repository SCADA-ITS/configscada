...
class EtdParamsAdapterTFA {
	...
	static final Long PARAM_MEASURE_VEH_LENGTH_3 = 22L;
		...
		try {
			...
			if (elementValues != null) {
				...
				for (ElementHierarchy child : childs){
					...
					listElements.add(elementSetValue(PARAM_MEASURE_OCCUPANCY, TYPE_PARAM_MEASURE, childElement.getId(),String.valueOf(etd_info.get(detArrayPos).occupancy)));	
					...
					listElements.add(elementSetValue(PARAM_MEASURE_SPEED, TYPE_PARAM_MEASURE, childElement.getId(),String.valueOf(etd_info.get(detArrayPos).average_speed)));	
					...
					listElements.add(elementSetValue(PARAM_MEASURE_LENGTH, TYPE_PARAM_MEASURE, childElement.getId(),String.valueOf(etd_info.get(detArrayPos).average_length)));	
					...
					val = String.valueOf(etd_info.get(detArrayPos).veh_length_3 == null ? 0 : etd_info.get(detArrayPos).veh_length_3);
					listElements.add(elementSetValue(PARAM_MEASURE_VEH_LENGTH_3, TYPE_PARAM_MEASURE, childElement.getId(),val));
