...
/**
 * 
 * SignallingCommand_73_2: ON 0% signalling command 
 * 
 */
class SignallingCommand_73_2 {
	...
	static final long FIVE = 0;
	
	
	org.apache.logging.log4j.Logger log;
	
	SignallingCommand_73_2(org.apache.logging.log4j.Logger log) {
	...
	boolean process(String dataSourceXid, SignallingCommand signallingCommand, MangoDriver driver) {
		...
		try {
			...
			xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand, 
					dataSourceXid + "_" + ARC_LEVEL, FIVE);
			xidPointValueTimeModels.add(xidPointValueTimeModel);
