...
/**
 *
 * SignallingCommand_68_2: TFA_3D SANCTION OFF command
 *
 */
class SignallingCommand_68_2 {

	GroovyShell shell;
	def signallingCommandUtils;
	
	static final String ACTIVATE_PANEL = "activate_panel";
	static final String ACTIVATE_PANEL_ON = "on";
	static final String ACTIVATE_PANEL_OFF = "off";

	org.apache.logging.log4j.Logger log;
	
	SignallingCommand_68_2(org.apache.logging.log4j.Logger log) {
	...
	boolean process(String dataSourceXid, SignallingCommand signallingCommand, MangoDriver driver) {
		...
		try {
			...
			XidPointValueTimeModel xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand,
					dataSourceXid + "_" + ACTIVATE_PANEL, ACTIVATE_PANEL_OFF);
