...
/**
 * 
 * SignallingCommand_9_11: Fan reset signalling command 
 * 
 */
class SignallingCommand_9_11 {

	GroovyShell shell;
	def signallingCommandUtils;
	
	static final String FAN_RESET = "reset_order";
	static final boolean ON = true;		
	
	org.apache.logging.log4j.Logger log;
	
	SignallingCommand_9_11(org.apache.logging.log4j.Logger log) {
