...
/**
 * 
 * SignallingCommand_18_2: DESINHIBIR signalling command 
 * 
 */
class SignallingCommand_18_2 {

	GroovyShell shell;
	def signallingCommandUtils;
	
	//XIDs
	static final String INHIBIR = "inhibir";
	...
	SignallingCommand_18_2(org.apache.logging.log4j.Logger log) {
