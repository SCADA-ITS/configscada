...
class SignallingCommand_2000_7 {
    ...
    static final String REGIME_CMD = 'illumination_regime_cmd';
    ...
    boolean process(String dataSourceXid, SignallingCommand signallingCommand, MangoDriver driver) {
        try {
			...
			XidPointValueTimeModel xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand, PARAM_ID_ILLUMINATION_REGIME, dataSourceXid + '_' + REGIME_CMD);
