...
/**
 *
 * SignallingCommand_8_3: Barrier force pull down signalling command
 *
 */
class SignallingCommand_8_3 {
    ...
    static final Long BARRIER_CMD_FORCE_PULL_DOWN = 3L

    org.apache.logging.log4j.Logger log;

    SignallingCommand_8_3(org.apache.logging.log4j.Logger log) {
    ...
    boolean process(String dataSourceXid, SignallingCommand signallingCommand, MangoDriver driver) {
        try {
            ...
            XidPointValueTimeModel xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand,
                    dataSourceXid + '_' + BARRIER_CMD, BARRIER_CMD_FORCE_PULL_DOWN)
