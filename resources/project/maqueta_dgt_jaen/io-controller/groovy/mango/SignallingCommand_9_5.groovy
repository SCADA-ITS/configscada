...
/**
 * 
 * SignallingCommand_9_5: Fan reset total hours signalling command 
 * 
 */
class SignallingCommand_9_5 {

	GroovyShell shell;
	def signallingCommandUtils;
	
	static final String FAN_RESET = "fan_reset";
	static final Long FAN_RESET_VALUE_PARTIAL_HOURS = 2L;
	
	org.apache.logging.log4j.Logger log;
	
	SignallingCommand_9_5(org.apache.logging.log4j.Logger log) {
	...
	boolean process(String dataSourceXid, SignallingCommand signallingCommand, MangoDriver driver) {
		...
		try {
			...
			XidPointValueTimeModel xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand, 
					dataSourceXid + "_" + FAN_RESET, FAN_RESET_VALUE_PARTIAL_HOURS);
