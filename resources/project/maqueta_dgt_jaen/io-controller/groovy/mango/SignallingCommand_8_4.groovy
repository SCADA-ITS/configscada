...
/**
 *
 * SignallingCommand_8_4: Barrier reset signalling command
 *
 */
class SignallingCommand_8_4 {

    GroovyShell shell;
    def signallingCommandUtils;

    static final String BARRIER_CMD_R = 'bar_cmd_reset'
	static final String BARRIER_CMD = 'bar_cmd'

    static final Long BARRIER_CMD_RESET = 8L

    org.apache.logging.log4j.Logger log;

    SignallingCommand_8_4(org.apache.logging.log4j.Logger log) {
