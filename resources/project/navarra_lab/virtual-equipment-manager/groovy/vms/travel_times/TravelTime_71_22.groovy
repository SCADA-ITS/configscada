...
class TravelTime_71_22 {
	...
	static final String JSON_DATA_TEMPLATE = "[{\"zone\":1,\"graphics\":[{\"id\":1,\"value\":874}]},{\"zone\":2,\"alternance_ms\":5000,\"align\": \"left\",\"texts\":[{\"id\":1,\"value\":\"\"},{\"id\":2,\"value\":\"\"},{\"id\":3,\"value\":\"\"}]},{\"zone\":3,\"graphics\":[{\"id\":1,\"value\":874}]}]";
	...
	static final List<Integer> MINUTES_PICTOGRAMS = Arrays.asList(875, 876, 877); 
	 ...
	 TravelTime_71_22(org.apache.logging.log4j.Logger log) {
								...
								if (travelTime.getTime() != null && travelTime.getTime() > 0) {
									...
									if (travelTimesOK < vmsMessageZone.getTexts().size()) {
										...
										if (zoneText != null) {
											...
											String lineTravelTime = String.format(formatLine, travelTime.getName(),
													travelTime.getTime(), TIME_UDS).trim();
											
											zoneText.setValue(lineTravelTime);
