...
class SignallingCommand_71_3 {
	...
	boolean process(String dataSourceXid, SignallingCommand signallingCommand, MangoDriver driver) {
		try {
			...
			def blank = shell.parse(new File(ResourcesUtil.getPath("io-controller/groovy/mango/pmv_subtypes/utils/utilsPMV.groovy")));
			blank.activarVMSNTCIP("", dataSourceXid, signallingCommand, driver, false, false, 255);
