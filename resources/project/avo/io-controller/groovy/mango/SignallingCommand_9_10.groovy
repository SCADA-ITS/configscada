...
/**
 * 
 * SignallingCommand_9_10: Fan start axial signalling command 
 * 
 */
class SignallingCommand_9_10 {

	GroovyShell shell;
	def signallingCommandUtils;
	
	static final String FAN_CMD = "fan_cmd";
	static final String FAN_SPEED = "speed_reference";

	static final Long FAN_CMD_VALUE_START_REVERSE = 2L;

	
	org.apache.logging.log4j.Logger log;
	
	SignallingCommand_9_10(org.apache.logging.log4j.Logger log) {
	...
	boolean process(String dataSourceXid, SignallingCommand signallingCommand, MangoDriver driver) {
		...
		try {
			...
			Long reference = Integer.parseInt(signallingCommand.getSignallingParams().get(0).getValue())
