...
/**
 * 
 * SignallingCommand_61_1: Reset signalling command 
 * 
 */
class SignallingCommand_61_1 {

	GroovyShell shell;
	def signallingCommandUtils;
	
	static final String RESET_CMD = "reset";
	static final Long RESET_VALUE = 65535L;	
	static final Long END_RESET_VALUE = 0L;	
	
	org.apache.logging.log4j.Logger log;
	
	SignallingCommand_61_1(org.apache.logging.log4j.Logger log) {
	...
	boolean process(String dataSourceXid, SignallingCommand signallingCommand, MangoDriver driver) {
		...
		try {
			...
			XidPointValueTimeModel xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand, 
					dataSourceXid + "_" + RESET_CMD, RESET_VALUE);
			...
			xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand, 
					dataSourceXid + "_" + RESET_CMD, END_RESET_VALUE);
