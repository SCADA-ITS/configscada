...
/**
 * 
 * SignallingCommand_24_3: Fan stop signalling command 
 * 
 */
class SignallingCommand_24_3 {

	GroovyShell shell;
	def signallingCommandUtils;
	
	static final String FAN_CMD_STOP = "stop";
	static final String FAN_CMD_DIRECT_GEAR = "direct_gear";
	static final String FAN_CMD_INDIRECT_GEAR = "indirect_gear";
	static final Long FAN_CMD_VALUE_STOP = 0L;
	static final Long FAN_CMD_VALUE_DIRECT_GEAR = 0L;
	static final Long FAN_CMD_VALUE_INDIRECT_GEAR = 1L;
	
	org.apache.logging.log4j.Logger log;
	
	SignallingCommand_24_3(org.apache.logging.log4j.Logger log) {
	...
	boolean process(String dataSourceXid, SignallingCommand signallingCommand, MangoDriver driver) {
		...
		try {
			...
			xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand, 
					dataSourceXid + "_" + FAN_CMD_STOP, FAN_CMD_VALUE_STOP);						
			xidPointValueTimeModels.add(xidPointValueTimeModel);
			
			xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand, 
					dataSourceXid + "_" + FAN_CMD_DIRECT_GEAR, FAN_CMD_VALUE_DIRECT_GEAR);						
			xidPointValueTimeModels.add(xidPointValueTimeModel);
			
			xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand, 
					dataSourceXid + "_" + FAN_CMD_INDIRECT_GEAR, FAN_CMD_VALUE_INDIRECT_GEAR);						
			xidPointValueTimeModels.add(xidPointValueTimeModel);
