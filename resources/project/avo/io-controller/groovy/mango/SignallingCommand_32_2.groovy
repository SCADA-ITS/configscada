...
/**
 * 
 * SignallingCommand_32_2: Fire pressurization OFF
 * 
 */
class SignallingCommand_32_2 {

	GroovyShell shell;
	def signallingCommandUtils;
	
	static final String FIRE_PRESSURIZATION_CMD = "fan_stop";
	
	static final Long PARAM_TYPE_MEASURE = 2L;
	static final Long FIRE_PRESSURIZATION_CMD_VALUE_OFF = 1L;
	
	org.apache.logging.log4j.Logger log;
	
	SignallingCommand_32_2(org.apache.logging.log4j.Logger log) {
	...
	boolean process(String dataSourceXid, SignallingCommand signallingCommand, MangoDriver driver) {
		...
		try {
			...
			XidPointValueTimeModel xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand, 
					dataSourceXid + "_" + FIRE_PRESSURIZATION_CMD, FIRE_PRESSURIZATION_CMD_VALUE_OFF);
