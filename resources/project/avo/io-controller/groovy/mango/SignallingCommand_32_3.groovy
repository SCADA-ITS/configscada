...
/**
 * 
 * SignallingCommand_32_3: Fire pressurization Reset alarms
 * 
 */
class SignallingCommand_32_3 {

	GroovyShell shell;
	def signallingCommandUtils;
	
	static final String FIRE_PRESSURIZATION_RESET = "reset_alarms";
	...
	SignallingCommand_32_3(org.apache.logging.log4j.Logger log) {
