...
/**
 * 
 * SignallingCommand_84_2: Circuit off signalling command 
 * 
 */
class SignallingCommand_84_2 {

	GroovyShell shell;
	def signallingCommandUtils;
	
	static final String CIRCUIT_CMD = "cmd";
	Long CIRCUIT_CMD_VALUE_ON = 1L;

	org.apache.logging.log4j.Logger log;
	
	SignallingCommand_84_2(org.apache.logging.log4j.Logger log) {
	...
	boolean process(String dataSourceXid, SignallingCommand signallingCommand, MangoDriver driver) {
		...
		try {
			...
			xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand, dataSourceXid + "_" + CIRCUIT_CMD, CIRCUIT_CMD_VALUE_ON);			
