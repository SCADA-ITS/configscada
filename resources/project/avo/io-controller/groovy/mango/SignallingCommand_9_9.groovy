...
/**
 * 
 * SignallingCommand_9_9: Fan start axial signalling command 
 * 
 */
class SignallingCommand_9_9 {
	...
	static final Long FAN_CMD_VALUE_START = 1L;

	
	org.apache.logging.log4j.Logger log;
	
	SignallingCommand_9_9(org.apache.logging.log4j.Logger log) {
	...
	boolean process(String dataSourceXid, SignallingCommand signallingCommand, MangoDriver driver) {
		...
		try {
			...
			xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand, 
						dataSourceXid + "_" + FAN_CMD, FAN_CMD_VALUE_START);
