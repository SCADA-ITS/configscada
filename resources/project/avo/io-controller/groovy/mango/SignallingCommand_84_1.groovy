...
/**
 * 
 * SignallingCommand_84_1: Circuit off signalling command 
 * 
 */
class SignallingCommand_84_1 {

	GroovyShell shell;
	def signallingCommandUtils;
	
	Long CIRCUIT_CMD_VALUE_OFF = 0L;
	static final String CIRCUIT_CMD = "cmd"
	org.apache.logging.log4j.Logger log;
	
	SignallingCommand_84_1(org.apache.logging.log4j.Logger log) {
	...
	boolean process(String dataSourceXid, SignallingCommand signallingCommand, MangoDriver driver) {
		...
		try {
			...
			xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand, dataSourceXid + "_" + CIRCUIT_CMD, CIRCUIT_CMD_VALUE_OFF);			
