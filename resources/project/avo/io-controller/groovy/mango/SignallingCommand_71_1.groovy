...
/**
 *
 * SignallingCommand_71_1: Barrier pull down signalling command
 *
 */
class SignallingCommand_71_1 {

    GroovyShell shell;
    def signallingCommandUtils;

    static final String DISABLED = 'enabled'

    static final Boolean DISABLED_VALUE = false;

    org.apache.logging.log4j.Logger log;

    SignallingCommand_71_1(org.apache.logging.log4j.Logger log) {
    ...
    boolean process(String dataSourceXid, SignallingCommand signallingCommand, MangoDriver driver) {
        try {
            ...
            XidPointValueTimeModel xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand,
                    dataSourceXid + '_' + DISABLED, DISABLED_VALUE)
