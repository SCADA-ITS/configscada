...
/**
 * 
 * SignallingCommand_32_4: Fire pressurization Reset partial hours
 * 
 */
class SignallingCommand_32_4 {

	GroovyShell shell;
	def signallingCommandUtils;
	
	static final String FIRE_PRESSURIZATION_RESET = "partial_hours_reset";
	
	static final Long PARAM_TYPE_MEASURE = 2L;
	static final Long FIRE_PRESSURIZATION_RESET_VALUE = 1L;
	
	org.apache.logging.log4j.Logger log;
	
	SignallingCommand_32_4(org.apache.logging.log4j.Logger log) {
	...
	boolean process(String dataSourceXid, SignallingCommand signallingCommand, MangoDriver driver) {
		...
		try {
			...
			XidPointValueTimeModel xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand, 
					dataSourceXid + "_" + FIRE_PRESSURIZATION_RESET, FIRE_PRESSURIZATION_RESET_VALUE);
