...
class InputAdapter_VMS {
	...
	static final String JSON_EXCESO_GALIBO = "[{\"zone\":1,\"graphics\":[{\"id\":1,\"value\":23}]},{\"zone\":2,\"align\": \"left\",\"texts\":[{\"id\":1,\"value\":\"PRECAUCION\",\"color\":\"#E2943A\"},{\"id\":2,\"value\":\"EXCESO DE\",\"color\":\"#E2943A\"},{\"id\":3,\"value\":\"GALIBO\",\"color\":\"#E2943A\"}]}]";
