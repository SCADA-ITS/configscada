...
/**
 *
 * SignallingCommand_71_9: Disabled Time Travel down signalling command
 *
 */
class SignallingCommand_71_9 {

    GroovyShell shell;
    def signallingCommandUtils;

    static final String TIMETRAVELENABLED = 'travel_time_enabled'

    static final Boolean DISABLED = false;

    org.apache.logging.log4j.Logger log;

    SignallingCommand_71_8(org.apache.logging.log4j.Logger log) {
    ...
    boolean process(String dataSourceXid, SignallingCommand signallingCommand, MangoDriver driver) {
        try {
            ...
            XidPointValueTimeModel xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand,
                    dataSourceXid + '_' + TIMETRAVELENABLED, DISABLED)
