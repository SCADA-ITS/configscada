...
/**
 * 
 * SignallingCommand_13_1: SEM GREEN_LIGHT signalling command 
 * 
 */
class SignallingCommand_13_1 {
	...
	//Values
	static final Long SEM_CMD_GREEN_LIGHT = 4L;
	static final Long SEM_CMD_ORANGE_LIGHT = 2L;
	static final Long SEM_CMD_RED_LIGHT = 1L;
	
	
	org.apache.logging.log4j.Logger log;
	
	SignallingCommand_13_1(org.apache.logging.log4j.Logger log) {
	...
	boolean process(String dataSourceXid, SignallingCommand signallingCommand, MangoDriver driver) {
		...
		try {
			...
			XidPointValueTimeModel xidPointValueTimeModel = signallingCommandUtils.getXidPointValueTimeModel(signallingCommand, 
					dataSourceXid + "_" + LIGHT_CMD, SEM_CMD_GREEN_LIGHT);
