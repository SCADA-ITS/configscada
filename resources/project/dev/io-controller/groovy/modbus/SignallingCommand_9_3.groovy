...
class SignallingCommand_9_3 {
	...
	static final Integer FAN_CMD_VALUE_START_REVERSE = 2;	
	...
	boolean process(final Integer xAddress, final SignallingCommand signallingCommand, final ModbusTcpDriver driver) {
		...
		try {
			...
			values[0] = FAN_CMD_VALUE_START_REVERSE;
			...
			log.debug("SignallingCommand_9_3: Fan start reverse signalling command result: " + result.toString());
