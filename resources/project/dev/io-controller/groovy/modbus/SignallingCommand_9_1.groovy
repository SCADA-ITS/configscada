...
/**
 * 
 * SignallingCommand_9_1: Fan stop signalling command 
 * 
 */
class SignallingCommand_9_1 {

	static final Integer FAN_CMD_VALUE_STOP = 0;	
	
	org.apache.logging.log4j.Logger log;
	
	SignallingCommand_9_1(org.apache.logging.log4j.Logger log) {
	...
	boolean process(final Integer xAddress, final SignallingCommand signallingCommand, final ModbusTcpDriver driver) {
		...
		try {
			...
			log.debug("SignallingCommand_9_1: Fan stop signalling command result: " + result.toString());
