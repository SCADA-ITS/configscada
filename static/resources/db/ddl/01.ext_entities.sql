...
DROP TABLE IF EXISTS rt.ext_entity_values;
DROP TABLE IF EXISTS rt.ext_entities;
DROP TABLE IF EXISTS static.management_area_ext_entity_types;
DROP TABLE IF EXISTS static.ext_entity_type_params;
DROP TABLE IF EXISTS static.ext_entity_subtypes;
DROP TABLE IF EXISTS static.ext_entity_types;

DROP SEQUENCE IF EXISTS rt.last_ext_entities_id;
...
--
	...
	ALTER TABLE rt.ext_entities SET TABLESPACE tbl_rt;
